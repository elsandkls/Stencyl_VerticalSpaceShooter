...
class Design_11_11_PCHandler extends ActorScript
{
	public var _Speed:Float;
	public var _LastProjectile:Actor;
	public var _ProjectileSpeed:Float;
	public var _powerLevel:Float;
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		_Speed = 0.0;
		nameMap.set("LastProjectile", "_LastProjectile");
		nameMap.set("ProjectileSpeed", "_ProjectileSpeed");
		_ProjectileSpeed = 0.0;
		nameMap.set("powerLevel", "_powerLevel");
		_powerLevel = 0.0;
