...
HX_DEFINE_STACK_FRAME(_hx_pos_10bd6b1bed041cec_31_new,"cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/vm/Thread.hx",31,0xb5f23fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_10bd6b1bed041cec_66___compare,"cpp.vm.Thread","__compare",0x3204cb4d,"cpp.vm.Thread.__compare","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/vm/Thread.hx",66,0xb5f23fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_10bd6b1bed041cec_53_create,"cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/vm/Thread.hx",53,0xb5f23fcb)
namespace cpp{
namespace vm{

void Thread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_10bd6b1bed041cec_31_new)
...
int Thread_obj::__compare( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_10bd6b1bed041cec_66___compare)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::cpp::vm::Thread Thread_obj::create( ::Dynamic callb){
            	HX_GC_STACKFRAME(&_hx_pos_10bd6b1bed041cec_53_create)
