...
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_36_getClass,"Type","getClass",0xc4e49bd6,"Type.getClass","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",36,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_54_getSuperClass,"Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",54,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_57_getClassName,"Type","getClassName",0x8e66dd41,"Type.getClassName","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",57,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_64_getEnumName,"Type","getEnumName",0x9b42910e,"Type.getEnumName","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",64,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_67_resolveClass,"Type","resolveClass",0x23b06bc0,"Type.resolveClass","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",67,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_74_resolveEnum,"Type","resolveEnum",0x26394079,"Type.resolveEnum","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",74,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_81_createInstance,"Type","createInstance",0xab84f9c5,"Type.createInstance","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",81,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_88_createEmptyInstance,"Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",88,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_92_createEnum,"Type","createEnum",0xd8d56d31,"Type.createEnum","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",92,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_102_getInstanceFields,"Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",102,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_110_getEnumConstructs,"Type","getEnumConstructs",0x7f46cf7f,"Type.getEnumConstructs","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",110,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_113_typeof,"Type","typeof",0xd6c51d65,"Type.typeof","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",113,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_130_enumEq,"Type","enumEq",0x855650e1,"Type.enumEq","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",130,0xdd2e9748)
HX_LOCAL_STACK_FRAME(_hx_pos_c2b821288c524359_138_enumParameters,"Type","enumParameters",0xf9e1b41f,"Type.enumParameters","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Type.hx",138,0xdd2e9748)
...
hx::Class Type_obj::getClass( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_36_getClass)
...
hx::Class Type_obj::getSuperClass(hx::Class c){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_54_getSuperClass)
...
::String Type_obj::getClassName(hx::Class c){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_57_getClassName)
...
::String Type_obj::getEnumName(hx::Class e){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_64_getEnumName)
...
hx::Class Type_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_67_resolveClass)
...
hx::Class Type_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_74_resolveEnum)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Type_obj,resolveEnum,return )
 ...
 ::Dynamic Type_obj::createInstance(hx::Class cl,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_81_createInstance)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Type_obj,createInstance,return )
 ...
 ::Dynamic Type_obj::createEmptyInstance(hx::Class cl){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_88_createEmptyInstance)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Type_obj,createEmptyInstance,return )
 ...
 ::Dynamic Type_obj::createEnum(hx::Class e,::String constr,::cpp::VirtualArray params){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_92_createEnum)
...
::Array< ::String > Type_obj::getInstanceFields(hx::Class c){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_102_getInstanceFields)
...
::Array< ::String > Type_obj::getEnumConstructs(hx::Class e){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_110_getEnumConstructs)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Type_obj,getEnumConstructs,return )
 ...
 ::ValueType Type_obj::_hx_typeof( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_113_typeof)
...
bool Type_obj::enumEq( ::Dynamic a, ::Dynamic b){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_130_enumEq)
...
::cpp::VirtualArray Type_obj::enumParameters( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_c2b821288c524359_138_enumParameters)
