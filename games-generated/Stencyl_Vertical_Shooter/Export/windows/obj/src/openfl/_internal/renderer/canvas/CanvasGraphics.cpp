...
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_529_hitTest,"openfl._internal.renderer.canvas.CanvasGraphics","hitTest",0xf1176f55,"openfl._internal.renderer.canvas.CanvasGraphics.hitTest","openfl/_internal/renderer/canvas/CanvasGraphics.hx",529,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_536_isCCW,"openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",536,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_541_normalizeUVT,"openfl._internal.renderer.canvas.CanvasGraphics","normalizeUVT",0x11b66056,"openfl._internal.renderer.canvas.CanvasGraphics.normalizeUVT","openfl/_internal/renderer/canvas/CanvasGraphics.hx",541,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_590_playCommands,"openfl._internal.renderer.canvas.CanvasGraphics","playCommands",0x147605cc,"openfl._internal.renderer.canvas.CanvasGraphics.playCommands","openfl/_internal/renderer/canvas/CanvasGraphics.hx",590,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1258_render,"openfl._internal.renderer.canvas.CanvasGraphics","render",0x7dc3ee46,"openfl._internal.renderer.canvas.CanvasGraphics.render","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1258,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1624_renderMask,"openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1624,0x0b9ff65e)
HX_LOCAL_STACK_FRAME(_hx_pos_ca7a636da47018f2_1741_setSmoothing,"openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1741,0x0b9ff65e)
...
bool CanvasGraphics_obj::hitTest( ::openfl::display::Graphics graphics,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_529_hitTest)
...
bool CanvasGraphics_obj::isCCW(Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_536_isCCW)
HXDLIN( 536)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
bool skipT = __o_skipT.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_ca7a636da47018f2_541_normalizeUVT)
HXLINE( 543)		Float max = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 544)		Float tmp = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 545)		int len = uvt->get_length();
HXLINE( 547)		{
HXLINE( 547)			int _g1 = (int)1;
HXDLIN( 547)			int _g = (len + (int)1);
HXDLIN( 547)			while((_g1 < _g)){
HXLINE( 547)				_g1 = (_g1 + (int)1);
HXDLIN( 547)				int t = (_g1 - (int)1);
HXLINE( 549)				bool _hx_tmp;
HXDLIN( 549)				if (skipT) {
HXLINE( 549)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 555)				tmp = uvt->get((t - (int)1));
HXLINE( 557)				if ((max < tmp)) {
HXLINE( 559)					max = tmp;
            				}
            			}
            		}
...
HXLINE( 571)		int length = null();
HXDLIN( 571)		bool fixed = null();
HXDLIN( 571)		 ::openfl::_Vector::FloatVector result =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXLINE( 573)		{
HXLINE( 573)			int _g11 = (int)1;
HXDLIN( 573)			int _g2 = (len + (int)1);
HXDLIN( 573)			while((_g11 < _g2)){
HXLINE( 573)				_g11 = (_g11 + (int)1);
HXDLIN( 573)				int t1 = (_g11 - (int)1);
HXLINE( 575)				bool _hx_tmp1;
HXDLIN( 575)				if (skipT) {
HXLINE( 575)					_hx_tmp1 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 581)				result->push(uvt->get((t1 - (int)1)));
            			}
            		}
...
bool stroke = __o_stroke.Default(false);
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_590_playCommands)
            	}
...
void CanvasGraphics_obj::render( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1258_render)
            	}
...
void CanvasGraphics_obj::renderMask( ::openfl::display::Graphics graphics, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1624_renderMask)
            	}
...
void CanvasGraphics_obj::setSmoothing(bool smooth){
            	HX_STACKFRAME(&_hx_pos_ca7a636da47018f2_1741_setSmoothing)
            	}
