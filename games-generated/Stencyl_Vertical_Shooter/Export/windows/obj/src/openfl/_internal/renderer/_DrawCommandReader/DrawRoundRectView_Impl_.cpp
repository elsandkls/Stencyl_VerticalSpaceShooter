...
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_363__new,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","_new",0x282357e4,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",363,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_364_get_x,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_x",0x8c16956c,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",364,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_365_get_y,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_y",0x8c16956d,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",365,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_366_get_width,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_width",0xe518d4fa,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_width","openfl/_internal/renderer/DrawCommandReader.hx",366,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_367_get_height,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_height",0x46f0fe73,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_height","openfl/_internal/renderer/DrawCommandReader.hx",367,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_368_get_ellipseWidth,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_ellipseWidth",0x1c1a67d4,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_ellipseWidth","openfl/_internal/renderer/DrawCommandReader.hx",368,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_29f1a366b7797e4c_369_get_ellipseHeight,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_","get_ellipseHeight",0x314fea59,"openfl._internal.renderer._DrawCommandReader.DrawRoundRectView_Impl_.get_ellipseHeight","openfl/_internal/renderer/DrawCommandReader.hx",369,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool DrawRoundRectView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader DrawRoundRectView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_363__new)
HXDLIN( 363)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float DrawRoundRectView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_364_get_x)
HXDLIN( 364)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawRoundRectView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_365_get_y)
HXDLIN( 365)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 365)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float DrawRoundRectView_Impl__obj::get_width( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_366_get_width)
HXDLIN( 366)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 366)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float DrawRoundRectView_Impl__obj::get_height( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_367_get_height)
HXDLIN( 367)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 367)		return this2->__get((this1->fPos + (int)3));
            	}
...
Float DrawRoundRectView_Impl__obj::get_ellipseWidth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_368_get_ellipseWidth)
HXDLIN( 368)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 368)		return this2->__get((this1->fPos + (int)4));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawRoundRectView_Impl__obj,get_ellipseWidth,return )
 ...
 ::Dynamic DrawRoundRectView_Impl__obj::get_ellipseHeight( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29f1a366b7797e4c_369_get_ellipseHeight)
HXDLIN( 369)		return this1->buffer->o->__get(this1->oPos);
            	}
