...
static void DrawCommandType_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(DrawCommandType_obj::OVERRIDE_BLEND_MODE,"OVERRIDE_BLEND_MODE");
...
static void DrawCommandType_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(DrawCommandType_obj::OVERRIDE_BLEND_MODE,"OVERRIDE_BLEND_MODE");
...
OVERRIDE_BLEND_MODE = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("OVERRIDE_BLEND_MODE","\xc4","\x2b","\x82","\x83"),19,0);
OVERRIDE_MATRIX = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("OVERRIDE_MATRIX","\x14","\x63","\x08","\xa8"),20,0);
UNKNOWN = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("UNKNOWN","\x6a","\xf7","\x4e","\x61"),23,0);
WINDING_EVEN_ODD = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("WINDING_EVEN_ODD","\xcf","\xa9","\x5e","\xc6"),21,0);
WINDING_NON_ZERO = hx::CreateEnum< DrawCommandType_obj >(HX_HCSTRING("WINDING_NON_ZERO","\x1f","\xee","\xbe","\x05"),22,0);
}
