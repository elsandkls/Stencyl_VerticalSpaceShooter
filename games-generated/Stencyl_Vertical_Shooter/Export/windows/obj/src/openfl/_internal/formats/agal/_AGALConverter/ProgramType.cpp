...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("openfl._internal.formats.agal._AGALConverter.ProgramType","\x5b","\xb6","\xf6","\x00"), hx::TCanCast< ProgramType_obj >,ProgramType_obj_sStaticFields,0,
