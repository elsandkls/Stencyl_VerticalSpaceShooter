...
HX_DEFINE_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_37_new,"openfl._internal.formats.swf.SWFLite","new",0x8f32a7f4,"openfl._internal.formats.swf.SWFLite.new","openfl/_internal/formats/swf/SWFLite.hx",37,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_46_createButton,"openfl._internal.formats.swf.SWFLite","createButton",0x575137fa,"openfl._internal.formats.swf.SWFLite.createButton","openfl/_internal/formats/swf/SWFLite.hx",46,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_51_createMovieClip,"openfl._internal.formats.swf.SWFLite","createMovieClip",0x199da198,"openfl._internal.formats.swf.SWFLite.createMovieClip","openfl/_internal/formats/swf/SWFLite.hx",51,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_80_getBitmapData,"openfl._internal.formats.swf.SWFLite","getBitmapData",0xed3aaa83,"openfl._internal.formats.swf.SWFLite.getBitmapData","openfl/_internal/formats/swf/SWFLite.hx",80,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_102_hasSymbol,"openfl._internal.formats.swf.SWFLite","hasSymbol",0xca4920e6,"openfl._internal.formats.swf.SWFLite.hasSymbol","openfl/_internal/formats/swf/SWFLite.hx",102,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_175_serialize,"openfl._internal.formats.swf.SWFLite","serialize",0x8f751c74,"openfl._internal.formats.swf.SWFLite.serialize","openfl/_internal/formats/swf/SWFLite.hx",175,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_119_resolveClass,"openfl._internal.formats.swf.SWFLite","resolveClass",0xdbf95398,"openfl._internal.formats.swf.SWFLite.resolveClass","openfl/_internal/formats/swf/SWFLite.hx",119,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_145_resolveEnum,"openfl._internal.formats.swf.SWFLite","resolveEnum",0x2df01ba1,"openfl._internal.formats.swf.SWFLite.resolveEnum","openfl/_internal/formats/swf/SWFLite.hx",145,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_184_unserialize,"openfl._internal.formats.swf.SWFLite","unserialize",0xca376ffb,"openfl._internal.formats.swf.SWFLite.unserialize","openfl/_internal/formats/swf/SWFLite.hx",184,0x106a09c0)
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_27_boot,"openfl._internal.formats.swf.SWFLite","boot",0xb5394e1e,"openfl._internal.formats.swf.SWFLite.boot","openfl/_internal/formats/swf/SWFLite.hx",27,0x106a09c0)
namespace openfl{
namespace _internal{
namespace formats{
namespace swf{
...
void SWFLite_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_37_new)
...
bool SWFLite_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::SimpleButton SWFLite_obj::createButton(::String className){
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_46_createButton)
...
::String className = __o_className.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_51_createMovieClip)
...
HX_DEFINE_DYNAMIC_FUNC1(SWFLite_obj,createMovieClip,return )
 ...
 ::openfl::display::BitmapData SWFLite_obj::getBitmapData(::String className){
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_80_getBitmapData)
HXLINE(  82)		{
...
bool SWFLite_obj::hasSymbol(::String className){
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_102_hasSymbol)
HXLINE( 104)		{
...
::String SWFLite_obj::serialize(){
            	HX_GC_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_175_serialize)
...
hx::Class SWFLite_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_119_resolveClass)
...
hx::Class SWFLite_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_145_resolveEnum)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(SWFLite_obj,resolveEnum,return )
 ...
 ::openfl::_internal::formats::swf::SWFLite SWFLite_obj::unserialize(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_184_unserialize)
...
HXLINE( 195)		return ( ( ::openfl::_internal::formats::swf::SWFLite)(unserializer->unserialize()) );
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_27_boot)
