...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("openfl._internal.formats.agal._AGALConverter.RegisterUsage","\xfb","\x53","\x84","\xee"), hx::TCanCast< RegisterUsage_obj >,RegisterUsage_obj_sStaticFields,0,
