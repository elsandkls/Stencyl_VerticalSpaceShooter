...
HX_DEFINE_STACK_FRAME(_hx_pos_75efee5aa8d131a4_31_new,"openfl._internal.utils.TouchData","new",0x621b4fae,"openfl._internal.utils.TouchData.new","openfl/_internal/utils/TouchData.hx",31,0xb785a0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_75efee5aa8d131a4_36_reset,"openfl._internal.utils.TouchData","reset",0xe8e8b89d,"openfl._internal.utils.TouchData.reset","openfl/_internal/utils/TouchData.hx",36,0xb785a0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_75efee5aa8d131a4_21_boot,"openfl._internal.utils.TouchData","boot",0x6de36924,"openfl._internal.utils.TouchData.boot","openfl/_internal/utils/TouchData.hx",21,0xb785a0c5)
namespace openfl{
namespace _internal{
namespace utils{

void TouchData_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_31_new)
HXDLIN(  31)		this->rollOutStack = ::Array_obj< ::Dynamic>::__new(0);
            	}
...
void TouchData_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_36_reset)
HXLINE(  38)		this->touch = null();
HXLINE(  39)		this->touchDownTarget = null();
HXLINE(  40)		this->touchOverTarget = null();
HXLINE(  42)		this->rollOutStack->removeRange((int)0,this->rollOutStack->length);
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::openfl::_internal::utils::TouchData _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_75efee5aa8d131a4_21_boot)
HXDLIN(  21)			return  ::openfl::_internal::utils::TouchData_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::openfl::_internal::utils::TouchData data){
            			HX_STACKFRAME(&_hx_pos_75efee5aa8d131a4_21_boot)
HXDLIN(  21)			data->reset();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_75efee5aa8d131a4_21_boot)
HXDLIN(  21)		_hx___pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
