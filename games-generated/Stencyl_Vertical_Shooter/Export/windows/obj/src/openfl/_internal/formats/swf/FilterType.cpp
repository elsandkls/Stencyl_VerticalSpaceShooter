...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("openfl._internal.formats.swf.FilterType","\x60","\x11","\xfc","\x5e"), hx::TCanCast< FilterType_obj >,FilterType_obj_sStaticFields,0,
