...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("openfl._internal.symbols.timeline.FrameObjectType","\x7c","\xdc","\x9a","\xf0"), hx::TCanCast< FrameObjectType_obj >,FrameObjectType_obj_sStaticFields,0,
