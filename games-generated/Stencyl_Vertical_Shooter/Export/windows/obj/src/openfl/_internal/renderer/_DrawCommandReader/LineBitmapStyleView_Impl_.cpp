...
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_394__new,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","_new",0x6ec636a4,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",394,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_395_get_bitmap,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_bitmap",0xeee7753b,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",395,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_396_get_matrix,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_matrix",0xb9a39b8d,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",396,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_397_get_repeat,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_repeat",0x0457fca7,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",397,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_3928fbcce9df7715_398_get_smooth,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_smooth",0x05466d7a,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",398,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool LineBitmapStyleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader LineBitmapStyleView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_394__new)
HXDLIN( 394)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,_new,return )
 ...
 ::openfl::display::BitmapData LineBitmapStyleView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_395_get_bitmap)
HXDLIN( 395)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineBitmapStyleView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix LineBitmapStyleView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_396_get_matrix)
HXDLIN( 396)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 396)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
bool LineBitmapStyleView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_397_get_repeat)
HXDLIN( 397)		return this1->buffer->b->__get(this1->bPos);
            	}
...
bool LineBitmapStyleView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3928fbcce9df7715_398_get_smooth)
HXDLIN( 398)		::Array< bool > this2 = this1->buffer->b;
HXDLIN( 398)		return this2->__get((this1->bPos + (int)1));
            	}
