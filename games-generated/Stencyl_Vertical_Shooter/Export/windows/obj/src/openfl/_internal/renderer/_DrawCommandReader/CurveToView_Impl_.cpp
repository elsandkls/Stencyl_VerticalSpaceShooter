...
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_310__new,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","_new",0x02b6a548,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",310,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_311_get_controlX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlX",0xd0ea894b,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlX","openfl/_internal/renderer/DrawCommandReader.hx",311,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_312_get_controlY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlY",0xd0ea894c,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlY","openfl/_internal/renderer/DrawCommandReader.hx",312,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_313_get_anchorX,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorX",0x40299753,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorX","openfl/_internal/renderer/DrawCommandReader.hx",313,0xbbdbd1ae)
HX_LOCAL_STACK_FRAME(_hx_pos_6171a03a509a36a4_314_get_anchorY,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorY",0x40299754,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorY","openfl/_internal/renderer/DrawCommandReader.hx",314,0xbbdbd1ae)
namespace openfl{
namespace _internal{
namespace renderer{
...
bool CurveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::_internal::renderer::DrawCommandReader CurveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_310__new)
HXDLIN( 310)		 ::openfl::_internal::renderer::DrawCommandReader this1 = d;
...
Float CurveToView_Impl__obj::get_controlX( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_311_get_controlX)
HXDLIN( 311)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float CurveToView_Impl__obj::get_controlY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_312_get_controlY)
HXDLIN( 312)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 312)		return this2->__get((this1->fPos + (int)1));
            	}
...
Float CurveToView_Impl__obj::get_anchorX( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_313_get_anchorX)
HXDLIN( 313)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 313)		return this2->__get((this1->fPos + (int)2));
            	}
...
Float CurveToView_Impl__obj::get_anchorY( ::openfl::_internal::renderer::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6171a03a509a36a4_314_get_anchorY)
HXDLIN( 314)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 314)		return this2->__get((this1->fPos + (int)3));
            	}
