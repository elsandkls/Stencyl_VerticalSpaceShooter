...
::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::BeginBitmapFill(int bitmap, ::openfl::geom::Matrix matrix,bool repeat,bool smooth)
{
...
::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::BeginFill(int color,Float alpha)
{
	return hx::CreateEnum< ShapeCommand_obj >(HX_("BeginFill",2c,8d,68,2e),1,2)->_hx_init(0,color)->_hx_init(1,alpha);
}

::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::BeginGradientFill( ::Dynamic fillType,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,Float focalPointRatio)
{
...
::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::CurveTo(Float controlX,Float controlY,Float anchorX,Float anchorY)
{
...
::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::EndFill;

::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::LineStyle( ::Dynamic thickness, ::Dynamic color, ::Dynamic alpha, ::Dynamic pixelHinting, ::Dynamic scaleMode, ::Dynamic caps, ::Dynamic joints, ::Dynamic miterLimit)
{
...
::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::LineTo(Float x,Float y)
{
	return hx::CreateEnum< ShapeCommand_obj >(HX_("LineTo",af,ba,34,21),6,2)->_hx_init(0,x)->_hx_init(1,y);
}

::openfl::_internal::formats::swf::ShapeCommand ShapeCommand_obj::MoveTo(Float x,Float y)
{
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("openfl._internal.formats.swf.ShapeCommand","\x78","\x32","\x71","\xa8"), hx::TCanCast< ShapeCommand_obj >,ShapeCommand_obj_sStaticFields,0,
