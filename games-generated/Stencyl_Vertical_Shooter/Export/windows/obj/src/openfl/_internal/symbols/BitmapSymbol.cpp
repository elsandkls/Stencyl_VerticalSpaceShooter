...
HX_DEFINE_STACK_FRAME(_hx_pos_6ebf8e17a3abb08a_32_new,"openfl._internal.symbols.BitmapSymbol","new",0x8818031c,"openfl._internal.symbols.BitmapSymbol.new","openfl/_internal/symbols/BitmapSymbol.hx",32,0x5876b9f1)
HX_LOCAL_STACK_FRAME(_hx_pos_6ebf8e17a3abb08a_40___createObject,"openfl._internal.symbols.BitmapSymbol","__createObject",0xcb0ed0bf,"openfl._internal.symbols.BitmapSymbol.__createObject","openfl/_internal/symbols/BitmapSymbol.hx",40,0x5876b9f1)
namespace openfl{
namespace _internal{
namespace symbols{

void BitmapSymbol_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6ebf8e17a3abb08a_32_new)
...
bool BitmapSymbol_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::DisplayObject BitmapSymbol_obj::_hx___createObject( ::openfl::_internal::formats::swf::SWFLite swf){
            	HX_GC_STACKFRAME(&_hx_pos_6ebf8e17a3abb08a_40___createObject)
HXDLIN(  40)		 ::openfl::display::BitmapData _hx_tmp = ::openfl::display::BitmapData_obj::fromImage(swf->library->getImage(this->path),null());
HXDLIN(  40)		return  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,_hx_tmp,(int)1,hx::IsNotEq( this->smooth,false ));
            	}
