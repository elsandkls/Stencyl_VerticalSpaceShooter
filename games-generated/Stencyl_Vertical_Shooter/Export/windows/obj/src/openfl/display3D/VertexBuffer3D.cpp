...
HX_DEFINE_STACK_FRAME(_hx_pos_8e0849c8e2179fab_38_new,"openfl.display3D.VertexBuffer3D","new",0xf0b52080,"openfl.display3D.VertexBuffer3D.new","openfl/display3D/VertexBuffer3D.hx",38,0xb1ad396e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_61_uploadFromByteArray,"openfl.display3D.VertexBuffer3D","uploadFromByteArray",0x0096a806,"openfl.display3D.VertexBuffer3D.uploadFromByteArray","openfl/display3D/VertexBuffer3D.hx",61,0xb1ad396e)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_73_uploadFromTypedArray,"openfl.display3D.VertexBuffer3D","uploadFromTypedArray",0xeb97089a,"openfl.display3D.VertexBuffer3D.uploadFromTypedArray","openfl/display3D/VertexBuffer3D.hx",73,0xb1ad396e)
HX_LOCAL_STACK_FRAME(_hx_pos_8e0849c8e2179fab_84_uploadFromVector,"openfl.display3D.VertexBuffer3D","uploadFromVector",0xcf228b0e,"openfl.display3D.VertexBuffer3D.uploadFromVector","openfl/display3D/VertexBuffer3D.hx",84,0xb1ad396e)
namespace openfl{
namespace display3D{
...
void VertexBuffer3D_obj::__construct( ::openfl::display3D::Context3D context3D,int numVertices,int dataPerVertex,::String bufferUsage){
            	HX_STACKFRAME(&_hx_pos_8e0849c8e2179fab_38_new)
HXLINE(  40)		this->_hx___context = context3D;
HXLINE(  41)		this->_hx___numVertices = numVertices;
HXLINE(  42)		this->_hx___vertexSize = dataPerVertex;
HXLINE(  44)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  46)		this->_hx___id = gl->createBuffer();
HXLINE(  47)		this->_hx___stride = (this->_hx___vertexSize * (int)4);
HXLINE(  48)		int _hx_tmp;
HXDLIN(  48)		if (hx::IsEq( ::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::fromString(bufferUsage),(int)0 )) {
HXLINE(  48)			_hx_tmp = gl->DYNAMIC_DRAW;
            		}
            		else {
HXLINE(  48)			_hx_tmp = gl->STATIC_DRAW;
            		}
HXDLIN(  48)		this->_hx___usage = _hx_tmp;
            	}
...
void VertexBuffer3D_obj::uploadFromByteArray( ::openfl::utils::ByteArrayData data,int byteArrayOffset,int startVertex,int numVertices){
            	HX_GC_STACKFRAME(&_hx_pos_8e0849c8e2179fab_61_uploadFromByteArray)
HXLINE(  64)		int offset = (byteArrayOffset + (startVertex * this->_hx___stride));
HXLINE(  65)		int length = (numVertices * this->_hx___vertexSize);
HXLINE(  67)		 ::haxe::io::Bytes buffer = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(data);
HXDLIN(  67)		 ::lime::utils::ArrayBufferView this1;
HXDLIN(  67)		if (hx::IsNotNull( buffer )) {
HXLINE(  67)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)8);
HXDLIN(  67)			int in_byteOffset = offset;
HXDLIN(  67)			if ((in_byteOffset < (int)0)) {
HXLINE(  67)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  67)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE(  67)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  67)			int bufferByteLength = buffer->length;
HXDLIN(  67)			int elementSize = _this->bytesPerElement;
HXDLIN(  67)			int newByteLength = bufferByteLength;
HXDLIN(  67)			if (hx::IsNull( length )) {
HXLINE(  67)				newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(  67)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE(  67)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN(  67)				if ((newByteLength < (int)0)) {
HXLINE(  67)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
            			else {
HXLINE(  67)				newByteLength = (length * _this->bytesPerElement);
HXDLIN(  67)				int newRange = (in_byteOffset + newByteLength);
HXDLIN(  67)				if ((newRange > bufferByteLength)) {
HXLINE(  67)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN(  67)			_this->buffer = buffer;
HXDLIN(  67)			_this->byteOffset = in_byteOffset;
HXDLIN(  67)			_this->byteLength = newByteLength;
HXDLIN(  67)			_this->length = ::Std_obj::_hx_int(((Float)newByteLength / (Float)_this->bytesPerElement));
HXDLIN(  67)			this1 = _this;
            		}
            		else {
HXLINE(  67)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            		}
HXDLIN(  67)		this->uploadFromTypedArray(this1,null());
            	}
...
int byteLength = __o_byteLength.Default(-1);
            	HX_STACKFRAME(&_hx_pos_8e0849c8e2179fab_73_uploadFromTypedArray)
HXLINE(  75)		if (hx::IsNull( data )) {
HXLINE(  75)			return;
            		}
HXLINE(  76)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  78)		this->_hx___context->_hx___bindGLArrayBuffer(this->_hx___id);
HXLINE(  79)		::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::bufferData(gl,gl->ARRAY_BUFFER,data,this->_hx___usage);
            	}
...
void VertexBuffer3D_obj::uploadFromVector( ::openfl::_Vector::FloatVector data,int startVertex,int numVertices){
            	HX_GC_STACKFRAME(&_hx_pos_8e0849c8e2179fab_84_uploadFromVector)
HXLINE(  87)		if (hx::IsNull( data )) {
HXLINE(  87)			return;
            		}
HXLINE(  88)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  92)		int start = (startVertex * this->_hx___vertexSize);
HXLINE(  93)		int count = (numVertices * this->_hx___vertexSize);
HXLINE(  94)		int length = (start + count);
HXLINE(  96)		 ::lime::utils::ArrayBufferView existingFloat32Array = this->_hx___tempFloat32Array;
HXLINE(  98)		bool _hx_tmp;
HXDLIN(  98)		if (hx::IsNotNull( this->_hx___tempFloat32Array )) {
HXLINE(  98)			_hx_tmp = (this->_hx___tempFloat32Array->length < count);
            		}
            		else {
HXLINE(  98)			_hx_tmp = true;
            		}
HXDLIN(  98)		if (_hx_tmp) {
HXLINE( 100)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 100)			if (hx::IsNotNull( count )) {
HXLINE( 100)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,count,(int)8);
            			}
            			else {
HXLINE( 100)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            			}
HXDLIN( 100)			this->_hx___tempFloat32Array = this1;
HXLINE( 102)			if (hx::IsNotNull( existingFloat32Array )) {
HXLINE( 104)				 ::lime::utils::ArrayBufferView _this = this->_hx___tempFloat32Array;
HXDLIN( 104)				int offset = (int)0;
HXDLIN( 104)				if (hx::IsNotNull( existingFloat32Array )) {
HXLINE( 104)					 ::haxe::io::Bytes _this1 = _this->buffer;
HXDLIN( 104)					_this1->blit((offset * _this->bytesPerElement),existingFloat32Array->buffer,existingFloat32Array->byteOffset,existingFloat32Array->byteLength);
            				}
            				else {
HXLINE( 104)					HX_STACK_DO_THROW(HX_("Invalid .set call. either view, or array must be not-null.",64,ba,b7,6c));
            				}
            			}
            		}
HXLINE( 110)		{
HXLINE( 110)			int _g1 = start;
HXDLIN( 110)			int _g = length;
HXDLIN( 110)			while((_g1 < _g)){
HXLINE( 110)				_g1 = (_g1 + (int)1);
HXDLIN( 110)				int i = (_g1 - (int)1);
HXLINE( 112)				{
HXLINE( 112)					 ::lime::utils::ArrayBufferView this2 = this->_hx___tempFloat32Array;
HXDLIN( 112)					Float val = data->get(i);
HXDLIN( 112)					{
HXLINE( 112)						int this3 = this2->byteOffset;
HXDLIN( 112)						::__hxcpp_memory_set_float(this2->buffer->b,(this3 + ((i - start) * (int)4)),val);
            					}
            				}
            			}
            		}
HXLINE( 116)		this->uploadFromTypedArray(this->_hx___tempFloat32Array,null());
            	}
