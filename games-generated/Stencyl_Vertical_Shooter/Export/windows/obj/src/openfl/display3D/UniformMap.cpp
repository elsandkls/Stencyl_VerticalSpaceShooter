...
HX_DEFINE_STACK_FRAME(_hx_pos_485718db96d0565f_889_new,"openfl.display3D.UniformMap","new",0x9f6fba13,"openfl.display3D.UniformMap.new","openfl/display3D/Program3D.hx",889,0x0a985b04)
HX_DEFINE_STACK_FRAME(_hx_pos_485718db96d0565f_883_new,"openfl.display3D.UniformMap","new",0x9f6fba13,"openfl.display3D.UniformMap.new","openfl/display3D/Program3D.hx",883,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_924_flush,"openfl.display3D.UniformMap","flush",0x8fcb5f37,"openfl.display3D.UniformMap.flush","openfl/display3D/Program3D.hx",924,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_944_markAllDirty,"openfl.display3D.UniformMap","markAllDirty",0xabef284b,"openfl.display3D.UniformMap.markAllDirty","openfl/display3D/Program3D.hx",944,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_485718db96d0565f_952_markDirty,"openfl.display3D.UniformMap","markDirty",0xb895e2b8,"openfl.display3D.UniformMap.markDirty","openfl/display3D/Program3D.hx",952,0x0a985b04)
namespace openfl{
namespace display3D{
...
void UniformMap_obj::__construct(::Array< ::Dynamic> list){
            		...
            		int _hx_run( ::openfl::display3D::Uniform a, ::openfl::display3D::Uniform b){
            			HX_STACKFRAME(&_hx_pos_485718db96d0565f_889_new)
HXLINE( 889)			return ::Reflect_obj::compare(a->regIndex,b->regIndex);
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_GC_STACKFRAME(&_hx_pos_485718db96d0565f_883_new)
HXLINE( 885)		this->_hx___uniforms = list;
HXLINE( 887)		this->_hx___uniforms->sort( ::Dynamic(new _hx_Closure_0()));
HXLINE( 893)		int total = (int)0;
HXLINE( 895)		{
HXLINE( 895)			int _g = (int)0;
HXDLIN( 895)			::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 895)			while((_g < _g1->length)){
HXLINE( 895)				 ::openfl::display3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 895)				_g = (_g + (int)1);
HXLINE( 897)				if (((uniform->regIndex + uniform->regCount) > total)) {
HXLINE( 899)					total = (uniform->regIndex + uniform->regCount);
            				}
            			}
            		}
HXLINE( 905)		bool fixed = null();
HXDLIN( 905)		this->_hx___registerLookup =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,null(),true);
HXLINE( 907)		{
HXLINE( 907)			int _g2 = (int)0;
HXDLIN( 907)			::Array< ::Dynamic> _g11 = this->_hx___uniforms;
HXDLIN( 907)			while((_g2 < _g11->length)){
HXLINE( 907)				 ::openfl::display3D::Uniform uniform1 = _g11->__get(_g2).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 907)				_g2 = (_g2 + (int)1);
HXLINE( 909)				{
HXLINE( 909)					int _g3 = (int)0;
HXDLIN( 909)					int _g21 = uniform1->regCount;
HXDLIN( 909)					while((_g3 < _g21)){
HXLINE( 909)						_g3 = (_g3 + (int)1);
HXDLIN( 909)						int i = (_g3 - (int)1);
HXLINE( 911)						this->_hx___registerLookup->set((uniform1->regIndex + i),uniform1).StaticCast<  ::openfl::display3D::Uniform >();
            					}
            				}
            			}
            		}
HXLINE( 917)		this->_hx___anyDirty = (this->_hx___allDirty = true);
            	}
...
void UniformMap_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_924_flush)
HXDLIN( 924)		if (this->_hx___anyDirty) {
HXLINE( 926)			{
HXLINE( 926)				int _g = (int)0;
HXDLIN( 926)				::Array< ::Dynamic> _g1 = this->_hx___uniforms;
HXDLIN( 926)				while((_g < _g1->length)){
HXLINE( 926)					 ::openfl::display3D::Uniform uniform = _g1->__get(_g).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN( 926)					_g = (_g + (int)1);
HXLINE( 928)					bool _hx_tmp;
HXDLIN( 928)					if (!(this->_hx___allDirty)) {
HXLINE( 928)						_hx_tmp = uniform->isDirty;
            					}
            					else {
HXLINE( 928)						_hx_tmp = true;
            					}
HXDLIN( 928)					if (_hx_tmp) {
HXLINE( 930)						uniform->flush();
HXLINE( 931)						uniform->isDirty = false;
            					}
            				}
            			}
HXLINE( 937)			this->_hx___anyDirty = (this->_hx___allDirty = false);
            		}
            	}
...
void UniformMap_obj::markAllDirty(){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_944_markAllDirty)
HXLINE( 946)		this->_hx___allDirty = true;
HXLINE( 947)		this->_hx___anyDirty = true;
            	}
...
void UniformMap_obj::markDirty(int start,int count){
            	HX_STACKFRAME(&_hx_pos_485718db96d0565f_952_markDirty)
HXLINE( 954)		if (this->_hx___allDirty) {
HXLINE( 956)			return;
            		}
HXLINE( 960)		int end = (start + count);
HXLINE( 962)		if ((end > this->_hx___registerLookup->get_length())) {
HXLINE( 964)			end = this->_hx___registerLookup->get_length();
            		}
HXLINE( 968)		int index = start;
HXLINE( 970)		while((index < end)){
HXLINE( 972)			 ::openfl::display3D::Uniform uniform = this->_hx___registerLookup->get(index).StaticCast<  ::openfl::display3D::Uniform >();
HXLINE( 974)			if (hx::IsNotNull( uniform )) {
HXLINE( 976)				uniform->isDirty = true;
HXLINE( 977)				this->_hx___anyDirty = true;
HXLINE( 979)				index = (uniform->regIndex + uniform->regCount);
            			}
            			else {
HXLINE( 983)				index = (index + (int)1);
            			}
            		}
            	}
