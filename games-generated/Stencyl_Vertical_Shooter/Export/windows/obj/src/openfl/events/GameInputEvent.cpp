...
HX_DEFINE_STACK_FRAME(_hx_pos_a9944c00dfbe9396_42_new,"openfl.events.GameInputEvent","new",0x8065662b,"openfl.events.GameInputEvent.new","openfl/events/GameInputEvent.hx",42,0x5318f185)
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_51_clone,"openfl.events.GameInputEvent","clone",0x205df1e8,"openfl.events.GameInputEvent.clone","openfl/events/GameInputEvent.hx",51,0x5318f185)
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_64_toString,"openfl.events.GameInputEvent","toString",0x31f35b01,"openfl.events.GameInputEvent.toString","openfl/events/GameInputEvent.hx",64,0x5318f185)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9944c00dfbe9396_33_boot,"openfl.events.GameInputEvent","boot",0xd06d0007,"openfl.events.GameInputEvent.boot","openfl/events/GameInputEvent.hx",33,0x5318f185)
namespace openfl{
namespace events{
...
bool cancelable = __o_cancelable.Default(false);
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_42_new)
HXLINE(  44)		super::__construct(type,bubbles,cancelable);
HXLINE(  46)		this->device = device;
            	}
...
bool GameInputEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event GameInputEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a9944c00dfbe9396_51_clone)
HXLINE(  53)		 ::openfl::events::GameInputEvent event =  ::openfl::events::GameInputEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->device);
...
::String GameInputEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_64_toString)
HXDLIN(  64)		return this->_hx___formatToString(HX_("GameInputEvent",62,3e,f4,2c),::Array_obj< ::String >::fromData( _hx_array_data_6a3e74b9_3,4));
            	}
...
HXDLIN(  28)		DEVICE_REMOVED = HX_("deviceRemoved",aa,c9,5b,59);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9944c00dfbe9396_33_boot)
HXDLIN(  33)		DEVICE_UNUSABLE = HX_("deviceUnusable",c7,a8,5e,6b);
            	}
}
