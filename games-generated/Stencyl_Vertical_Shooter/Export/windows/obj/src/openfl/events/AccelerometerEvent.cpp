...
HX_DEFINE_STACK_FRAME(_hx_pos_439e5e3230d0e146_88_new,"openfl.events.AccelerometerEvent","new",0x41c806b4,"openfl.events.AccelerometerEvent.new","openfl/events/AccelerometerEvent.hx",88,0xf933e51c)
HX_LOCAL_STACK_FRAME(_hx_pos_439e5e3230d0e146_100_clone,"openfl.events.AccelerometerEvent","clone",0xf81086b1,"openfl.events.AccelerometerEvent.clone","openfl/events/AccelerometerEvent.hx",100,0xf933e51c)
HX_LOCAL_STACK_FRAME(_hx_pos_439e5e3230d0e146_113_toString,"openfl.events.AccelerometerEvent","toString",0x0df129d8,"openfl.events.AccelerometerEvent.toString","openfl/events/AccelerometerEvent.hx",113,0xf933e51c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_439e5e3230d0e146_29_boot,"openfl.events.AccelerometerEvent","boot",0x4556d75e,"openfl.events.AccelerometerEvent.boot","openfl/events/AccelerometerEvent.hx",29,0xf933e51c)
namespace openfl{
namespace events{
...
Float accelerationZ = __o_accelerationZ.Default(0);
            	HX_STACKFRAME(&_hx_pos_439e5e3230d0e146_88_new)
HXLINE(  90)		super::__construct(type,bubbles,cancelable);
HXLINE(  92)		this->timestamp = timestamp;
HXLINE(  93)		this->accelerationX = accelerationX;
HXLINE(  94)		this->accelerationY = accelerationY;
HXLINE(  95)		this->accelerationZ = accelerationZ;
            	}
...
bool AccelerometerEvent_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2cacf5c0) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x2cacf5c0;
	} else {
 ...
 ::openfl::events::Event AccelerometerEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_439e5e3230d0e146_100_clone)
HXLINE( 102)		 ::openfl::events::AccelerometerEvent event =  ::openfl::events::AccelerometerEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->timestamp,this->accelerationX,this->accelerationY,this->accelerationZ);
HXLINE( 103)		event->target = this->target;
HXLINE( 104)		event->currentTarget = this->currentTarget;
HXLINE( 105)		event->eventPhase = this->eventPhase;
HXLINE( 106)		return event;
            	}


::String AccelerometerEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_439e5e3230d0e146_113_toString)
HXDLIN( 113)		return this->_hx___formatToString(HX_("AccelerometerEvent",eb,2e,b8,f5),::Array_obj< ::String >::fromData( _hx_array_data_5b31dcc2_3,7));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_439e5e3230d0e146_29_boot)
HXDLIN(  29)		UPDATE = HX_("update",09,86,05,87);
            	}
}
