...
HX_DEFINE_STACK_FRAME(_hx_pos_a9542994cee360f6_70_new,"openfl.events.TextEvent","new",0x29e58508,"openfl.events.TextEvent.new","openfl/events/TextEvent.hx",70,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_79_clone,"openfl.events.TextEvent","clone",0x41494205,"openfl.events.TextEvent.clone","openfl/events/TextEvent.hx",79,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_92_toString,"openfl.events.TextEvent","toString",0x2a253b04,"openfl.events.TextEvent.toString","openfl/events/TextEvent.hx",92,0x23b91588)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_27_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",27,0x23b91588)
HX_LOCAL_STACK_FRAME(_hx_pos_a9542994cee360f6_38_boot,"openfl.events.TextEvent","boot",0x7707e28a,"openfl.events.TextEvent.boot","openfl/events/TextEvent.hx",38,0x23b91588)
namespace openfl{
namespace events{
...
::String text = __o_text.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_70_new)
HXLINE(  72)		super::__construct(type,bubbles,cancelable);
HXLINE(  74)		this->text = text;
            	}
...
bool TextEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TextEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a9542994cee360f6_79_clone)
HXLINE(  81)		 ::openfl::events::TextEvent event =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text);
HXLINE(  82)		event->target = this->target;
HXLINE(  83)		event->currentTarget = this->currentTarget;
HXLINE(  84)		event->eventPhase = this->eventPhase;
HXLINE(  85)		return event;
            	}


::String TextEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_92_toString)
HXDLIN(  92)		return this->_hx___formatToString(HX_("TextEvent",0d,38,85,b0),::Array_obj< ::String >::fromData( _hx_array_data_52f4a116_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_27_boot)
HXDLIN(  27)		LINK = HX_("link",fa,17,b3,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a9542994cee360f6_38_boot)
HXDLIN(  38)		TEXT_INPUT = HX_("textInput",1d,54,0b,57);
            	}
}
