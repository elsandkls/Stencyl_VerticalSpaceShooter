...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_115_new,"openfl.events.FocusEvent","new",0xf00a0d8b,"openfl.events.FocusEvent.new","openfl/events/FocusEvent.hx",115,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_126_clone,"openfl.events.FocusEvent","clone",0x40033148,"openfl.events.FocusEvent.clone","openfl/events/FocusEvent.hx",126,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_139_toString,"openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",139,0xe559e625)
...
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_35_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",35,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_43_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",43,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_51_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",51,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_59_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",59,0xe559e625)
namespace openfl{
namespace events{
...
int keyCode = __o_keyCode.Default(0);
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_115_new)
HXLINE( 117)		super::__construct(type,bubbles,cancelable);
HXLINE( 119)		this->keyCode = keyCode;
HXLINE( 120)		this->shiftKey = shiftKey;
HXLINE( 121)		this->relatedObject = relatedObject;
            	}
...
bool FocusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FocusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_126_clone)
HXLINE( 128)		 ::openfl::events::FocusEvent event =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->relatedObject,this->shiftKey,this->keyCode);
HXLINE( 129)		event->target = this->target;
HXLINE( 130)		event->currentTarget = this->currentTarget;
HXLINE( 131)		event->eventPhase = this->eventPhase;
HXLINE( 132)		return event;
            	}


::String FocusEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_139_toString)
HXDLIN( 139)		return this->_hx___formatToString(HX_("FocusEvent",42,6d,d7,2e),::Array_obj< ::String >::fromData( _hx_array_data_ade3ec19_3,6));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_35_boot)
HXDLIN(  35)		FOCUS_IN = HX_("focusIn",dd,45,83,41);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_43_boot)
HXDLIN(  43)		FOCUS_OUT = HX_("focusOut",96,6f,5e,11);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_51_boot)
HXDLIN(  51)		KEY_FOCUS_CHANGE = HX_("keyFocusChange",09,9c,8e,e5);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_59_boot)
HXDLIN(  59)		MOUSE_FOCUS_CHANGE = HX_("mouseFocusChange",43,f1,81,96);
            	}
}
