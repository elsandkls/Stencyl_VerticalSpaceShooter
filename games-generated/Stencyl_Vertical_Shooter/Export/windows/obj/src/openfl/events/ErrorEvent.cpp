...
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_78_clone,"openfl.events.ErrorEvent","clone",0xbbab6b58,"openfl.events.ErrorEvent.clone","openfl/events/ErrorEvent.hx",78,0x9d2fc215)
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_91_toString,"openfl.events.ErrorEvent","toString",0x299f6791,"openfl.events.ErrorEvent.toString","openfl/events/ErrorEvent.hx",91,0x9d2fc215)
...
HX_LOCAL_STACK_FRAME(_hx_pos_0aefc26d1b1b4062_39_boot,"openfl.events.ErrorEvent","boot",0xced38497,"openfl.events.ErrorEvent.boot","openfl/events/ErrorEvent.hx",39,0x9d2fc215)
namespace openfl{
namespace events{
...
HXLINE(  72)		super::__construct(type,bubbles,cancelable,text);
HXLINE(  73)		this->errorID = id;
            	}
...
bool ErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_78_clone)
HXLINE(  80)		 ::openfl::events::ErrorEvent event =  ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
HXLINE(  81)		event->target = this->target;
HXLINE(  82)		event->currentTarget = this->currentTarget;
HXLINE(  83)		event->eventPhase = this->eventPhase;
HXLINE(  84)		return event;
            	}


::String ErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_91_toString)
HXDLIN(  91)		return this->_hx___formatToString(HX_("ErrorEvent",52,bb,79,e1),::Array_obj< ::String >::fromData( _hx_array_data_60863a29_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_0aefc26d1b1b4062_39_boot)
HXDLIN(  39)		ERROR = HX_("error",c8,cb,29,73);
            	}
}
