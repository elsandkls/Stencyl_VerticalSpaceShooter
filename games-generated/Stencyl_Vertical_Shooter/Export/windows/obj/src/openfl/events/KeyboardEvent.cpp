...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_130_new,"openfl.events.KeyboardEvent","new",0xa9982e4e,"openfl.events.KeyboardEvent.new","openfl/events/KeyboardEvent.hx",130,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_146_clone,"openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",146,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_159_toString,"openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",159,0xce5f4702)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_35_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",35,0xce5f4702)
...
bool commandKeyValue = __o_commandKeyValue.Default(false);
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_130_new)
HXLINE( 132)		super::__construct(type,bubbles,cancelable);
HXLINE( 134)		this->charCode = charCodeValue;
HXLINE( 135)		this->keyCode = keyCodeValue;
HXLINE( 136)		int _hx_tmp;
HXDLIN( 136)		if (hx::IsNotNull( keyLocationValue )) {
HXLINE( 136)			_hx_tmp = keyLocationValue;
            		}
            		else {
HXLINE( 136)			_hx_tmp = (int)0;
            		}
HXDLIN( 136)		this->keyLocation = _hx_tmp;
HXLINE( 137)		this->ctrlKey = ctrlKeyValue;
HXLINE( 138)		this->altKey = altKeyValue;
HXLINE( 139)		this->shiftKey = shiftKeyValue;
HXLINE( 140)		this->controlKey = controlKeyValue;
HXLINE( 141)		this->commandKey = commandKeyValue;
            	}
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_146_clone)
HXLINE( 148)		 ::openfl::events::KeyboardEvent event =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
HXLINE( 149)		event->target = this->target;
HXLINE( 150)		event->currentTarget = this->currentTarget;
HXLINE( 151)		event->eventPhase = this->eventPhase;
HXLINE( 152)		return event;
            	}


::String KeyboardEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_159_toString)
HXDLIN( 159)		return this->_hx___formatToString(HX_("KeyboardEvent",d3,8d,88,91),::Array_obj< ::String >::fromData( _hx_array_data_d8fbaf5c_3,9));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_35_boot)
HXDLIN(  35)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_43_boot)
HXDLIN(  43)		KEY_UP = HX_("keyUp",da,b9,fe,de);
            	}
}
