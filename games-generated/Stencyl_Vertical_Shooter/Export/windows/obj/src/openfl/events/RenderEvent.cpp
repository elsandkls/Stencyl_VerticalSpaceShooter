...
HX_LOCAL_STACK_FRAME(_hx_pos_6a559adcb74b53ca_59_toString,"openfl.events.RenderEvent","toString",0xf15b7b2d,"openfl.events.RenderEvent.toString","openfl/events/RenderEvent.hx",59,0xf57c28f1)
...
HXLINE(  47)		event5->target = this->target;
HXLINE(  48)		event5->currentTarget = this->currentTarget;
HXLINE(  49)		event5->eventPhase = this->eventPhase;
HXLINE(  51)		return event5;
            	}


::String RenderEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_6a559adcb74b53ca_59_toString)
HXDLIN(  59)		return this->_hx___formatToString(HX_("RenderEvent",c4,8c,a8,25),::Array_obj< ::String >::fromData( _hx_array_data_d18b0a0d_3,3));
            	}
