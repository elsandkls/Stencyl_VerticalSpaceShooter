...
HX_DEFINE_STACK_FRAME(_hx_pos_b09527e17bebd012_74_new,"openfl.events.ProgressEvent","new",0xeed66288,"openfl.events.ProgressEvent.new","openfl/events/ProgressEvent.hx",74,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_84_clone,"openfl.events.ProgressEvent","clone",0xca4c7f85,"openfl.events.ProgressEvent.clone","openfl/events/ProgressEvent.hx",84,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_97_toString,"openfl.events.ProgressEvent","toString",0x8ba16d84,"openfl.events.ProgressEvent.toString","openfl/events/ProgressEvent.hx",97,0xea3bf808)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_30_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",30,0xea3bf808)
HX_LOCAL_STACK_FRAME(_hx_pos_b09527e17bebd012_38_boot,"openfl.events.ProgressEvent","boot",0x04d8d50a,"openfl.events.ProgressEvent.boot","openfl/events/ProgressEvent.hx",38,0xea3bf808)
namespace openfl{
namespace events{
...
Float bytesTotal = __o_bytesTotal.Default(0);
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_74_new)
HXLINE(  76)		super::__construct(type,bubbles,cancelable);
HXLINE(  78)		this->bytesLoaded = bytesLoaded;
HXLINE(  79)		this->bytesTotal = bytesTotal;
            	}
...
bool ProgressEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ProgressEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_b09527e17bebd012_84_clone)
HXLINE(  86)		 ::openfl::events::ProgressEvent event =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->bytesLoaded,this->bytesTotal);
HXLINE(  87)		event->target = this->target;
HXLINE(  88)		event->currentTarget = this->currentTarget;
HXLINE(  89)		event->eventPhase = this->eventPhase;
HXLINE(  90)		return event;
            	}


::String ProgressEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_97_toString)
HXDLIN(  97)		return this->_hx___formatToString(HX_("ProgressEvent",0d,9d,55,84),::Array_obj< ::String >::fromData( _hx_array_data_cbc8be96_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_30_boot)
HXDLIN(  30)		PROGRESS = HX_("progress",ad,f7,2a,86);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b09527e17bebd012_38_boot)
HXDLIN(  38)		SOCKET_DATA = HX_("socketData",7d,63,de,b1);
            	}
}
