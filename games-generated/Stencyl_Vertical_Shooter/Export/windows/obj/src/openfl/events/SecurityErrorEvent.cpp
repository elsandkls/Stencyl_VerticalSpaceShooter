...
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_69_clone,"openfl.events.SecurityErrorEvent","clone",0x91bd7138,"openfl.events.SecurityErrorEvent.clone","openfl/events/SecurityErrorEvent.hx",69,0x4f4e3035)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7a0f0e2b2707adbe_39_boot,"openfl.events.SecurityErrorEvent","boot",0x0eecdab7,"openfl.events.SecurityErrorEvent.boot","openfl/events/SecurityErrorEvent.hx",39,0x4f4e3035)
namespace openfl{
namespace events{
...
bool SecurityErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event SecurityErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_69_clone)
HXLINE(  71)		 ::openfl::events::SecurityErrorEvent event =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->text,this->errorID);
...
{
{
            	HX_STACKFRAME(&_hx_pos_7a0f0e2b2707adbe_39_boot)
HXDLIN(  39)		SECURITY_ERROR = HX_("securityError",e8,28,7c,a2);
            	}
}
