...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_521_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",521,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_531_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",531,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_543_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",543,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_550_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",550,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_557_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",557,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_587_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",587,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_598_start,"openfl.events._EventDispatcher.DispatchIterator","start",0x64b17551,"openfl.events._EventDispatcher.DispatchIterator.start","openfl/events/EventDispatcher.hx",598,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_604_stop,"openfl.events._EventDispatcher.DispatchIterator","stop",0x76b1a1f3,"openfl.events._EventDispatcher.DispatchIterator.stop","openfl/events/EventDispatcher.hx",604,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_521_new)
HXLINE( 523)		this->active = false;
HXLINE( 524)		this->reset(list);
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_531_copy)
HXDLIN( 531)		if (!(this->isCopy)) {
HXLINE( 533)			this->list = this->list->copy();
HXLINE( 534)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_543_hasNext)
HXDLIN( 543)		return (this->index < this->list->length);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_550_next)
HXDLIN( 550)		::Array< ::Dynamic> _hx_tmp = this->list;
HXDLIN( 550)		return _hx_tmp->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_557_remove)
HXDLIN( 557)		if (this->active) {
HXLINE( 559)			if (!(this->isCopy)) {
HXLINE( 561)				if ((listIndex < this->index)) {
HXLINE( 563)					this->index--;
            				}
            			}
            			else {
HXLINE( 569)				int _g1 = this->index;
HXDLIN( 569)				int _g = this->list->length;
HXDLIN( 569)				while((_g1 < _g)){
HXLINE( 569)					_g1 = (_g1 + (int)1);
HXDLIN( 569)					int i = (_g1 - (int)1);
HXLINE( 571)					if (hx::IsEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 573)						this->list->removeRange(i,(int)1);
HXLINE( 574)						goto _hx_goto_4;
            					}
            				}
            				_hx_goto_4:;
            			}
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_587_reset)
HXLINE( 589)		this->list = list;
HXLINE( 591)		this->isCopy = false;
HXLINE( 592)		this->index = (int)0;
            	}
...
void DispatchIterator_obj::start(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_598_start)
HXDLIN( 598)		this->active = true;
            	}
...
void DispatchIterator_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_604_stop)
HXDLIN( 604)		this->active = false;
            	}
