...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_254_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",254,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_278_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",278,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_291_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",291,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_301_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",301,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_308___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",308,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_60_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",60,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_68_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",68,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_84_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",84,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_92_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",92,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_100_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",100,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_108_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",108,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_116_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",116,0x2fe85d0c)
namespace openfl{
namespace events{
...
bool isTouchPointCanceled = __o_isTouchPointCanceled.Default(false);
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_254_new)
HXLINE( 256)		super::__construct(type,bubbles,cancelable);
HXLINE( 258)		this->touchPointID = touchPointID;
HXLINE( 259)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 260)		this->localX = localX;
HXLINE( 261)		this->localY = localY;
HXLINE( 262)		this->sizeX = sizeX;
HXLINE( 263)		this->sizeY = sizeY;
HXLINE( 264)		this->pressure = pressure;
HXLINE( 265)		this->relatedObject = relatedObject;
HXLINE( 266)		this->ctrlKey = ctrlKey;
HXLINE( 267)		this->altKey = altKey;
HXLINE( 268)		this->shiftKey = shiftKey;
HXLINE( 269)		this->commandKey = commandKey;
HXLINE( 270)		this->controlKey = controlKey;
HXLINE( 272)		this->stageX = ::Math_obj::NaN;
HXLINE( 273)		this->stageY = ::Math_obj::NaN;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_278_clone)
...
HXLINE( 281)		event->target = this->target;
HXLINE( 282)		event->currentTarget = this->currentTarget;
HXLINE( 283)		event->eventPhase = this->eventPhase;
HXLINE( 284)		return event;
            	}


::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_291_toString)
HXDLIN( 291)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_301_updateAfterEvent)
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_308___create)
HXLINE( 310)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,(int)0,true,local->x,local->y,(int)1,(int)1,(int)1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 311)		evt->stageX = stageX;
HXLINE( 312)		evt->stageY = stageY;
HXLINE( 313)		evt->target = target;
HXLINE( 315)		return evt;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_60_boot)
HXDLIN(  60)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_68_boot)
HXDLIN(  68)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_76_boot)
HXDLIN(  76)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_84_boot)
HXDLIN(  84)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_92_boot)
HXDLIN(  92)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_100_boot)
HXDLIN( 100)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_108_boot)
HXDLIN( 108)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_116_boot)
HXDLIN( 116)		TOUCH_TAP = HX_("touchTap",e4,1b,15,00);
            	}
}
