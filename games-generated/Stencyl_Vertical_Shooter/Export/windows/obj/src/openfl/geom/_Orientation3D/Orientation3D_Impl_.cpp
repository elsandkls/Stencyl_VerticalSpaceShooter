...
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_19_fromString,"openfl.geom._Orientation3D.Orientation3D_Impl_","fromString",0xa47116a0,"openfl.geom._Orientation3D.Orientation3D_Impl_.fromString","openfl/geom/Orientation3D.hx",19,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_32_toString,"openfl.geom._Orientation3D.Orientation3D_Impl_","toString",0xf11d8e31,"openfl.geom._Orientation3D.Orientation3D_Impl_.toString","openfl/geom/Orientation3D.hx",32,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_13_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",13,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_14_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",14,0xf4ac08f1)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfa7e5fc0c22ef6_15_boot,"openfl.geom._Orientation3D.Orientation3D_Impl_","boot",0xe951db37,"openfl.geom._Orientation3D.Orientation3D_Impl_.boot","openfl/geom/Orientation3D.hx",15,0xf4ac08f1)
namespace openfl{
namespace geom{
...
bool Orientation3D_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Orientation3D_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_19_fromString)
...
::String Orientation3D_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_32_toString)
HXDLIN(  32)		switch((int)(value)){
            			case (int)0: {
HXLINE(  34)				return HX_("axisAngle",72,2f,86,7c);
            			}
            			break;
            			case (int)1: {
HXLINE(  35)				return HX_("eulerAngles",89,d7,c4,64);
            			}
            			break;
            			case (int)2: {
HXLINE(  36)				return HX_("quaternion",1e,0d,ca,1b);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_13_boot)
HXDLIN(  13)		AXIS_ANGLE = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_14_boot)
HXDLIN(  14)		EULER_ANGLES = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfa7e5fc0c22ef6_15_boot)
HXDLIN(  15)		QUATERNION = (int)2;
            	}
}
