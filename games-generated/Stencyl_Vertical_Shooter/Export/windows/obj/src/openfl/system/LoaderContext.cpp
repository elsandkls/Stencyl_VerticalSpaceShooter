...
HX_DEFINE_STACK_FRAME(_hx_pos_b514a9552a6ee0e8_25_new,"openfl.system.LoaderContext","new",0xca9b9c4d,"openfl.system.LoaderContext.new","openfl/system/LoaderContext.hx",25,0x3ddfdde3)
namespace openfl{
...
bool checkPolicyFile = __o_checkPolicyFile.Default(false);
            	HX_STACKFRAME(&_hx_pos_b514a9552a6ee0e8_25_new)
HXLINE(  27)		this->checkPolicyFile = checkPolicyFile;
HXLINE(  28)		this->securityDomain = securityDomain;
HXLINE(  29)		this->applicationDomain = applicationDomain;
HXLINE(  31)		this->allowCodeImport = true;
HXLINE(  32)		this->allowLoadBytesCodeExecution = true;
            	}
