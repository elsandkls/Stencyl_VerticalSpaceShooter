...
HX_DEFINE_STACK_FRAME(_hx_pos_5a0a7282aa095189_26_new,"openfl.system.ApplicationDomain","new",0x87171265,"openfl.system.ApplicationDomain.new","openfl/system/ApplicationDomain.hx",26,0xc87242cb)
HX_LOCAL_STACK_FRAME(_hx_pos_5a0a7282aa095189_41_getDefinition,"openfl.system.ApplicationDomain","getDefinition",0xdd020c0e,"openfl.system.ApplicationDomain.getDefinition","openfl/system/ApplicationDomain.hx",41,0xc87242cb)
HX_LOCAL_STACK_FRAME(_hx_pos_5a0a7282aa095189_51_hasDefinition,"openfl.system.ApplicationDomain","hasDefinition",0x9ae667d2,"openfl.system.ApplicationDomain.hasDefinition","openfl/system/ApplicationDomain.hx",51,0xc87242cb)
HX_LOCAL_STACK_FRAME(_hx_pos_5a0a7282aa095189_17_boot,"openfl.system.ApplicationDomain","boot",0xa532068d,"openfl.system.ApplicationDomain.boot","openfl/system/ApplicationDomain.hx",17,0xc87242cb)
namespace openfl{
namespace _hx_system{

void ApplicationDomain_obj::__construct( ::openfl::_hx_system::ApplicationDomain parentDomain){
            	HX_STACKFRAME(&_hx_pos_5a0a7282aa095189_26_new)
HXDLIN(  26)		if (hx::IsNotNull( parentDomain )) {
HXLINE(  28)			this->parentDomain = parentDomain;
            		}
            		else {
HXLINE(  32)			this->parentDomain = ::openfl::_hx_system::ApplicationDomain_obj::currentDomain;
            		}
            	}
...
hx::Class ApplicationDomain_obj::getDefinition(::String name){
            	HX_STACKFRAME(&_hx_pos_5a0a7282aa095189_41_getDefinition)
HXDLIN(  41)		return ::Type_obj::resolveClass(name);
            	}
...
bool ApplicationDomain_obj::hasDefinition(::String name){
            	HX_STACKFRAME(&_hx_pos_5a0a7282aa095189_51_hasDefinition)
HXDLIN(  51)		return hx::IsNotNull( ::Type_obj::resolveClass(name) );
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_5a0a7282aa095189_17_boot)
HXDLIN(  17)		currentDomain =  ::openfl::_hx_system::ApplicationDomain_obj::__alloc( HX_CTX ,null());
            	}
}
