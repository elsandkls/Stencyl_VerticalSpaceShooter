...
HX_DEFINE_STACK_FRAME(_hx_pos_d7a2132659cec934_266_new,"openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",266,0xe997cd0d)
namespace openfl{
namespace net{

void URLRequest_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d7a2132659cec934_266_new)
HXLINE( 268)		if (hx::IsNotNull( url )) {
HXLINE( 270)			this->url = url;
            		}
HXLINE( 274)		this->contentType = null();
HXLINE( 275)		this->followRedirects = ::openfl::net::URLRequestDefaults_obj::followRedirects;
HXLINE( 276)		Float _hx_tmp;
HXDLIN( 276)		if ((::openfl::net::URLRequestDefaults_obj::idleTimeout > (int)0)) {
HXLINE( 276)			_hx_tmp = ::openfl::net::URLRequestDefaults_obj::idleTimeout;
            		}
            		else {
HXLINE( 276)			_hx_tmp = (int)30000;
            		}
HXDLIN( 276)		this->idleTimeout = _hx_tmp;
HXLINE( 277)		this->manageCookies = ::openfl::net::URLRequestDefaults_obj::manageCookies;
HXLINE( 278)		this->method = HX_("GET",76,1c,36,00);
HXLINE( 279)		this->requestHeaders = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 280)		this->userAgent = ::openfl::net::URLRequestDefaults_obj::userAgent;
            	}
