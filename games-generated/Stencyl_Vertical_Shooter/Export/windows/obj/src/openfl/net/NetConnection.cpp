...
HX_DEFINE_STACK_FRAME(_hx_pos_cbeb021ed190252c_38_new,"openfl.net.NetConnection","new",0x5c5dd97e,"openfl.net.NetConnection.new","openfl/net/NetConnection.hx",38,0x3b599834)
HX_LOCAL_STACK_FRAME(_hx_pos_cbeb021ed190252c_48_connect,"openfl.net.NetConnection","connect",0x1fc82c08,"openfl.net.NetConnection.connect","openfl/net/NetConnection.hx",48,0x3b599834)
...
void NetConnection_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_cbeb021ed190252c_38_new)
...
void NetConnection_obj::connect(::String command, ::Dynamic _, ::Dynamic _1, ::Dynamic _2, ::Dynamic _3, ::Dynamic _4){
            	HX_GC_STACKFRAME(&_hx_pos_cbeb021ed190252c_48_connect)
HXLINE(  50)		if (hx::IsNotNull( command )) {
HXLINE(  52)			HX_STACK_DO_THROW(HX_("Error: Can only connect in \"HTTP streaming\" mode",fe,f3,67,57));
            		}
HXLINE(  56)		this->dispatchEvent( ::openfl::events::NetStatusEvent_obj::__alloc( HX_CTX ,HX_("netStatus",6f,4f,ec,46),false,true, ::Dynamic(hx::Anon_obj::Create(1)
