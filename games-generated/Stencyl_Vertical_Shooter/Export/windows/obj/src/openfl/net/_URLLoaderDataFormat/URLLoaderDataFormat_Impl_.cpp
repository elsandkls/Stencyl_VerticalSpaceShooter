...
HX_LOCAL_STACK_FRAME(_hx_pos_bc4be490b63557ba_43_toString,"openfl.net._URLLoaderDataFormat.URLLoaderDataFormat_Impl_","toString",0x62701f12,"openfl.net._URLLoaderDataFormat.URLLoaderDataFormat_Impl_.toString","openfl/net/URLLoaderDataFormat.hx",43,0x0297964c)
...
::String URLLoaderDataFormat_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_bc4be490b63557ba_43_toString)
HXDLIN(  43)		switch((int)(value)){
            			case (int)0: {
HXLINE(  45)				return HX_("binary",01,bc,0b,ed);
            			}
            			break;
            			case (int)1: {
HXLINE(  46)				return HX_("text",ad,cc,f9,4c);
            			}
            			break;
            			case (int)2: {
HXLINE(  47)				return HX_("variables",b7,e2,62,82);
            			}
            			break;
            			default:{
