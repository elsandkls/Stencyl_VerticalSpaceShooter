...
HX_DEFINE_STACK_FRAME(_hx_pos_fafdee3291969395_18_new,"openfl.ui.GameInputDevice","new",0x66440344,"openfl.ui.GameInputDevice.new","openfl/ui/GameInputDevice.hx",18,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_104_getCachedSamples,"openfl.ui.GameInputDevice","getCachedSamples",0x0422a56d,"openfl.ui.GameInputDevice.getCachedSamples","openfl/ui/GameInputDevice.hx",104,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_114_getControlAt,"openfl.ui.GameInputDevice","getControlAt",0xc65be2d6,"openfl.ui.GameInputDevice.getControlAt","openfl/ui/GameInputDevice.hx",114,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_132_startCachingSamples,"openfl.ui.GameInputDevice","startCachingSamples",0xf3794db0,"openfl.ui.GameInputDevice.startCachingSamples","openfl/ui/GameInputDevice.hx",132,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_142_stopCachingSamples,"openfl.ui.GameInputDevice","stopCachingSamples",0xbbb05408,"openfl.ui.GameInputDevice.stopCachingSamples","openfl/ui/GameInputDevice.hx",142,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_158_get_numControls,"openfl.ui.GameInputDevice","get_numControls",0x2a978757,"openfl.ui.GameInputDevice.get_numControls","openfl/ui/GameInputDevice.hx",158,0x744a6f4c)
...
void GameInputDevice_obj::__construct(::String id,::String name){
            	HX_GC_STACKFRAME(&_hx_pos_fafdee3291969395_18_new)
HXLINE(  52)		this->_hx___controls = ::Array_obj< ::Dynamic>::__new();
HXLINE(  51)		this->_hx___button =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  50)		this->_hx___axis =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  72)		this->id = id;
HXLINE(  73)		this->name = name;
HXLINE(  75)		 ::openfl::ui::GameInputControl control;
HXLINE(  77)		{
HXLINE(  77)			int _g = (int)0;
HXDLIN(  77)			while((_g < (int)6)){
HXLINE(  77)				_g = (_g + (int)1);
HXDLIN(  77)				int i = (_g - (int)1);
HXLINE(  79)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),(int)-1,(int)1,null());
HXLINE(  80)				this->_hx___axis->set(i,control);
HXLINE(  81)				this->_hx___controls->push(control);
            			}
            		}
HXLINE(  85)		{
HXLINE(  85)			int _g1 = (int)0;
HXDLIN(  85)			while((_g1 < (int)15)){
HXLINE(  85)				_g1 = (_g1 + (int)1);
HXDLIN(  85)				int i1 = (_g1 - (int)1);
HXLINE(  87)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),(int)0,(int)1,null());
HXLINE(  88)				this->_hx___button->set(i1,control);
HXLINE(  89)				this->_hx___controls->push(control);
            			}
            		}
            	}
...
bool append = __o_append.Default(false);
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_104_getCachedSamples)
...
HX_DEFINE_DYNAMIC_FUNC2(GameInputDevice_obj,getCachedSamples,return )
 ...
 ::openfl::ui::GameInputControl GameInputDevice_obj::getControlAt(int i){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_114_getControlAt)
HXLINE( 116)		bool _hx_tmp;
HXDLIN( 116)		if ((i >= (int)0)) {
HXLINE( 116)			_hx_tmp = (i < this->_hx___controls->length);
            		}
            		else {
HXLINE( 116)			_hx_tmp = false;
            		}
HXDLIN( 116)		if (_hx_tmp) {
HXLINE( 118)			return this->_hx___controls->__get(i).StaticCast<  ::openfl::ui::GameInputControl >();
            		}
...
void GameInputDevice_obj::startCachingSamples(int numSamples, ::openfl::_Vector::ObjectVector controls){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_132_startCachingSamples)
            	}
...
void GameInputDevice_obj::stopCachingSamples(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_142_stopCachingSamples)
            	}
...
int GameInputDevice_obj::get_numControls(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_158_get_numControls)
HXDLIN( 158)		return this->_hx___controls->length;
            	}
