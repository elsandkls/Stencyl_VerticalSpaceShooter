...
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_170_new,"openfl.filters.BlurFilter","new",0x2ff6acc2,"openfl.filters.BlurFilter.new","openfl/filters/BlurFilter.hx",170,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_187_clone,"openfl.filters.BlurFilter","clone",0xcbbf4c3f,"openfl.filters.BlurFilter.clone","openfl/filters/BlurFilter.hx",187,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_192___applyFilter,"openfl.filters.BlurFilter","__applyFilter",0x511b0b88,"openfl.filters.BlurFilter.__applyFilter","openfl/filters/BlurFilter.hx",192,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_203___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",203,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_235_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",235,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_240_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",240,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_255_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",255,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_260_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",260,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_275_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",275,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_280_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",280,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_80_boot,"openfl.filters.BlurFilter","boot",0xbff97d90,"openfl.filters.BlurFilter.boot","openfl/filters/BlurFilter.hx",80,0x46563eac)
namespace openfl{
namespace filters{
...
int quality = __o_quality.Default(1);
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_170_new)
HXLINE( 172)		super::__construct();
HXLINE( 174)		this->set_blurX(blurX);
HXLINE( 175)		this->set_blurY(blurY);
HXLINE( 176)		this->set_quality(quality);
HXLINE( 178)		this->_hx___needSecondBitmapData = true;
HXLINE( 179)		this->_hx___preserveObject = false;
...
bool BlurFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BlurFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_187_clone)
HXDLIN( 187)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->_hx___blurX,this->_hx___blurY,this->_hx___quality);
            	}
 ...
 ::openfl::display::BitmapData BlurFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_192___applyFilter)
HXLINE( 195)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 195)		 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 195)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 195)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 195)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
HXLINE( 196)		if (hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 196)			return bitmapData;
            		}
HXLINE( 198)		return sourceBitmapData;
            	}


 ::openfl::display::Shader BlurFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_203___initShader)
HXLINE( 206)		if ((pass <= this->_hx___horizontalPasses)) {
HXLINE( 208)			Float scale = ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1));
HXLINE( 209)			::Array< Float > _hx_tmp = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN( 209)			_hx_tmp[(int)0] = (this->get_blurX() * scale);
HXLINE( 210)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)1] = (int)0;
            		}
            		else {
HXLINE( 214)			Float scale1 = ::Math_obj::pow(((Float)0.5),((int)(pass - this->_hx___horizontalPasses) >> (int)(int)1));
HXLINE( 215)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)0] = (int)0;
HXLINE( 216)			::Array< Float > _hx_tmp1 = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN( 216)			_hx_tmp1[(int)1] = (this->get_blurY() * scale1);
            		}
HXLINE( 221)		return ::openfl::filters::BlurFilter_obj::_hx___blurShader;
            	}


Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_235_get_blurX)
HXDLIN( 235)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_240_set_blurX)
HXLINE( 242)		if ((value != this->_hx___blurX)) {
HXLINE( 243)			this->_hx___blurX = value;
HXLINE( 244)			this->_hx___renderDirty = true;
HXLINE( 245)			int _hx_tmp;
HXDLIN( 245)			if ((value > (int)0)) {
HXLINE( 245)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 245)				_hx_tmp = (int)0;
            			}
HXDLIN( 245)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 246)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_255_get_blurY)
HXDLIN( 255)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_260_set_blurY)
HXLINE( 262)		if ((value != this->_hx___blurY)) {
HXLINE( 263)			this->_hx___blurY = value;
HXLINE( 264)			this->_hx___renderDirty = true;
HXLINE( 265)			int _hx_tmp;
HXDLIN( 265)			if ((value > (int)0)) {
HXLINE( 265)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 265)				_hx_tmp = (int)0;
            			}
HXDLIN( 265)			this->_hx___topExtension = _hx_tmp;
HXLINE( 266)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_275_get_quality)
HXDLIN( 275)		return this->_hx___quality;
            	}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_280_set_quality)
HXLINE( 284)		int _hx_tmp;
HXDLIN( 284)		if ((this->_hx___blurX <= (int)0)) {
HXLINE( 284)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 284)			Float _hx_tmp1 = this->_hx___blurX;
HXDLIN( 284)			_hx_tmp = (::Math_obj::round((_hx_tmp1 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 284)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 285)		int _hx_tmp2;
HXDLIN( 285)		if ((this->_hx___blurY <= (int)0)) {
HXLINE( 285)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 285)			Float _hx_tmp3 = this->_hx___blurY;
HXDLIN( 285)			_hx_tmp2 = (::Math_obj::round((_hx_tmp3 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 285)		this->_hx___verticalPasses = _hx_tmp2;
HXLINE( 287)		this->_hx___numShaderPasses = (this->_hx___horizontalPasses + this->_hx___verticalPasses);
HXLINE( 289)		if ((value != this->_hx___quality)) {
HXLINE( 289)			this->_hx___renderDirty = true;
            		}
HXLINE( 290)		return (this->_hx___quality = value);
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_80_boot)
HXDLIN(  80)		_hx___blurShader =  ::openfl::filters::_BlurFilter::BlurShader_obj::__alloc( HX_CTX );
            	}
}
