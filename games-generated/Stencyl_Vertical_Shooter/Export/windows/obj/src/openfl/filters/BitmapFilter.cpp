...
HX_DEFINE_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_45_new,"openfl.filters.BitmapFilter","new",0x22686a4a,"openfl.filters.BitmapFilter.new","openfl/filters/BitmapFilter.hx",45,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_68_clone,"openfl.filters.BitmapFilter","clone",0x8c417bc7,"openfl.filters.BitmapFilter.clone","openfl/filters/BitmapFilter.hx",68,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_75___applyFilter,"openfl.filters.BitmapFilter","__applyFilter",0xc6240310,"openfl.filters.BitmapFilter.__applyFilter","openfl/filters/BitmapFilter.hx",75,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_83___initShader,"openfl.filters.BitmapFilter","__initShader",0x9b1b6e4b,"openfl.filters.BitmapFilter.__initShader","openfl/filters/BitmapFilter.hx",83,0x1697f5a4)
namespace openfl{
namespace filters{

void BitmapFilter_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_45_new)
HXLINE(  47)		this->_hx___bottomExtension = (int)0;
HXLINE(  48)		this->_hx___leftExtension = (int)0;
HXLINE(  49)		this->_hx___needSecondBitmapData = true;
HXLINE(  50)		this->_hx___numShaderPasses = (int)0;
HXLINE(  51)		this->_hx___preserveObject = false;
HXLINE(  52)		this->_hx___rightExtension = (int)0;
HXLINE(  53)		this->_hx___shaderBlendMode = (int)10;
HXLINE(  54)		this->_hx___topExtension = (int)0;
HXLINE(  55)		this->_hx___smooth = true;
            	}
...
bool BitmapFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BitmapFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_68_clone)
HXDLIN(  68)		return  ::openfl::filters::BitmapFilter_obj::__alloc( HX_CTX );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFilter_obj,clone,return )
 ...
 ::openfl::display::BitmapData BitmapFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_75___applyFilter)
HXDLIN(  75)		return sourceBitmapData;
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(BitmapFilter_obj,_hx___applyFilter,return )
 ...
 ::openfl::display::Shader BitmapFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_83___initShader)
