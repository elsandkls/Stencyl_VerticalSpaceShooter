...
HX_DEFINE_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_200_new,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","new",0xf11da59b,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.new","openfl/filters/ColorMatrixFilter.hx",200,0xb64128b5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_65d84bf4a5bd7bcf_212_init,"openfl.filters._ColorMatrixFilter.ColorMatrixShader","init",0x058bf975,"openfl.filters._ColorMatrixFilter.ColorMatrixShader.init","openfl/filters/ColorMatrixFilter.hx",212,0xb64128b5)
namespace openfl{
namespace filters{
namespace _ColorMatrixFilter{

void ColorMatrixShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_200_new)
...
HXLINE( 202)		super::__construct(null());
HXLINE( 205)		this->uMultipliers->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_1,16);
HXLINE( 206)		this->uOffsets->value = ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_2,4);
...
void ColorMatrixShader_obj::init(::Array< Float > matrix){
            	HX_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_212_init)
HXLINE( 215)		::Array< Float > multipliers = this->uMultipliers->value;
HXLINE( 216)		::Array< Float > offsets = this->uOffsets->value;
HXLINE( 218)		multipliers[(int)0] = matrix->__get((int)0);
HXLINE( 219)		multipliers[(int)1] = matrix->__get((int)1);
HXLINE( 220)		multipliers[(int)2] = matrix->__get((int)2);
HXLINE( 221)		multipliers[(int)3] = matrix->__get((int)3);
HXLINE( 222)		multipliers[(int)4] = matrix->__get((int)5);
HXLINE( 223)		multipliers[(int)5] = matrix->__get((int)6);
HXLINE( 224)		multipliers[(int)6] = matrix->__get((int)7);
HXLINE( 225)		multipliers[(int)7] = matrix->__get((int)8);
HXLINE( 226)		multipliers[(int)8] = matrix->__get((int)10);
HXLINE( 227)		multipliers[(int)9] = matrix->__get((int)11);
HXLINE( 228)		multipliers[(int)10] = matrix->__get((int)12);
HXLINE( 229)		multipliers[(int)11] = matrix->__get((int)13);
HXLINE( 230)		multipliers[(int)12] = matrix->__get((int)15);
HXLINE( 231)		multipliers[(int)13] = matrix->__get((int)16);
HXLINE( 232)		multipliers[(int)14] = matrix->__get((int)17);
HXLINE( 233)		multipliers[(int)15] = matrix->__get((int)18);
HXLINE( 235)		offsets[(int)0] = ((Float)matrix->__get((int)4) / (Float)((Float)255.0));
HXLINE( 236)		offsets[(int)1] = ((Float)matrix->__get((int)9) / (Float)((Float)255.0));
HXLINE( 237)		offsets[(int)2] = ((Float)matrix->__get((int)14) / (Float)((Float)255.0));
HXLINE( 238)		offsets[(int)3] = ((Float)matrix->__get((int)19) / (Float)((Float)255.0));
            	}
