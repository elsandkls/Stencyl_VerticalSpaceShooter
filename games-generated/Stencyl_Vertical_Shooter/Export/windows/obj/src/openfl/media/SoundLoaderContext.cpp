...
HX_DEFINE_STACK_FRAME(_hx_pos_baeaab40d0a56ac0_158_new,"openfl.media.SoundLoaderContext","new",0xafd95147,"openfl.media.SoundLoaderContext.new","openfl/media/SoundLoaderContext.hx",158,0x79afda07)
namespace openfl{
namespace media{
...
bool checkPolicyFile = __o_checkPolicyFile.Default(false);
            	HX_STACKFRAME(&_hx_pos_baeaab40d0a56ac0_158_new)
HXLINE( 160)		this->bufferTime = bufferTime;
HXLINE( 161)		this->checkPolicyFile = checkPolicyFile;
            	}
