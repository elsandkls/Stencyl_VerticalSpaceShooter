...
HX_DEFINE_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_62_new,"openfl.media.SoundTransform","new",0x75fea817,"openfl.media.SoundTransform.new","openfl/media/SoundTransform.hx",62,0xcbc8f637)
HX_LOCAL_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_76_clone,"openfl.media.SoundTransform","clone",0xa03c86d4,"openfl.media.SoundTransform.clone","openfl/media/SoundTransform.hx",76,0xcbc8f637)
namespace openfl{
namespace media{
...
Float panning = __o_panning.Default(0);
            	HX_STACKFRAME(&_hx_pos_b69a1b3bd673fa32_62_new)
HXLINE(  64)		this->volume = vol;
HXLINE(  65)		this->pan = panning;
HXLINE(  66)		this->leftToLeft = (int)0;
HXLINE(  67)		this->leftToRight = (int)0;
HXLINE(  68)		this->rightToLeft = (int)0;
HXLINE(  69)		this->rightToRight = (int)0;
            	}
...
bool SoundTransform_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::media::SoundTransform SoundTransform_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_b69a1b3bd673fa32_76_clone)
HXDLIN(  76)		return  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,this->volume,this->pan);
            	}
