...
HX_DEFINE_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_90_new,"openfl.media.SoundChannel","new",0xfc94e2ae,"openfl.media.SoundChannel.new","openfl/media/SoundChannel.hx",90,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_128_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",128,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_142___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",142,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_157___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",157,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_169_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",169,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_182_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",182,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_196_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",196,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_201_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",201,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_244_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",244,0xa4290000)
namespace openfl{
namespace media{

void SoundChannel_obj::__construct( ::lime::media::AudioSource source, ::openfl::media::SoundTransform soundTransform){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_90_new)
HXLINE(  92)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  94)		this->leftPeak = (int)1;
HXLINE(  95)		this->rightPeak = (int)1;
HXLINE(  97)		if (hx::IsNotNull( soundTransform )) {
HXLINE(  99)			this->_hx___soundTransform = soundTransform;
            		}
            		else {
HXLINE( 103)			this->_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE( 108)		if (hx::IsNotNull( source )) {
HXLINE( 110)			this->_hx___source = source;
HXLINE( 111)			this->_hx___source->onComplete->add(this->source_onComplete_dyn(),null(),null());
HXLINE( 112)			this->_hx___isValid = true;
HXLINE( 114)			this->_hx___source->play();
            		}
HXLINE( 119)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_128_stop)
HXLINE( 130)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 132)		if (!(this->_hx___isValid)) {
HXLINE( 132)			return;
            		}
HXLINE( 135)		this->_hx___source->stop();
HXLINE( 137)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_142___dispose)
HXLINE( 144)		if (!(this->_hx___isValid)) {
HXLINE( 144)			return;
            		}
HXLINE( 147)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE( 148)		this->_hx___source->dispose();
HXLINE( 150)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_157___updateTransform)
HXDLIN( 157)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_169_get_position)
HXLINE( 171)		if (!(this->_hx___isValid)) {
HXLINE( 171)			return (int)0;
            		}
HXLINE( 174)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 174)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_182_set_position)
HXLINE( 184)		if (!(this->_hx___isValid)) {
HXLINE( 184)			return (int)0;
            		}
HXLINE( 187)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 187)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 187)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_196_get_soundTransform)
HXDLIN( 196)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_201_set_soundTransform)
HXLINE( 203)		if (hx::IsNotNull( value )) {
HXLINE( 205)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 206)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 208)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 210)			if ((pan < (int)-1)) {
HXLINE( 210)				pan = (int)-1;
            			}
HXLINE( 211)			if ((pan > (int)1)) {
HXLINE( 211)				pan = (int)1;
            			}
HXLINE( 213)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 215)			if (this->_hx___isValid) {
HXLINE( 218)				this->_hx___source->set_gain(volume);
HXLINE( 220)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 221)				position->x = pan;
HXLINE( 222)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 223)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_244_source_onComplete)
HXLINE( 246)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 248)		this->_hx___dispose();
HXLINE( 249)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
