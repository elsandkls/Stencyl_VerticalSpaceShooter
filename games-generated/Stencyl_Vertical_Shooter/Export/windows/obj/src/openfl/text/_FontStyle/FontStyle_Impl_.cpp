...
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_56_toString,"openfl.text._FontStyle.FontStyle_Impl_","toString",0x0cd38b60,"openfl.text._FontStyle.FontStyle_Impl_.toString","openfl/text/FontStyle.hx",56,0x6b07f79f)
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_15_boot,"openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",15,0x6b07f79f)
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_22_boot,"openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",22,0x6b07f79f)
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_29_boot,"openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",29,0x6b07f79f)
HX_LOCAL_STACK_FRAME(_hx_pos_2a9064c0a4b35973_36_boot,"openfl.text._FontStyle.FontStyle_Impl_","boot",0x44f7d4e6,"openfl.text._FontStyle.FontStyle_Impl_.boot","openfl/text/FontStyle.hx",36,0x6b07f79f)
namespace openfl{
namespace text{
...
::String FontStyle_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_56_toString)
HXDLIN(  56)		switch((int)(value)){
            			case (int)0: {
HXLINE(  58)				return HX_("bold",85,81,1b,41);
            			}
            			break;
            			case (int)1: {
HXLINE(  59)				return HX_("boldItalic",55,96,d1,ad);
            			}
            			break;
            			case (int)2: {
HXLINE(  60)				return HX_("italic",f0,2e,64,06);
            			}
            			break;
            			case (int)3: {
HXLINE(  61)				return HX_("regular",5c,52,88,82);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_15_boot)
HXDLIN(  15)		BOLD = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_22_boot)
HXDLIN(  22)		BOLD_ITALIC = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_29_boot)
HXDLIN(  29)		ITALIC = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2a9064c0a4b35973_36_boot)
HXDLIN(  36)		REGULAR = (int)3;
            	}
}
