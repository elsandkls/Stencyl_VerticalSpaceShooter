...
HX_DEFINE_STACK_FRAME(_hx_pos_769ce4a0cb4bebca_79_new,"openfl.text.TextLineMetrics","new",0x08194531,"openfl.text.TextLineMetrics.new","openfl/text/TextLineMetrics.hx",79,0x3c3b1fbf)
namespace openfl{
namespace text{
...
HXLINE(  84)		this->ascent = ascent;
HXLINE(  85)		this->descent = descent;
HXLINE(  86)		this->leading = leading;
            	}
