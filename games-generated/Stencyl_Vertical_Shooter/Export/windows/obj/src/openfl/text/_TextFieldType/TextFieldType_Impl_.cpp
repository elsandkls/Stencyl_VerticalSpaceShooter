...
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_37_toString,"openfl.text._TextFieldType.TextFieldType_Impl_","toString",0x7192f756,"openfl.text._TextFieldType.TextFieldType_Impl_.toString","openfl/text/TextFieldType.hx",37,0xaebfe8fa)
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_14_boot,"openfl.text._TextFieldType.TextFieldType_Impl_","boot",0xd2688ddc,"openfl.text._TextFieldType.TextFieldType_Impl_.boot","openfl/text/TextFieldType.hx",14,0xaebfe8fa)
HX_LOCAL_STACK_FRAME(_hx_pos_923930f61aa169d2_19_boot,"openfl.text._TextFieldType.TextFieldType_Impl_","boot",0xd2688ddc,"openfl.text._TextFieldType.TextFieldType_Impl_.boot","openfl/text/TextFieldType.hx",19,0xaebfe8fa)
namespace openfl{
namespace text{
...
::String TextFieldType_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_37_toString)
HXDLIN(  37)		switch((int)(value)){
            			case (int)0: {
HXLINE(  39)				return HX_("dynamic",7f,9f,15,36);
            			}
            			break;
            			case (int)1: {
HXLINE(  40)				return HX_("input",0a,c4,1d,be);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_14_boot)
HXDLIN(  14)		DYNAMIC = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_923930f61aa169d2_19_boot)
HXDLIN(  19)		INPUT = (int)1;
            	}
}
