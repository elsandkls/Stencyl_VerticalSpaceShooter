...
HX_LOCAL_STACK_FRAME(_hx_pos_d860189a36ec7114_47_toString,"openfl.text._AntiAliasType.AntiAliasType_Impl_","toString",0xa8e1d554,"openfl.text._AntiAliasType.AntiAliasType_Impl_.toString","openfl/text/AntiAliasType.hx",47,0x9da7f159)
HX_LOCAL_STACK_FRAME(_hx_pos_d860189a36ec7114_20_boot,"openfl.text._AntiAliasType.AntiAliasType_Impl_","boot",0x423514da,"openfl.text._AntiAliasType.AntiAliasType_Impl_.boot","openfl/text/AntiAliasType.hx",20,0x9da7f159)
HX_LOCAL_STACK_FRAME(_hx_pos_d860189a36ec7114_29_boot,"openfl.text._AntiAliasType.AntiAliasType_Impl_","boot",0x423514da,"openfl.text._AntiAliasType.AntiAliasType_Impl_.boot","openfl/text/AntiAliasType.hx",29,0x9da7f159)
namespace openfl{
namespace text{
...
::String AntiAliasType_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_d860189a36ec7114_47_toString)
HXDLIN(  47)		switch((int)(value)){
            			case (int)0: {
HXLINE(  49)				return HX_("advanced",a2,69,7b,3b);
            			}
            			break;
            			case (int)1: {
HXLINE(  50)				return HX_("normal",27,72,69,30);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_d860189a36ec7114_20_boot)
HXDLIN(  20)		ADVANCED = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d860189a36ec7114_29_boot)
HXDLIN(  29)		NORMAL = (int)1;
            	}
}
