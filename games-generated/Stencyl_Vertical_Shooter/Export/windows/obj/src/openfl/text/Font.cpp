...
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_68_new,"openfl.text.Font","new",0xe13d5ce4,"openfl.text.Font.new","openfl/text/Font.hx",68,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_220___fromLimeFont,"openfl.text.Font","__fromLimeFont",0x57c4282a,"openfl.text.Font.__fromLimeFont","openfl/text/Font.hx",220,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_226___initialize,"openfl.text.Font","__initialize",0x3f396f6c,"openfl.text.Font.__initialize","openfl/text/Font.hx",226,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_262_get_fontName,"openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",262,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_273_set_fontName,"openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",273,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_89_enumerateFonts,"openfl.text.Font","enumerateFonts",0x792ac3fc,"openfl.text.Font.enumerateFonts","openfl/text/Font.hx",89,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_94_fromBytes,"openfl.text.Font","fromBytes",0x95ccba25,"openfl.text.Font.fromBytes","openfl/text/Font.hx",94,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_110_fromFile,"openfl.text.Font","fromFile",0x919e3202,"openfl.text.Font.fromFile","openfl/text/Font.hx",110,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_132_loadFromBytes,"openfl.text.Font","loadFromBytes",0x88069d1f,"openfl.text.Font.loadFromBytes","openfl/text/Font.hx",132,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_150_loadFromFile,"openfl.text.Font","loadFromFile",0x74db4c48,"openfl.text.Font.loadFromFile","openfl/text/Font.hx",150,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_168_loadFromName,"openfl.text.Font","loadFromName",0x7a1ef017,"openfl.text.Font.loadFromName","openfl/text/Font.hx",168,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_187_registerFont,"openfl.text.Font","registerFont",0xd99a60ce,"openfl.text.Font.registerFont","openfl/text/Font.hx",187,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_49_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",49,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_50_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",50,0x076bbaac)
namespace openfl{
namespace text{

void Font_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_68_new)
HXDLIN(  68)		super::__construct(name);
            	}
...
void Font_obj::_hx___fromLimeFont( ::lime::text::Font font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_220___fromLimeFont)
HXDLIN( 220)		this->_hx___copyFrom(font);
            	}
...
bool Font_obj::_hx___initialize(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_226___initialize)
HXLINE( 229)		if (!(this->_hx___initialized)) {
HXLINE( 231)			if (hx::IsNotNull( this->src )) {
HXLINE( 234)				if ((this->unitsPerEM == (int)0)) {
HXLINE( 234)					this->_hx___initializeSource();
            				}
HXLINE( 235)				this->_hx___initialized = true;
            			}
            			else {
HXLINE( 237)				bool _hx_tmp;
HXDLIN( 237)				bool _hx_tmp1;
HXDLIN( 237)				if (hx::IsNull( this->src )) {
HXLINE( 237)					_hx_tmp1 = hx::IsNotNull( this->_hx___fontID );
            				}
            				else {
HXLINE( 237)					_hx_tmp1 = false;
            				}
HXDLIN( 237)				if (_hx_tmp1) {
HXLINE( 237)					_hx_tmp = ::openfl::utils::Assets_obj::isLocal(this->_hx___fontID,null(),null());
            				}
            				else {
HXLINE( 237)					_hx_tmp = false;
            				}
HXDLIN( 237)				if (_hx_tmp) {
HXLINE( 239)					this->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(::openfl::utils::Assets_obj::getBytes(this->_hx___fontID)));
HXLINE( 240)					this->_hx___initialized = true;
            				}
            			}
            		}
HXLINE( 247)		return this->_hx___initialized;
            	}
...
::String Font_obj::get_fontName(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_262_get_fontName)
HXDLIN( 262)		return this->name;
            	}
...
::String Font_obj::set_fontName(::String value){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_273_set_fontName)
HXDLIN( 273)		return (this->name = value);
            	}
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_89_enumerateFonts)
HXDLIN(  89)		return ::openfl::text::Font_obj::_hx___registeredFonts;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::text::Font Font_obj::fromBytes( ::openfl::utils::ByteArrayData bytes){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_94_fromBytes)
HXLINE(  96)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE(  98)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
HXLINE( 102)		if (hx::IsNotNull( font->src )) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::text::Font Font_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_110_fromFile)
HXLINE( 112)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 114)		font->_hx___fromFile(path);
HXLINE( 118)		if (hx::IsNotNull( font->src )) {
HXLINE( 118)			return font;
            		}
            		else {
 ...
 ::lime::app::Future Font_obj::loadFromBytes( ::openfl::utils::ByteArrayData bytes){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_132_loadFromBytes)
HXLINE( 134)			 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 135)			font->_hx___fromLimeFont(limeFont);
HXLINE( 137)			return ::lime::app::Future_obj::withValue(font);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_132_loadFromBytes)
HXDLIN( 132)		return ::lime::text::Font_obj::loadFromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes))->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromBytes,return )
 ...
 ::lime::app::Future Font_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_150_loadFromFile)
...
HXLINE( 155)			return ::lime::app::Future_obj::withValue(font);
            	...
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_150_loadFromFile)
HXDLIN( 150)		return ::lime::text::Font_obj::loadFromFile(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromFile,return )
 ...
 ::lime::app::Future Font_obj::loadFromName(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_168_loadFromName)
HXLINE( 170)			 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 171)			font->_hx___fromLimeFont(limeFont);
HXLINE( 173)			return ::lime::app::Future_obj::withValue(font);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_168_loadFromName)
HXDLIN( 168)		return ::lime::text::Font_obj::loadFromName(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
void Font_obj::registerFont( ::Dynamic font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_187_registerFont)
HXLINE( 189)		 ::openfl::text::Font instance = null();
HXLINE( 191)		if (hx::IsNull( ::Type_obj::getClass(font) )) {
HXLINE( 193)			instance = hx::TCast<  ::openfl::text::Font >::cast(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0)));
            		}
            		else {
HXLINE( 197)			instance = hx::TCast<  ::openfl::text::Font >::cast(font);
            		}
HXLINE( 201)		if (hx::IsNotNull( instance )) {
HXLINE( 209)			::openfl::text::Font_obj::_hx___registeredFonts->push(instance);
HXLINE( 210)			::openfl::text::Font_obj::_hx___fontByName->set(instance->name,instance);
            		}
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_49_boot)
HXDLIN(  49)		_hx___fontByName =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_50_boot)
HXDLIN(  50)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
}
