...
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_35_fromInt,"openfl.display._CapsStyle.CapsStyle_Impl_","fromInt",0xdf1ba554,"openfl.display._CapsStyle.CapsStyle_Impl_.fromInt","openfl/display/CapsStyle.hx",35,0x1f3162da)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_56_toInt,"openfl.display._CapsStyle.CapsStyle_Impl_","toInt",0xbad7ec23,"openfl.display._CapsStyle.CapsStyle_Impl_.toInt","openfl/display/CapsStyle.hx",56,0x1f3162da)
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_63_toString,"openfl.display._CapsStyle.CapsStyle_Impl_","toString",0xedfcc21d,"openfl.display._CapsStyle.CapsStyle_Impl_.toString","openfl/display/CapsStyle.hx",63,0x1f3162da)
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_18_boot,"openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",18,0x1f3162da)
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_24_boot,"openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",24,0x1f3162da)
HX_LOCAL_STACK_FRAME(_hx_pos_8e2965ce4f780c2f_30_boot,"openfl.display._CapsStyle.CapsStyle_Impl_","boot",0xb135a923,"openfl.display._CapsStyle.CapsStyle_Impl_.boot","openfl/display/CapsStyle.hx",30,0x1f3162da)
namespace openfl{
namespace display{
...
bool CapsStyle_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic CapsStyle_Impl__obj::fromInt( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_35_fromInt)
HXDLIN(  35)		return value;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CapsStyle_Impl__obj,fromString,return )
 ...
 ::Dynamic CapsStyle_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_56_toInt)
...
::String CapsStyle_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_63_toString)
HXDLIN(  63)		switch((int)(value)){
            			case (int)0: {
HXLINE(  65)				return HX_("none",b8,12,0a,49);
            			}
            			break;
            			case (int)1: {
HXLINE(  66)				return HX_("round",4e,f8,65,ed);
            			}
            			break;
            			case (int)2: {
HXLINE(  67)				return HX_("square",9d,00,f2,58);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_18_boot)
HXDLIN(  18)		NONE = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_24_boot)
HXDLIN(  24)		ROUND = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_8e2965ce4f780c2f_30_boot)
HXDLIN(  30)		SQUARE = (int)2;
            	}
}
