...
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_398_new,"openfl.display.LoaderInfo","new",0xaabc917d,"openfl.display.LoaderInfo.new","openfl/display/LoaderInfo.hx",398,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_436___complete,"openfl.display.LoaderInfo","__complete",0x9858c05c,"openfl.display.LoaderInfo.__complete","openfl/display/LoaderInfo.hx",436,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_454___update,"openfl.display.LoaderInfo","__update",0x44ca06ec,"openfl.display.LoaderInfo.__update","openfl/display/LoaderInfo.hx",454,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_411_create,"openfl.display.LoaderInfo","create",0xe80075ff,"openfl.display.LoaderInfo.create","openfl/display/LoaderInfo.hx",411,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_123_boot,"openfl.display.LoaderInfo","boot",0xb25bbc75,"openfl.display.LoaderInfo.boot","openfl/display/LoaderInfo.hx",123,0x88528a51)
namespace openfl{
namespace display{

void LoaderInfo_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bc206267402385e1_398_new)
HXLINE( 400)		super::__construct(null());
HXLINE( 402)		this->applicationDomain = ::openfl::_hx_system::ApplicationDomain_obj::currentDomain;
HXLINE( 403)		this->bytesLoaded = (int)0;
HXLINE( 404)		this->bytesTotal = (int)0;
HXLINE( 405)		this->childAllowsParent = true;
HXLINE( 406)		this->parameters =  ::Dynamic(hx::Anon_obj::Create(0));
            	}
...
void LoaderInfo_obj::_hx___complete(){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_436___complete)
HXDLIN( 436)		if (!(this->_hx___completed)) {
HXLINE( 438)			if ((this->bytesLoaded < this->bytesTotal)) {
HXLINE( 440)				this->bytesLoaded = this->bytesTotal;
            			}
HXLINE( 444)			this->_hx___update(this->bytesLoaded,this->bytesTotal);
HXLINE( 445)			this->_hx___completed = true;
HXLINE( 447)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
void LoaderInfo_obj::_hx___update(int bytesLoaded,int bytesTotal){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_454___update)
HXLINE( 456)		this->bytesLoaded = bytesLoaded;
HXLINE( 457)		this->bytesTotal = bytesTotal;
HXLINE( 459)		this->dispatchEvent( ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),false,false,bytesLoaded,bytesTotal));
            	}
...
::String LoaderInfo_obj::_hx___rootURL;
 ...
 ::openfl::display::LoaderInfo LoaderInfo_obj::create( ::openfl::display::Loader loader){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_411_create)
HXLINE( 413)		 ::openfl::display::LoaderInfo loaderInfo =  ::openfl::display::LoaderInfo_obj::__alloc( HX_CTX );
HXLINE( 414)		loaderInfo->uncaughtErrorEvents =  ::openfl::events::UncaughtErrorEvents_obj::__alloc( HX_CTX );
HXLINE( 416)		if (hx::IsNotNull( loader )) {
HXLINE( 418)			loaderInfo->loader = loader;
            		}
            		else {
HXLINE( 422)			loaderInfo->url = ::openfl::display::LoaderInfo_obj::_hx___rootURL;
            		}
HXLINE( 426)		return loaderInfo;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bc206267402385e1_123_boot)
HXDLIN( 123)		_hx___rootURL = HX_("",00,00,00,00);
            	}
}
