...
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_53_toString,"openfl.display._PixelSnapping.PixelSnapping_Impl_","toString",0xd1c938f9,"openfl.display._PixelSnapping.PixelSnapping_Impl_.toString","openfl/display/PixelSnapping.hx",53,0x71d03308)
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_17_boot,"openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",17,0x71d03308)
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_28_boot,"openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",28,0x71d03308)
HX_LOCAL_STACK_FRAME(_hx_pos_0f3cf3c73141d162_34_boot,"openfl.display._PixelSnapping.PixelSnapping_Impl_","boot",0x4f8e81ff,"openfl.display._PixelSnapping.PixelSnapping_Impl_.boot","openfl/display/PixelSnapping.hx",34,0x71d03308)
namespace openfl{
namespace display{
...
::String PixelSnapping_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_53_toString)
HXDLIN(  53)		switch((int)(value)){
            			case (int)0: {
HXLINE(  55)				return HX_("always",cf,0e,d7,46);
            			}
            			break;
            			case (int)1: {
HXLINE(  56)				return HX_("auto",6f,df,76,40);
            			...
            			break;
            			case (int)2: {
HXLINE(  57)				return HX_("never",8c,3e,30,99);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_17_boot)
HXDLIN(  17)		ALWAYS = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_28_boot)
HXDLIN(  28)		AUTO = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_0f3cf3c73141d162_34_boot)
HXDLIN(  34)		NEVER = (int)2;
            	}
}
