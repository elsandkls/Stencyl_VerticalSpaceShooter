...
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_46_toInt,"openfl.display._GradientType.GradientType_Impl_","toInt",0x5e8fbadf,"openfl.display._GradientType.GradientType_Impl_.toInt","openfl/display/GradientType.hx",46,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_53_toString,"openfl.display._GradientType.GradientType_Impl_","toString",0xdcddd0e1,"openfl.display._GradientType.GradientType_Impl_.toString","openfl/display/GradientType.hx",53,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_16_boot,"openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",16,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_21_boot,"openfl.display._GradientType.GradientType_Impl_","boot",0xb7af05e7,"openfl.display._GradientType.GradientType_Impl_.boot","openfl/display/GradientType.hx",21,0xadf6e848)
namespace openfl{
namespace display{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(GradientType_Impl__obj,fromString,return )
 ...
 ::Dynamic GradientType_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_46_toInt)
...
::String GradientType_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_53_toString)
HXDLIN(  53)		switch((int)(value)){
            			case (int)0: {
HXLINE(  55)				return HX_("linear",e5,51,a0,ec);
            			}
            			break;
            			case (int)1: {
HXLINE(  56)				return HX_("radial",df,be,f6,b0);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_16_boot)
HXDLIN(  16)		LINEAR = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_21_boot)
HXDLIN(  21)		RADIAL = (int)1;
            	}
}
