...
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_21_fromString,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","fromString",0x5431d0d8,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.fromString","openfl/display/GraphicsPathWinding.hx",21,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_33_toString,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","toString",0x816cca69,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.toString","openfl/display/GraphicsPathWinding.hx",33,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_16_boot,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","boot",0xb4d09b6f,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.boot","openfl/display/GraphicsPathWinding.hx",16,0xa8467880)
HX_LOCAL_STACK_FRAME(_hx_pos_e291141470723f52_17_boot,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_","boot",0xb4d09b6f,"openfl.display._GraphicsPathWinding.GraphicsPathWinding_Impl_.boot","openfl/display/GraphicsPathWinding.hx",17,0xa8467880)
namespace openfl{
namespace display{
...
bool GraphicsPathWinding_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GraphicsPathWinding_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_21_fromString)
HXDLIN(  21)		::String _hx_switch_0 = value;
...
::String GraphicsPathWinding_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_33_toString)
HXDLIN(  33)		switch((int)(value)){
            			case (int)0: {
HXLINE(  35)				return HX_("evenOdd",b5,c6,7e,06);
            			}
            			break;
            			case (int)1: {
HXLINE(  36)				return HX_("nonZero",d5,1e,b4,d1);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_16_boot)
HXDLIN(  16)		EVEN_ODD = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_e291141470723f52_17_boot)
HXDLIN(  17)		NON_ZERO = (int)1;
            	}
}
