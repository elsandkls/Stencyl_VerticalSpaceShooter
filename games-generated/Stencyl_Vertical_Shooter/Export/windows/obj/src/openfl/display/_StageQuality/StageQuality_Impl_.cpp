...
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_54_toString,"openfl.display._StageQuality.StageQuality_Impl_","toString",0x0c5a9f41,"openfl.display._StageQuality.StageQuality_Impl_.toString","openfl/display/StageQuality.hx",54,0x4c0ba3d1)
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_15_boot,"openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",15,0x4c0ba3d1)
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_21_boot,"openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",21,0x4c0ba3d1)
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_27_boot,"openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",27,0x4c0ba3d1)
HX_LOCAL_STACK_FRAME(_hx_pos_0c0edf02bce9ade1_34_boot,"openfl.display._StageQuality.StageQuality_Impl_","boot",0xf44d2447,"openfl.display._StageQuality.StageQuality_Impl_.boot","openfl/display/StageQuality.hx",34,0x4c0ba3d1)
namespace openfl{
namespace display{
...
::String StageQuality_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_54_toString)
HXDLIN(  54)		switch((int)(value)){
            			case (int)0: {
HXLINE(  56)				return HX_("best",24,f1,13,41);
            			}
            			break;
            			case (int)1: {
HXLINE(  57)				return HX_("high",62,37,0e,45);
            			}
            			break;
            			case (int)2: {
HXLINE(  58)				return HX_("low",94,54,52,00);
            			}
            			break;
            			case (int)3: {
HXLINE(  59)				return HX_("medium",75,54,c8,fe);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_15_boot)
HXDLIN(  15)		BEST = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_21_boot)
HXDLIN(  21)		HIGH = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_27_boot)
HXDLIN(  27)		LOW = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_0c0edf02bce9ade1_34_boot)
HXDLIN(  34)		MEDIUM = (int)3;
            	}
}
