...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_83_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",83,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_107_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",107,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_124_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",124,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_129___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",129,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_219___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",219,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_229___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",229,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_241___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",241,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_273_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",273,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_278_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",278,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_292_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",292,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_297_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",297,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_83_new)
HXLINE(  85)		super::__construct(null());
HXLINE(  87)		this->_hx___stage = stage;
HXLINE(  89)		this->_hx___height = (int)0;
HXLINE(  90)		this->_hx___projectionTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  91)		this->_hx___renderTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE(  92)		this->_hx___width = (int)0;
HXLINE(  93)		this->_hx___x = (int)0;
HXLINE(  94)		this->_hx___y = (int)0;
HXLINE(  96)		this->visible = true;
HXLINE(  98)		bool _hx_tmp;
HXDLIN(  98)		if ((stage->stageWidth > (int)0)) {
HXLINE(  98)			_hx_tmp = (stage->stageHeight > (int)0);
            		}
            		else {
HXLINE(  98)			_hx_tmp = false;
            		}
HXDLIN(  98)		if (_hx_tmp) {
HXLINE(  99)			this->_hx___resize(stage->stageWidth,stage->stageHeight);
            		}
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_107_requestContext3D)
HXDLIN( 107)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 109)			this->_hx___contextRequested = true;
HXLINE( 110)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            		else {
HXLINE( 112)			if (!(this->_hx___contextRequested)) {
HXLINE( 114)				this->_hx___contextRequested = true;
HXLINE( 115)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),(int)1);
            			}
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_124_requestContext3DMatchingProfiles)
HXDLIN( 124)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_129___createContext)
HXLINE( 132)		 ::openfl::display::Stage stage = this->_hx___stage;
HXLINE( 133)		 ::openfl::display::DisplayObjectRenderer renderer = stage->_hx___renderer;
HXLINE( 135)		bool _hx_tmp;
HXDLIN( 135)		if ((renderer->_hx___type != HX_("cairo",88,30,19,41))) {
HXLINE( 135)			_hx_tmp = (renderer->_hx___type == HX_("canvas",d8,54,42,b8));
            		}
            		else {
HXLINE( 135)			_hx_tmp = true;
            		}
HXDLIN( 135)		if (_hx_tmp) {
HXLINE( 137)			this->_hx___dispatchError();
HXLINE( 138)			return;
            		}
HXLINE( 142)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 147)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,hx::ObjectPtr<OBJ_>(this));
HXLINE( 149)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 151)			bool _hx_tmp1 = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_219___dispatchError)
HXLINE( 221)		this->_hx___contextRequested = false;
HXLINE( 222)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_229___dispatchCreate)
HXDLIN( 229)		if (this->_hx___contextRequested) {
HXLINE( 231)			this->_hx___contextRequested = false;
HXLINE( 232)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_241___resize)
HXDLIN( 241)		bool _hx_tmp;
HXDLIN( 241)		if ((width == this->_hx___width)) {
HXDLIN( 241)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 241)			_hx_tmp = true;
            		}
HXDLIN( 241)		if (_hx_tmp) {
HXLINE( 252)			 ::openfl::geom::Matrix3D _hx_tmp1 = this->_hx___projectionTransform;
HXDLIN( 252)			int length = null();
HXDLIN( 252)			bool fixed = null();
HXLINE( 253)			int _hx_tmp2;
HXDLIN( 253)			if ((width > (int)0)) {
HXLINE( 253)				_hx_tmp2 = width;
            			}
            			else {
HXLINE( 253)				_hx_tmp2 = (int)1;
            			}
HXLINE( 254)			int _hx_tmp3;
HXDLIN( 254)			if ((height > (int)0)) {
HXLINE( 254)				_hx_tmp3 = height;
            			}
            			else {
HXLINE( 254)				_hx_tmp3 = (int)1;
            			}
HXLINE( 252)			_hx_tmp1->copyRawDataFrom( ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< Float >::__new(16)->init(0,((Float)((Float)2.0) / (Float)_hx_tmp2))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,((Float)((Float)-2.0) / (Float)_hx_tmp3))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0)),true),null(),null());
HXLINE( 259)			this->_hx___renderTransform->identity();
HXLINE( 260)			this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 261)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 263)			this->_hx___width = width;
HXLINE( 264)			this->_hx___height = height;
            		}
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_273_get_x)
HXDLIN( 273)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_278_set_x)
HXLINE( 280)		if ((this->_hx___x == value)) {
HXLINE( 280)			return value;
            		}
HXLINE( 281)		this->_hx___x = value;
HXLINE( 282)		this->_hx___renderTransform->identity();
HXLINE( 283)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 284)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_292_get_y)
HXDLIN( 292)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_297_set_y)
HXLINE( 299)		if ((this->_hx___y == value)) {
HXLINE( 299)			return value;
            		}
HXLINE( 300)		this->_hx___y = value;
HXLINE( 301)		this->_hx___renderTransform->identity();
HXLINE( 302)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
HXLINE( 303)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
