...
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_52_fromString,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","fromString",0x8e1d4c22,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.fromString","openfl/display/InterpolationMethod.hx",52,0x1fa1c725)
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_65_toInt,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","toInt",0x246b454d,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.toInt","openfl/display/InterpolationMethod.hx",65,0x1fa1c725)
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_72_toString,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","toString",0x7209ff33,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.toString","openfl/display/InterpolationMethod.hx",72,0x1fa1c725)
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_26_boot,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","boot",0x602d2339,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.boot","openfl/display/InterpolationMethod.hx",26,0x1fa1c725)
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_40_boot,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","boot",0x602d2339,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.boot","openfl/display/InterpolationMethod.hx",40,0x1fa1c725)
namespace openfl{
namespace display{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(InterpolationMethod_Impl__obj,fromInt,return )
 ...
 ::Dynamic InterpolationMethod_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_52_fromString)
HXDLIN(  52)		::String _hx_switch_0 = value;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(InterpolationMethod_Impl__obj,fromString,return )
 ...
 ::Dynamic InterpolationMethod_Impl__obj::toInt( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_65_toInt)
...
::String InterpolationMethod_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_72_toString)
HXDLIN(  72)		switch((int)(value)){
            			case (int)0: {
HXLINE(  74)				return HX_("linearRGB",28,a2,44,d9);
            			}
            			break;
            			case (int)1: {
HXLINE(  75)				return HX_("rgb",0d,db,56,00);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_26_boot)
HXDLIN(  26)		LINEAR_RGB = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_40_boot)
HXDLIN(  40)		RGB = (int)1;
            	}
}
