...
HX_LOCAL_STACK_FRAME(_hx_pos_84d55d5087e49b43_63___updateGL,"openfl.display.ShaderParameter_Int","__updateGL",0x96a05a12,"openfl.display.ShaderParameter_Int.__updateGL","openfl/display/ShaderParameter.hx",63,0xc89f13e6)
HX_LOCAL_STACK_FRAME(_hx_pos_84d55d5087e49b43_259___updateGLFromBuffer,"openfl.display.ShaderParameter_Int","__updateGLFromBuffer",0x6a822abc,"openfl.display.ShaderParameter_Int.__updateGLFromBuffer","openfl/display/ShaderParameter.hx",259,0xc89f13e6)
HX_LOCAL_STACK_FRAME(_hx_pos_84d55d5087e49b43_416_set_name,"openfl.display.ShaderParameter_Int","set_name",0x1ffdeccc,"openfl.display.ShaderParameter_Int.set_name","openfl/display/ShaderParameter.hx",416,0xc89f13e6)
namespace openfl{
namespace display{
...
void ShaderParameter_Int_obj::_hx___updateGLFromBuffer( ::openfl::display3D::Context3D context, ::lime::utils::ArrayBufferView buffer,int position,int length,int bufferOffset){
            	HX_STACKFRAME(&_hx_pos_84d55d5087e49b43_259___updateGLFromBuffer)
...
::String ShaderParameter_Int_obj::set_name(::String value){
            	HX_STACKFRAME(&_hx_pos_84d55d5087e49b43_416_set_name)
