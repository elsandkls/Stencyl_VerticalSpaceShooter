...
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_17_fromString,"openfl.display._StageScaleMode.StageScaleMode_Impl_","fromString",0xa7123530,"openfl.display._StageScaleMode.StageScaleMode_Impl_.fromString","openfl/display/StageScaleMode.hx",17,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_31_toString,"openfl.display._StageScaleMode.StageScaleMode_Impl_","toString",0x32c6e8c1,"openfl.display._StageScaleMode.StageScaleMode_Impl_.toString","openfl/display/StageScaleMode.hx",31,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_10_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",10,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_11_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",11,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_12_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",12,0x7043b2c3)
HX_LOCAL_STACK_FRAME(_hx_pos_2edbc9abb5fbacde_13_boot,"openfl.display._StageScaleMode.StageScaleMode_Impl_","boot",0x3976adc7,"openfl.display._StageScaleMode.StageScaleMode_Impl_.boot","openfl/display/StageScaleMode.hx",13,0x7043b2c3)
namespace openfl{
namespace display{
...
bool StageScaleMode_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageScaleMode_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_17_fromString)
...
::String StageScaleMode_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_31_toString)
HXDLIN(  31)		switch((int)(value)){
            			case (int)0: {
HXLINE(  33)				return HX_("exactFit",52,58,22,25);
            			}
            			break;
            			case (int)1: {
HXLINE(  34)				return HX_("noBorder",0d,48,2a,34);
            			}
            			break;
            			case (int)2: {
HXLINE(  35)				return HX_("noScale",89,52,d2,4b);
            			}
            			break;
            			case (int)3: {
HXLINE(  36)				return HX_("showAll",24,58,96,7b);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_10_boot)
HXDLIN(  10)		EXACT_FIT = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_11_boot)
HXDLIN(  11)		NO_BORDER = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_12_boot)
HXDLIN(  12)		NO_SCALE = (int)2;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2edbc9abb5fbacde_13_boot)
HXDLIN(  13)		SHOW_ALL = (int)3;
            	}
}
