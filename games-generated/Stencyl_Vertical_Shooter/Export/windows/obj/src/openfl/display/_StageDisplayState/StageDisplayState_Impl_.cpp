...
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_43_toString,"openfl.display._StageDisplayState.StageDisplayState_Impl_","toString",0x6b7dca23,"openfl.display._StageDisplayState.StageDisplayState_Impl_.toString","openfl/display/StageDisplayState.hx",43,0x75a7a3fd)
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_14_boot,"openfl.display._StageDisplayState.StageDisplayState_Impl_","boot",0xd144b629,"openfl.display._StageDisplayState.StageDisplayState_Impl_.boot","openfl/display/StageDisplayState.hx",14,0x75a7a3fd)
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_19_boot,"openfl.display._StageDisplayState.StageDisplayState_Impl_","boot",0xd144b629,"openfl.display._StageDisplayState.StageDisplayState_Impl_.boot","openfl/display/StageDisplayState.hx",19,0x75a7a3fd)
HX_LOCAL_STACK_FRAME(_hx_pos_c56d6b3d9ce820b8_24_boot,"openfl.display._StageDisplayState.StageDisplayState_Impl_","boot",0xd144b629,"openfl.display._StageDisplayState.StageDisplayState_Impl_.boot","openfl/display/StageDisplayState.hx",24,0x75a7a3fd)
namespace openfl{
namespace display{
...
::String StageDisplayState_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_43_toString)
HXDLIN(  43)		switch((int)(value)){
            			case (int)0: {
HXLINE(  45)				return HX_("fullScreen",5b,ae,48,2e);
            			}
            			break;
            			case (int)1: {
HXLINE(  46)				return HX_("fullScreenInteractive",47,df,d1,02);
            			}
            			break;
            			case (int)2: {
...
{
{
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_14_boot)
HXDLIN(  14)		FULL_SCREEN = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_19_boot)
HXDLIN(  19)		FULL_SCREEN_INTERACTIVE = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_c56d6b3d9ce820b8_24_boot)
HXDLIN(  24)		NORMAL = (int)2;
            	}
}
