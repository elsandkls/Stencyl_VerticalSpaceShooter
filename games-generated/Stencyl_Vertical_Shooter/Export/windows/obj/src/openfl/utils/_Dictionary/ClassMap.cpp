...
HX_DEFINE_STACK_FRAME(_hx_pos_e4d60601e770703e_180_new,"openfl.utils._Dictionary.ClassMap","new",0xf688c28a,"openfl.utils._Dictionary.ClassMap.new","openfl/utils/Dictionary.hx",180,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_201_exists,"openfl.utils._Dictionary.ClassMap","exists",0xb39161f2,"openfl.utils._Dictionary.ClassMap.exists","openfl/utils/Dictionary.hx",201,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_208_get,"openfl.utils._Dictionary.ClassMap","get",0xf68372c0,"openfl.utils._Dictionary.ClassMap.get","openfl/utils/Dictionary.hx",208,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_224_keys,"openfl.utils._Dictionary.ClassMap","keys",0xbf25d48a,"openfl.utils._Dictionary.ClassMap.keys","openfl/utils/Dictionary.hx",224,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_231_iterator,"openfl.utils._Dictionary.ClassMap","iterator",0xc9353f84,"openfl.utils._Dictionary.ClassMap.iterator","openfl/utils/Dictionary.hx",231,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_236_remove,"openfl.utils._Dictionary.ClassMap","remove",0xf839e05a,"openfl.utils._Dictionary.ClassMap.remove","openfl/utils/Dictionary.hx",236,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_244_set,"openfl.utils._Dictionary.ClassMap","set",0xf68c8dcc,"openfl.utils._Dictionary.ClassMap.set","openfl/utils/Dictionary.hx",244,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_e4d60601e770703e_256_toString,"openfl.utils._Dictionary.ClassMap","toString",0x6e09c642,"openfl.utils._Dictionary.ClassMap.toString","openfl/utils/Dictionary.hx",256,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void ClassMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e4d60601e770703e_180_new)
HXLINE( 182)		this->types =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 183)		this->values =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool ClassMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_201_exists)
HXDLIN( 201)		::Dynamic this1 = this->types;
HXDLIN( 201)		return ( ( ::haxe::ds::StringMap)(this1) )->exists(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,exists,return )
 ...
 ::Dynamic ClassMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_208_get)
HXDLIN( 208)		::Dynamic this1 = this->values;
HXDLIN( 208)		return ( ( ::haxe::ds::StringMap)(this1) )->get(::Type_obj::getClassName(key));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassMap_obj,get,return )
 ...
 ::Dynamic ClassMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_224_keys)
HXDLIN( 224)		return this->types->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ClassMap_obj,keys,return )
 ...
 ::Dynamic ClassMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_231_iterator)
HXDLIN( 231)		return this->values->iterator();
            	}
...
bool ClassMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_236_remove)
HXLINE( 238)		::String name = ::Type_obj::getClassName(key);
HXLINE( 239)		if (!(this->types->remove(name))) {
HXLINE( 239)			return this->values->remove(name);
            		}
            		else {
...
void ClassMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_244_set)
HXLINE( 246)		::String name = ::Type_obj::getClassName(key);
HXLINE( 248)		this->types->set(name,key);
HXLINE( 249)		this->values->set(name,value);
            	}
...
::String ClassMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_e4d60601e770703e_256_toString)
HXDLIN( 256)		return this->values->toString();
            	}
