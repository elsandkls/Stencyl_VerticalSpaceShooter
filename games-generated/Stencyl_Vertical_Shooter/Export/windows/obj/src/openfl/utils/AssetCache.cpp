...
HX_DEFINE_STACK_FRAME(_hx_pos_3b51c86a24135fbd_18_new,"openfl.utils.AssetCache","new",0x1485f77f,"openfl.utils.AssetCache.new","openfl/utils/AssetCache.hx",18,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_50_clear,"openfl.utils.AssetCache","clear",0x6abcde6c,"openfl.utils.AssetCache.clear","openfl/utils/AssetCache.hx",50,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_101_getBitmapData,"openfl.utils.AssetCache","getBitmapData",0x142af5ce,"openfl.utils.AssetCache.getBitmapData","openfl/utils/AssetCache.hx",101,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_108_getFont,"openfl.utils.AssetCache","getFont",0xa580b024,"openfl.utils.AssetCache.getFont","openfl/utils/AssetCache.hx",108,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_115_getSound,"openfl.utils.AssetCache","getSound",0xa75444da,"openfl.utils.AssetCache.getSound","openfl/utils/AssetCache.hx",115,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_122_hasBitmapData,"openfl.utils.AssetCache","hasBitmapData",0xd20f5192,"openfl.utils.AssetCache.hasBitmapData","openfl/utils/AssetCache.hx",122,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_129_hasFont,"openfl.utils.AssetCache","hasFont",0xa24220e8,"openfl.utils.AssetCache.hasFont","openfl/utils/AssetCache.hx",129,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_136_hasSound,"openfl.utils.AssetCache","hasSound",0xd3d57f96,"openfl.utils.AssetCache.hasSound","openfl/utils/AssetCache.hx",136,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_141_removeBitmapData,"openfl.utils.AssetCache","removeBitmapData",0x9ca8649e,"openfl.utils.AssetCache.removeBitmapData","openfl/utils/AssetCache.hx",141,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_151_removeFont,"openfl.utils.AssetCache","removeFont",0x136c22f4,"openfl.utils.AssetCache.removeFont","openfl/utils/AssetCache.hx",151,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_161_removeSound,"openfl.utils.AssetCache","removeSound",0x676d480a,"openfl.utils.AssetCache.removeSound","openfl/utils/AssetCache.hx",161,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_173_setBitmapData,"openfl.utils.AssetCache","setBitmapData",0x5930d7da,"openfl.utils.AssetCache.setBitmapData","openfl/utils/AssetCache.hx",173,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_180_setFont,"openfl.utils.AssetCache","setFont",0x98824130,"openfl.utils.AssetCache.setFont","openfl/utils/AssetCache.hx",180,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_187_setSound,"openfl.utils.AssetCache","setSound",0x55b19e4e,"openfl.utils.AssetCache.setSound","openfl/utils/AssetCache.hx",187,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_201_get_enabled,"openfl.utils.AssetCache","get_enabled",0xec9842b7,"openfl.utils.AssetCache.get_enabled","openfl/utils/AssetCache.hx",201,0xffd5b4cf)
HX_LOCAL_STACK_FRAME(_hx_pos_3b51c86a24135fbd_208_set_enabled,"openfl.utils.AssetCache","set_enabled",0xf70549c3,"openfl.utils.AssetCache.set_enabled","openfl/utils/AssetCache.hx",208,0xffd5b4cf)
namespace openfl{
namespace utils{

void AssetCache_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_3b51c86a24135fbd_18_new)
HXLINE(  27)		this->_hx___enabled = true;
HXLINE(  41)		this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  42)		this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  43)		this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
void AssetCache_obj::clear(::String prefix){
            	HX_GC_STACKFRAME(&_hx_pos_3b51c86a24135fbd_50_clear)
HXDLIN(  50)		if (hx::IsNull( prefix )) {
HXLINE(  52)			this->bitmapData =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  53)			this->font =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  54)			this->sound =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
            		else {
HXLINE(  58)			 ::Dynamic keys = this->bitmapData->keys();
HXLINE(  60)			{
HXLINE(  60)				 ::Dynamic key = keys;
...
HXLINE(  62)					if (::StringTools_obj::startsWith(key1,prefix)) {
HXLINE(  64)						this->removeBitmapData(key1);
            					}
            				}
            			}
HXLINE(  70)			 ::Dynamic keys1 = this->font->keys();
HXLINE(  72)			{
HXLINE(  72)				 ::Dynamic key2 = keys1;
HXDLIN(  72)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  72)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  74)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE(  76)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE(  82)			 ::Dynamic keys2 = this->sound->keys();
HXLINE(  84)			{
HXLINE(  84)				 ::Dynamic key4 = keys2;
HXDLIN(  84)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  84)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  86)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE(  88)						this->removeSound(key5);
            					}
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,clear,(void))
 ...
 ::openfl::display::BitmapData AssetCache_obj::getBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_101_getBitmapData)
HXDLIN( 101)		return this->bitmapData->get(id).StaticCast<  ::openfl::display::BitmapData >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getBitmapData,return )
 ...
 ::openfl::text::Font AssetCache_obj::getFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_108_getFont)
HXDLIN( 108)		return this->font->get(id).StaticCast<  ::openfl::text::Font >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AssetCache_obj,getFont,return )
 ...
 ::openfl::media::Sound AssetCache_obj::getSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_115_getSound)
HXDLIN( 115)		return this->sound->get(id).StaticCast<  ::openfl::media::Sound >();
            	}
...
bool AssetCache_obj::hasBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_122_hasBitmapData)
HXDLIN( 122)		return this->bitmapData->exists(id);
            	}
...
bool AssetCache_obj::hasFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_129_hasFont)
HXDLIN( 129)		return this->font->exists(id);
            	}
...
bool AssetCache_obj::hasSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_136_hasSound)
HXDLIN( 136)		return this->sound->exists(id);
            	}
...
bool AssetCache_obj::removeBitmapData(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_141_removeBitmapData)
HXLINE( 144)		::lime::utils::Assets_obj::cache->image->remove(id);
HXLINE( 146)		return this->bitmapData->remove(id);
            	}
...
bool AssetCache_obj::removeFont(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_151_removeFont)
HXLINE( 154)		::lime::utils::Assets_obj::cache->font->remove(id);
HXLINE( 156)		return this->font->remove(id);
            	}
...
bool AssetCache_obj::removeSound(::String id){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_161_removeSound)
HXLINE( 164)		::lime::utils::Assets_obj::cache->audio->remove(id);
HXLINE( 166)		return this->sound->remove(id);
            	}
...
void AssetCache_obj::setBitmapData(::String id, ::openfl::display::BitmapData bitmapData){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_173_setBitmapData)
HXDLIN( 173)		this->bitmapData->set(id,bitmapData);
            	}
...
void AssetCache_obj::setFont(::String id, ::openfl::text::Font font){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_180_setFont)
HXDLIN( 180)		this->font->set(id,font);
            	}
...
void AssetCache_obj::setSound(::String id, ::openfl::media::Sound sound){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_187_setSound)
HXDLIN( 187)		this->sound->set(id,sound);
            	}
...
bool AssetCache_obj::get_enabled(){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_201_get_enabled)
HXDLIN( 201)		return this->_hx___enabled;
            	}
...
bool AssetCache_obj::set_enabled(bool value){
            	HX_STACKFRAME(&_hx_pos_3b51c86a24135fbd_208_set_enabled)
HXDLIN( 208)		return (this->_hx___enabled = value);
            	}
