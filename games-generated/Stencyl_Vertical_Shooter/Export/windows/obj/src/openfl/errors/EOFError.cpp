...
HX_DEFINE_STACK_FRAME(_hx_pos_6527ad318e200d9c_25_new,"openfl.errors.EOFError","new",0xc20c3743,"openfl.errors.EOFError.new","openfl/errors/EOFError.hx",25,0x8db2236d)
namespace openfl{
namespace errors{

void EOFError_obj::__construct(::String message,hx::Null< int >  __o_id){
int id = __o_id.Default(0);
            	HX_STACKFRAME(&_hx_pos_6527ad318e200d9c_25_new)
HXLINE(  27)		super::__construct(HX_("End of file was encountered",fb,7f,d6,0b));
HXLINE(  29)		this->name = HX_("EOFError",8c,e5,0a,43);
HXLINE(  30)		this->errorID = (int)2030;
            	}
