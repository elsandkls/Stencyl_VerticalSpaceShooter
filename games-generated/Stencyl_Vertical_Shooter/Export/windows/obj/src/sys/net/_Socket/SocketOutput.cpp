...
HX_DEFINE_STACK_FRAME(_hx_pos_c4021adb20347ad9_77_new,"sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Socket.hx",77,0xd3e64dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_c4021adb20347ad9_80_writeByte,"sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Socket.hx",80,0xd3e64dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_c4021adb20347ad9_94_writeBytes,"sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Socket.hx",94,0xd3e64dbb)
HX_LOCAL_STACK_FRAME(_hx_pos_c4021adb20347ad9_106_close,"sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Socket.hx",106,0xd3e64dbb)
namespace sys{
namespace net{
namespace _Socket{

void SocketOutput_obj::__construct( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_c4021adb20347ad9_77_new)
...
void SocketOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_c4021adb20347ad9_80_writeByte)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_c4021adb20347ad9_94_writeBytes)
HXDLIN(  94)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void SocketOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c4021adb20347ad9_106_close)
