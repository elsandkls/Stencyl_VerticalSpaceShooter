...
HX_DEFINE_STACK_FRAME(_hx_pos_1e53caa73002206d_35_new,"sys.net.Host","new",0x056496ac,"sys.net.Host.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Host.hx",35,0x341fb526)
HX_LOCAL_STACK_FRAME(_hx_pos_ff56b210f7567b42_59___init__,"::sys::net::Host_obj","__init__",0x01315e0e,"::sys::net::Host_obj.__init__","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Host.hx",59,0x341fb526)
HX_LOCAL_STACK_FRAME(_hx_pos_1e53caa73002206d_47_toString,"sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/net/Host.hx",47,0x341fb526)
namespace sys{
namespace net{

void Host_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_1e53caa73002206d_35_new)
...
void Host_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_ff56b210f7567b42_59___init__)
HXDLIN(  59)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_1e53caa73002206d_47_toString)
