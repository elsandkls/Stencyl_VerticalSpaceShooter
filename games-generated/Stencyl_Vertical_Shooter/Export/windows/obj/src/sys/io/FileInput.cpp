...
HX_DEFINE_STACK_FRAME(_hx_pos_058ada8550aec00e_32_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/FileInput.hx",32,0xc6f8c39b)
HX_LOCAL_STACK_FRAME(_hx_pos_058ada8550aec00e_36_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/FileInput.hx",36,0xc6f8c39b)
HX_LOCAL_STACK_FRAME(_hx_pos_058ada8550aec00e_47_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/FileInput.hx",47,0xc6f8c39b)
HX_LOCAL_STACK_FRAME(_hx_pos_058ada8550aec00e_57_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/FileInput.hx",57,0xc6f8c39b)
HX_LOCAL_STACK_FRAME(_hx_pos_058ada8550aec00e_67_tell,"sys.io.FileInput","tell",0x38812eb8,"sys.io.FileInput.tell","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/FileInput.hx",67,0xc6f8c39b)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_058ada8550aec00e_32_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_058ada8550aec00e_36_readByte)
HXDLIN(  36)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_058ada8550aec00e_47_readBytes)
HXDLIN(  47)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_058ada8550aec00e_57_close)
...
int FileInput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_058ada8550aec00e_67_tell)
HXDLIN(  67)		return _hx_std_file_tell(this->_hx___f);
            	}
