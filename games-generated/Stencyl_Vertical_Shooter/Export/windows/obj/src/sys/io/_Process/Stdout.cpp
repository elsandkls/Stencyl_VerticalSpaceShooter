...
HX_DEFINE_STACK_FRAME(_hx_pos_44e044b00df25375_63_new,"sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/Process.hx",63,0x4a4f22fa)
HX_LOCAL_STACK_FRAME(_hx_pos_44e044b00df25375_69_readByte,"sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/Process.hx",69,0x4a4f22fa)
HX_LOCAL_STACK_FRAME(_hx_pos_44e044b00df25375_75_readBytes,"sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/sys/io/Process.hx",75,0x4a4f22fa)
namespace sys{
namespace io{
namespace _Process{

void Stdout_obj::__construct( ::Dynamic p,bool out){
            	HX_STACKFRAME(&_hx_pos_44e044b00df25375_63_new)
HXLINE(  64)		this->p = p;
...
int Stdout_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_44e044b00df25375_69_readByte)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_44e044b00df25375_75_readBytes)
