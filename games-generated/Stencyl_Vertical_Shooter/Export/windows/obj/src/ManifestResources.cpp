...
HXLINE(  43)			::ManifestResources_obj::rootPath = (::sys::FileSystem_obj::absolutePath(::haxe::io::Path_obj::directory(::Sys_obj::programPath())) + HX_("/",2f,00,00,00));
            		}
...
HXLINE(  72)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
