...
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_45_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",45,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_115_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",115,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_183_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",183,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_211_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",211,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_245_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",245,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_262_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",262,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_287_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",287,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_315_trim,"StringTools","trim",0x2908d066,"StringTools.trim","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",315,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_331_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",331,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_386_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",386,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_396_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",396,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_488_quoteUnixArg,"StringTools","quoteUnixArg",0xc59dac56,"StringTools.quoteUnixArg","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",488,0xca7dc0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_521_quoteWinArg,"StringTools","quoteWinArg",0x7e16b8f2,"StringTools.quoteWinArg","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",521,0xca7dc0f7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c106eb22407b680b_506_boot,"StringTools","boot",0x1d20b7b6,"StringTools.boot","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/StringTools.hx",506,0xca7dc0f7)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_45_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_115_urlDecode)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_183_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_211_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_245_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_262_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_287_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_315_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_331_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_386_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_396_hex)
...
::String StringTools_obj::quoteUnixArg(::String argument){
            	HX_GC_STACKFRAME(&_hx_pos_c106eb22407b680b_488_quoteUnixArg)
...
::String StringTools_obj::quoteWinArg(::String argument,bool escapeMetaCharacters){
            	HX_GC_STACKFRAME(&_hx_pos_c106eb22407b680b_521_quoteWinArg)
...
{
{
            	HX_STACKFRAME(&_hx_pos_c106eb22407b680b_506_boot)
