...
HX_DEFINE_STACK_FRAME(_hx_pos_3eda1783b7a2240b_74_new,"haxe.ds.GenericStack_hscript_Token","new",0xda5f4ac8,"haxe.ds.GenericStack_hscript_Token.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",74,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_81_add,"haxe.ds.GenericStack_hscript_Token","add",0xda556c89,"haxe.ds.GenericStack_hscript_Token.add","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",81,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_90_first,"haxe.ds.GenericStack_hscript_Token","first",0x104a5c98,"haxe.ds.GenericStack_hscript_Token.first","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",90,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_98_pop,"haxe.ds.GenericStack_hscript_Token","pop",0xda60d7f9,"haxe.ds.GenericStack_hscript_Token.pop","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",98,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_112_isEmpty,"haxe.ds.GenericStack_hscript_Token","isEmpty",0x0c5cacab,"haxe.ds.GenericStack_hscript_Token.isEmpty","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",112,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_124_remove,"haxe.ds.GenericStack_hscript_Token","remove",0xac2392dc,"haxe.ds.GenericStack_hscript_Token.remove","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",124,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_147_iterator,"haxe.ds.GenericStack_hscript_Token","iterator",0x90d21686,"haxe.ds.GenericStack_hscript_Token.iterator","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",147,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_3eda1783b7a2240b_173_toString,"haxe.ds.GenericStack_hscript_Token","toString",0x35a69d44,"haxe.ds.GenericStack_hscript_Token.toString","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",173,0x70c30393)
namespace haxe{
namespace ds{

void GenericStack_hscript_Token_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_74_new)
            	}
...
void GenericStack_hscript_Token_obj::add( ::hscript::Token item){
            	HX_GC_STACKFRAME(&_hx_pos_3eda1783b7a2240b_81_add)
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,add,(void))
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::first(){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_90_first)
...
HX_DEFINE_DYNAMIC_FUNC0(GenericStack_hscript_Token_obj,first,return )
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_98_pop)
...
bool GenericStack_hscript_Token_obj::isEmpty(){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_112_isEmpty)
...
bool GenericStack_hscript_Token_obj::remove( ::hscript::Token v){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_124_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,remove,return )
 ...
 ::Dynamic GenericStack_hscript_Token_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_3eda1783b7a2240b_147_iterator)
...
::String GenericStack_hscript_Token_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_3eda1783b7a2240b_173_toString)
