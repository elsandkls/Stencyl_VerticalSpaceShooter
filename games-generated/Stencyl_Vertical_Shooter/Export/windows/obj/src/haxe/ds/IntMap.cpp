...
HX_DEFINE_STACK_FRAME(_hx_pos_23306208439745f0_53_new,"haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",53,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_56_set,"haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",56,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_60_get,"haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",60,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_64_exists,"haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",64,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_68_remove,"haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",68,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_71_keys,"haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",71,0x90bdbcfe)
HX_LOCAL_STACK_FRAME(_hx_pos_23306208439745f0_76_iterator,"haxe.ds.IntMap","iterator",0x4dc7ddd8,"haxe.ds.IntMap.iterator","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/haxe/ds/IntMap.hx",76,0x90bdbcfe)
namespace haxe{
namespace ds{

void IntMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_53_new)
            	}
...
void IntMap_obj::set(int key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_56_set)
...
HX_DEFINE_DYNAMIC_FUNC2(IntMap_obj,set,(void))
 ...
 ::Dynamic IntMap_obj::get(int key){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_60_get)
...
bool IntMap_obj::exists(int key){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_64_exists)
...
bool IntMap_obj::remove(int key){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_68_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(IntMap_obj,remove,return )
 ...
 ::Dynamic IntMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_71_keys)
...
HX_DEFINE_DYNAMIC_FUNC0(IntMap_obj,keys,return )
 ...
 ::Dynamic IntMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_23306208439745f0_76_iterator)
