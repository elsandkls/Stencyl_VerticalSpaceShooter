...
HX_DEFINE_STACK_FRAME(_hx_pos_e7acd57190e33f02_35_new,"haxe.ds.GenericCell_hscript_Token","new",0x1c0e2ea2,"haxe.ds.GenericCell_hscript_Token.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",35,0x70c30393)
namespace haxe{
namespace ds{

void GenericCell_hscript_Token_obj::__construct( ::hscript::Token elt, ::haxe::ds::GenericCell_hscript_Token next){
            	HX_STACKFRAME(&_hx_pos_e7acd57190e33f02_35_new)
