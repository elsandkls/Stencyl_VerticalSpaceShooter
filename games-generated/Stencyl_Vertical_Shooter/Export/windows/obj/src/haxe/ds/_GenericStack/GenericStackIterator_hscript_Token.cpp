...
HX_DEFINE_STACK_FRAME(_hx_pos_cee2826fea67b4ed_45_new,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","new",0xbf5d5a94,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",45,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_cee2826fea67b4ed_42_hasNext,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","hasNext",0xccb359a1,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.hasNext","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",42,0x70c30393)
HX_LOCAL_STACK_FRAME(_hx_pos_cee2826fea67b4ed_43_next,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","next",0xb251e83f,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.next","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/ds/GenericStack.hx",43,0x70c30393)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_hscript_Token_obj::__construct( ::haxe::ds::GenericCell_hscript_Token head){
            	HX_STACKFRAME(&_hx_pos_cee2826fea67b4ed_45_new)
