...
HX_LOCAL_STACK_FRAME(_hx_pos_c7740197cb0698bb_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Output.hx",47,0x9fe2feda)
HX_LOCAL_STACK_FRAME(_hx_pos_c7740197cb0698bb_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Output.hx",57,0x9fe2feda)
HX_LOCAL_STACK_FRAME(_hx_pos_c7740197cb0698bb_93_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Output.hx",93,0x9fe2feda)
HX_LOCAL_STACK_FRAME(_hx_pos_c7740197cb0698bb_123_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Output.hx",123,0x9fe2feda)
HX_LOCAL_STACK_FRAME(_hx_pos_c7740197cb0698bb_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Output.hx",278,0x9fe2feda)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_c7740197cb0698bb_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_c7740197cb0698bb_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c7740197cb0698bb_93_close)
            	}
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_c7740197cb0698bb_123_writeFullBytes)
...
void Output_obj::writeString(::String s){
            	HX_STACKFRAME(&_hx_pos_c7740197cb0698bb_278_writeString)
