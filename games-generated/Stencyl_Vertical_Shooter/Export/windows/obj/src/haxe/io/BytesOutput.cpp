...
HX_DEFINE_STACK_FRAME(_hx_pos_a506e1810efbcaf6_40_new,"haxe.io.BytesOutput","new",0x130b775e,"haxe.io.BytesOutput.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/BytesOutput.hx",40,0x515422d5)
HX_LOCAL_STACK_FRAME(_hx_pos_a506e1810efbcaf6_55_writeByte,"haxe.io.BytesOutput","writeByte",0xed1b0d05,"haxe.io.BytesOutput.writeByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/BytesOutput.hx",55,0x515422d5)
HX_LOCAL_STACK_FRAME(_hx_pos_a506e1810efbcaf6_59_writeBytes,"haxe.io.BytesOutput","writeBytes",0x8a9057ce,"haxe.io.BytesOutput.writeBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/BytesOutput.hx",59,0x515422d5)
HX_LOCAL_STACK_FRAME(_hx_pos_a506e1810efbcaf6_137_getBytes,"haxe.io.BytesOutput","getBytes",0x9fe35837,"haxe.io.BytesOutput.getBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/BytesOutput.hx",137,0x515422d5)
namespace haxe{
namespace io{

void BytesOutput_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_a506e1810efbcaf6_40_new)
...
void BytesOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_a506e1810efbcaf6_55_writeByte)
HXDLIN(  55)		this->b->b->push(c);
            	}


int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_a506e1810efbcaf6_59_writeBytes)
HXLINE(  64)		{
...
HXLINE(  66)		return len;
 ...
 ::haxe::io::Bytes BytesOutput_obj::getBytes(){
            	HX_STACKFRAME(&_hx_pos_a506e1810efbcaf6_137_getBytes)
