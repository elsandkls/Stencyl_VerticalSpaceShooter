...
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_51_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",51,0x6264cb17)
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_64_readBytes,"haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",64,0x6264cb17)
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_92_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",92,0x6264cb17)
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_135_readFullBytes,"haxe.io.Input","readFullBytes",0x3db9a162,"haxe.io.Input.readFullBytes","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",135,0x6264cb17)
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_177_readLine,"haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",177,0x6264cb17)
HX_LOCAL_STACK_FRAME(_hx_pos_b7b0c7da22cc4c0f_303_readString,"haxe.io.Input","readString",0xfdebd00b,"haxe.io.Input.readString","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/io/Input.hx",303,0x6264cb17)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_51_readByte)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_64_readBytes)
HXLINE(  65)		int k = len;
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_92_close)
            	}
...
void Input_obj::readFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_135_readFullBytes)
...
::String Input_obj::readLine(){
            	HX_GC_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_177_readLine)
...
::String Input_obj::readString(int len){
            	HX_STACKFRAME(&_hx_pos_b7b0c7da22cc4c0f_303_readString)
