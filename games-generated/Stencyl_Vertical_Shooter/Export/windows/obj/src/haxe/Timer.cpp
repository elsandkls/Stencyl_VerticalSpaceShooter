...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_287_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","haxe/Timer.hx",287,0x1a690682)
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_309___check,"haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",309,0x1a690682)
...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_277_stamp,"haxe.Timer","stamp",0xebba8a32,"haxe.Timer.stamp","haxe/Timer.hx",277,0x1a690682)
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_287_stop)
HXDLIN( 287)		if (this->mRunning) {
HXLINE( 289)			this->mRunning = false;
HXLINE( 291)			{
HXLINE( 291)				int _g1 = (int)0;
HXDLIN( 291)				int _g = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 291)				while((_g1 < _g)){
HXLINE( 291)					_g1 = (_g1 + (int)1);
HXDLIN( 291)					int i = (_g1 - (int)1);
HXLINE( 293)					if (hx::IsEq( ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >(),hx::ObjectPtr<OBJ_>(this) )) {
HXLINE( 295)						::haxe::Timer_obj::sRunningTimers[i] = null();
...
void Timer_obj::_hx___check(Float inTime){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_309___check)
HXDLIN( 309)		if ((inTime >= this->mFireAt)) {
HXLINE( 311)			 ::haxe::Timer _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 311)			_hx_tmp->mFireAt = (_hx_tmp->mFireAt + this->mTime);
HXLINE( 312)			this->run();
            		}
            	}
...
HXLINE( 262)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 262)		Float t0;
HXDLIN( 262)		if ((timer > (int)0)) {
HXLINE( 262)			t0 = ((Float)timer / (Float)(int)1000);
            		}
            		else {
HXLINE( 262)			t0 = (int)0;
            		}
...
HXDLIN( 264)		int timer1 = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 264)		Float _hx_tmp1;
HXDLIN( 264)		if ((timer1 > (int)0)) {
HXLINE( 264)			_hx_tmp1 = ((Float)timer1 / (Float)(int)1000);
            		}
            		else {
HXLINE( 264)			_hx_tmp1 = (int)0;
            		}
HXDLIN( 264)		_hx_tmp(((_hx_tmp1 - t0) + HX_("s",73,00,00,00)),pos);
HXLINE( 265)		return r;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_277_stamp)
HXLINE( 279)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 280)		if ((timer > (int)0)) {
HXLINE( 280)			return ((Float)timer / (Float)(int)1000);
            		}
            		else {
HXLINE( 280)			return (int)0;
            		}
HXDLIN( 280)		return ((Float)0.);
            	}
