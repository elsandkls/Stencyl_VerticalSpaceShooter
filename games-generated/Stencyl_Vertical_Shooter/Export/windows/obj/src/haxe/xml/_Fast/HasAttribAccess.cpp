...
HX_DEFINE_STACK_FRAME(_hx_pos_76447d07fdec67d1_67_new,"haxe.xml._Fast.HasAttribAccess","new",0x4d025ce8,"haxe.xml._Fast.HasAttribAccess.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",67,0x3dbc7184)
namespace haxe{
namespace xml{
namespace _Fast{

void HasAttribAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_76447d07fdec67d1_67_new)
