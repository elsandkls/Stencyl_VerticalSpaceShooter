...
HX_DEFINE_STACK_FRAME(_hx_pos_aa2efdc434998afc_97_new,"haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",97,0x3dbc7184)
namespace haxe{
namespace xml{
namespace _Fast{

void NodeListAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_aa2efdc434998afc_97_new)
