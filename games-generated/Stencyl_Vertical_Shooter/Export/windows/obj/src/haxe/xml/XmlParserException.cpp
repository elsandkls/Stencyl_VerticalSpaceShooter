...
HX_DEFINE_STACK_FRAME(_hx_pos_6d48a82db7d555ff_77_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Parser.hx",77,0xd9ca5fa1)
HX_LOCAL_STACK_FRAME(_hx_pos_6d48a82db7d555ff_98_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Parser.hx",98,0xd9ca5fa1)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_6d48a82db7d555ff_77_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_6d48a82db7d555ff_98_toString)
