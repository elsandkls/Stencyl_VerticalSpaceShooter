...
HX_DEFINE_STACK_FRAME(_hx_pos_ddd33d32d19bdcd2_83_new,"haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",83,0x3dbc7184)
HX_LOCAL_STACK_FRAME(_hx_pos_ddd33d32d19bdcd2_87_resolve,"haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",87,0x3dbc7184)
namespace haxe{
namespace xml{
namespace _Fast{

void HasNodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_ddd33d32d19bdcd2_83_new)
...
bool HasNodeAccess_obj::resolve(::String name){
            	HX_STACKFRAME(&_hx_pos_ddd33d32d19bdcd2_87_resolve)
HXDLIN(  87)		return ( (bool)(this->_hx___x->elementsNamed(name)->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) );
            	}
