...
HX_DEFINE_STACK_FRAME(_hx_pos_e5777b7381a795c0_29_new,"haxe.xml._Fast.NodeAccess","new",0xde09fb0a,"haxe.xml._Fast.NodeAccess.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",29,0x3dbc7184)
HX_LOCAL_STACK_FRAME(_hx_pos_e5777b7381a795c0_32_resolve,"haxe.xml._Fast.NodeAccess","resolve",0x0e91da96,"haxe.xml._Fast.NodeAccess.resolve","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/xml/Fast.hx",32,0x3dbc7184)
namespace haxe{
namespace xml{
namespace _Fast{

void NodeAccess_obj::__construct( ::Xml x){
            	HX_STACKFRAME(&_hx_pos_e5777b7381a795c0_29_new)
...
bool NodeAccess_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::xml::Fast NodeAccess_obj::resolve(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_e5777b7381a795c0_32_resolve)
