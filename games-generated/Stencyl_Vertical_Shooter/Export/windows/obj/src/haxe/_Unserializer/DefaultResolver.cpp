...
HX_DEFINE_STACK_FRAME(_hx_pos_31d1c9e32878e0b6_476_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",476,0xebd935cd)
HX_LOCAL_STACK_FRAME(_hx_pos_31d1c9e32878e0b6_477_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",477,0xebd935cd)
HX_LOCAL_STACK_FRAME(_hx_pos_31d1c9e32878e0b6_478_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",478,0xebd935cd)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_31d1c9e32878e0b6_476_new)
            	}
...
hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_31d1c9e32878e0b6_477_resolveClass)
...
hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_31d1c9e32878e0b6_478_resolveEnum)
