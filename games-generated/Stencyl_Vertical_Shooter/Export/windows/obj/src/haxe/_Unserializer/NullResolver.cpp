...
HX_DEFINE_STACK_FRAME(_hx_pos_6fe1f3d32fca2729_482_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",482,0xebd935cd)
HX_LOCAL_STACK_FRAME(_hx_pos_6fe1f3d32fca2729_483_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",483,0xebd935cd)
HX_LOCAL_STACK_FRAME(_hx_pos_6fe1f3d32fca2729_484_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/haxe/Unserializer.hx",484,0xebd935cd)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6fe1f3d32fca2729_482_new)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6fe1f3d32fca2729_483_resolveClass)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6fe1f3d32fca2729_484_resolveEnum)
