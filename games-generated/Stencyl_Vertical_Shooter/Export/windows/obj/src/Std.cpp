...
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_24_is,"Std","is",0x3c56d6f5,"Std.is","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",24,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_28_instance,"Std","instance",0x1431f4e0,"Std.instance","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",28,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_32_string,"Std","string",0xcf48855c,"Std.string","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",32,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_36_int,"Std","int",0x8fa53b84,"Std.int","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",36,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_40_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",40,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_44_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",44,0xe9c9d777)
HX_LOCAL_STACK_FRAME(_hx_pos_4178b2a86a714a81_47_random,"Std","random",0x75a77e8e,"Std.random","Z:\\Program Files (x86)\\Stencyl\\plaf\\haxe-std\\std/cpp/_std/Std.hx",47,0xe9c9d777)
...
bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_24_is)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_28_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_32_string)
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_36_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_40_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_44_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_4178b2a86a714a81_47_random)
