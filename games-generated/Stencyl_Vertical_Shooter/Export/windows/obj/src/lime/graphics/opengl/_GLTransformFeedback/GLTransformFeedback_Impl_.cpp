...
HX_LOCAL_STACK_FRAME(_hx_pos_37b54af8ff8dc0de_15_fromInt,"lime.graphics.opengl._GLTransformFeedback.GLTransformFeedback_Impl_","fromInt",0xec7828f7,"lime.graphics.opengl._GLTransformFeedback.GLTransformFeedback_Impl_.fromInt","lime/graphics/opengl/GLTransformFeedback.hx",15,0xac3a3468)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLTransformFeedback_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLTransformFeedback_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_37b54af8ff8dc0de_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)11,id);
            	}
