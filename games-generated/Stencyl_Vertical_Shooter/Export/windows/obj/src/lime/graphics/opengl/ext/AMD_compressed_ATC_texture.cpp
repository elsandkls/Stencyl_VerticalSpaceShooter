...
HX_DEFINE_STACK_FRAME(_hx_pos_7a228448205ba8a3_7_new,"lime.graphics.opengl.ext.AMD_compressed_ATC_texture","new",0xe60aeca9,"lime.graphics.opengl.ext.AMD_compressed_ATC_texture.new","lime/graphics/opengl/ext/AMD_compressed_ATC_texture.hx",7,0x5b741105)
namespace lime{
namespace graphics{
namespace opengl{
namespace ext{
...
void AMD_compressed_ATC_texture_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7a228448205ba8a3_7_new)
HXLINE(  12)		this->ATC_RGBA_INTERPOLATED_ALPHA_AMD = (int)34798;
HXLINE(  11)		this->ATC_RGBA_EXPLICIT_ALPHA_AMD = (int)35987;
HXLINE(  10)		this->ATC_RGB_AMD = (int)35986;
            	}
