...
HX_LOCAL_STACK_FRAME(_hx_pos_58c1710013d07f8a_15_fromInt,"lime.graphics.opengl._GLTexture.GLTexture_Impl_","fromInt",0x91dae20b,"lime.graphics.opengl._GLTexture.GLTexture_Impl_.fromInt","lime/graphics/opengl/GLTexture.hx",15,0xaab4bc1e)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLTexture_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLTexture_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_58c1710013d07f8a_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)4,id);
            	}
