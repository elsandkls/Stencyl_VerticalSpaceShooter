...
HX_LOCAL_STACK_FRAME(_hx_pos_7e0f8c2e5e5d29bc_15_fromInt,"lime.graphics.opengl._GLVertexArrayObject.GLVertexArrayObject_Impl_","fromInt",0xdded5f3d,"lime.graphics.opengl._GLVertexArrayObject.GLVertexArrayObject_Impl_.fromInt","lime/graphics/opengl/GLVertexArrayObject.hx",15,0x5a893a25)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLVertexArrayObject_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLVertexArrayObject_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_7e0f8c2e5e5d29bc_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)7,id);
            	}
