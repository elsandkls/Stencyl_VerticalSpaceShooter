...
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_117_new,"lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",117,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_137_clone,"lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",137,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_223_get_src,"lime.graphics.ImageBuffer","get_src",0x9748e67e,"lime.graphics.ImageBuffer.get_src","lime/graphics/ImageBuffer.hx",223,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_230_set_src,"lime.graphics.ImageBuffer","set_src",0x8a4a778a,"lime.graphics.ImageBuffer.set_src","lime/graphics/ImageBuffer.hx",230,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_262_get_stride,"lime.graphics.ImageBuffer","get_stride",0xb11b1cbf,"lime.graphics.ImageBuffer.get_stride","lime/graphics/ImageBuffer.hx",262,0x6475c2cd)
namespace lime{
namespace graphics{
...
int bitsPerPixel = __o_bitsPerPixel.Default(32);
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_117_new)
HXLINE( 119)		this->data = data;
HXLINE( 120)		this->width = width;
HXLINE( 121)		this->height = height;
HXLINE( 122)		this->bitsPerPixel = bitsPerPixel;
HXLINE( 123)		int _hx_tmp;
HXDLIN( 123)		if (hx::IsNull( format )) {
HXLINE( 123)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 123)			_hx_tmp = format;
            		}
HXDLIN( 123)		this->format = _hx_tmp;
HXLINE( 124)		this->premultiplied = false;
HXLINE( 125)		this->transparent = true;
            	}
...
bool ImageBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_137_clone)
HXLINE( 139)		 ::lime::graphics::ImageBuffer buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this->data,this->width,this->height,this->bitsPerPixel,null());
HXLINE( 185)		if (hx::IsNotNull( this->data )) {
HXLINE( 187)			 ::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::alloc(this->data->byteLength);
HXLINE( 188)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 189)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 189)			if (hx::IsNotNull( bytes )) {
HXLINE( 189)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 189)				int in_byteOffset = (int)0;
HXDLIN( 189)				if ((in_byteOffset < (int)0)) {
HXLINE( 189)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 189)				if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 189)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 189)				int bufferByteLength = bytes->length;
...
HXDLIN( 189)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 189)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 189)					if ((newByteLength < (int)0)) {
HXLINE( 189)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 189)				_this->buffer = bytes;
...
HXLINE( 189)				HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            			}
HXDLIN( 189)			buffer->data = this1;
            		}
HXLINE( 194)		buffer->bitsPerPixel = this->bitsPerPixel;
HXLINE( 195)		buffer->format = this->format;
HXLINE( 196)		buffer->premultiplied = this->premultiplied;
HXLINE( 197)		buffer->transparent = this->transparent;
HXLINE( 198)		return buffer;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,clone,return )
 ...
 ::Dynamic ImageBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_223_get_src)
HXDLIN( 223)		return this->_hx___srcCustom;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_230_set_src)
HXLINE( 251)		this->_hx___srcCustom = value;
...
int ImageBuffer_obj::get_stride(){
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_262_get_stride)
HXDLIN( 262)		return (this->width * (int)4);
            	}
