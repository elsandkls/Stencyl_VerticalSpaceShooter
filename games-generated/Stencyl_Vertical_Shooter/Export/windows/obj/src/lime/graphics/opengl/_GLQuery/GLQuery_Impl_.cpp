...
HX_LOCAL_STACK_FRAME(_hx_pos_82fc8ff80fd7e425_15_fromInt,"lime.graphics.opengl._GLQuery.GLQuery_Impl_","fromInt",0xfb88d665,"lime.graphics.opengl._GLQuery.GLQuery_Impl_.fromInt","lime/graphics/opengl/GLQuery.hx",15,0x69cab751)
namespace lime{
namespace graphics{
namespace opengl{
namespace _GLQuery{
...
bool GLQuery_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLQuery_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_82fc8ff80fd7e425_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)8,id);
            	}
