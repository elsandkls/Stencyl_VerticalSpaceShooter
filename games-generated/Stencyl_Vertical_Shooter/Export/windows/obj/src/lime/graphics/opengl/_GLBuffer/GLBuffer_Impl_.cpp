...
HX_LOCAL_STACK_FRAME(_hx_pos_0f2401efb1b32638_15_fromInt,"lime.graphics.opengl._GLBuffer.GLBuffer_Impl_","fromInt",0x6ac84e1b,"lime.graphics.opengl._GLBuffer.GLBuffer_Impl_.fromInt","lime/graphics/opengl/GLBuffer.hx",15,0xd18082c3)
namespace lime{
namespace graphics{
namespace opengl{
namespace _GLBuffer{
...
bool GLBuffer_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLBuffer_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_0f2401efb1b32638_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)3,id);
            	}
