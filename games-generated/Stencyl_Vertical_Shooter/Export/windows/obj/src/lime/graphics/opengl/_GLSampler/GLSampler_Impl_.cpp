...
HX_LOCAL_STACK_FRAME(_hx_pos_3ddd19a8470d1ea4_15_fromInt,"lime.graphics.opengl._GLSampler.GLSampler_Impl_","fromInt",0x2f824e25,"lime.graphics.opengl._GLSampler.GLSampler_Impl_.fromInt","lime/graphics/opengl/GLSampler.hx",15,0x764fda11)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLSampler_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLSampler_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_3ddd19a8470d1ea4_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)9,id);
            	}
