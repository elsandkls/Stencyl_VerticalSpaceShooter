...
HX_DEFINE_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3341_new,"lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GL.hx",3341,0xa5aa2623)
HX_LOCAL_STACK_FRAME(_hx_pos_def54b8cacb52d8e_3346_fromInt,"lime.graphics.opengl.GLObject","fromInt",0x6703afb0,"lime.graphics.opengl.GLObject.fromInt","lime/graphics/opengl/GL.hx",3346,0xa5aa2623)
namespace lime{
namespace graphics{
namespace opengl{

void GLObject_obj::__construct(int id){
            	HX_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3341_new)
HXDLIN(3341)		this->id = id;
            	}
...
bool GLObject_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLObject_obj::fromInt(int type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_def54b8cacb52d8e_3346_fromInt)
HXLINE(3348)		if ((id == (int)0)) {
HXLINE(3348)			return null();
            		}
HXLINE(3351)		 ::hx::Object * object = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_from_id(id,type);
HXLINE(3353)		if (hx::IsNotEq( object,hx::DynamicPtr(null()) )) {
HXLINE(3355)			return ( ( ::Dynamic)(object) );
            		}
HXLINE(3359)		object = hx::DynamicPtr( ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id));
HXLINE(3360)		( ( ::Dynamic)(object) )->__SetField(HX_("ptr",ee,61,55,00),( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,type,object)) ),hx::paccDynamic);
HXLINE(3361)		return ( ( ::Dynamic)(object) );
            	}
