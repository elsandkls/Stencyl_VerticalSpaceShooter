...
HX_LOCAL_STACK_FRAME(_hx_pos_0c684fbb9993b6aa_15_fromInt,"lime.graphics.opengl._GLRenderbuffer.GLRenderbuffer_Impl_","fromInt",0x11b02c9b,"lime.graphics.opengl._GLRenderbuffer.GLRenderbuffer_Impl_.fromInt","lime/graphics/opengl/GLRenderbuffer.hx",15,0x63850e6d)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLRenderbuffer_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLRenderbuffer_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_0c684fbb9993b6aa_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)6,id);
            	}
