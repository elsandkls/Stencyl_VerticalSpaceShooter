...
HX_LOCAL_STACK_FRAME(_hx_pos_09e78a4290817425_15_fromInt,"lime.graphics.opengl._GLFramebuffer.GLFramebuffer_Impl_","fromInt",0xbb8569af,"lime.graphics.opengl._GLFramebuffer.GLFramebuffer_Impl_.fromInt","lime/graphics/opengl/GLFramebuffer.hx",15,0x2d1110cc)
namespace lime{
namespace graphics{
namespace opengl{
...
bool GLFramebuffer_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLFramebuffer_Impl__obj::fromInt(int id){
            	HX_STACKFRAME(&_hx_pos_09e78a4290817425_15_fromInt)
HXDLIN(  15)		return ::lime::graphics::opengl::GLObject_obj::fromInt((int)5,id);
            	}
