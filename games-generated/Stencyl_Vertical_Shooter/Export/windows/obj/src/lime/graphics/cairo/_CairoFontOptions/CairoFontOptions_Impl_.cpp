...
HXDLIN(  20)		 ::Dynamic this1 = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_create()) );
...
HXDLIN(  41)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_get_antialias(hx::DynamicPtr(this1));
            	}
...
HXLINE(  52)		::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_set_antialias(hx::DynamicPtr(this1),value);
...
HXDLIN(  63)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_get_hint_metrics(hx::DynamicPtr(this1));
            	}
...
HXLINE(  74)		::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_set_hint_metrics(hx::DynamicPtr(this1),value);
...
HXDLIN(  86)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_get_hint_style(hx::DynamicPtr(this1));
            	}
...
HXLINE(  97)		::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_set_hint_style(hx::DynamicPtr(this1),value);
...
HXDLIN( 108)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_get_subpixel_order(hx::DynamicPtr(this1));
            	}
...
HXLINE( 119)		::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_font_options_set_subpixel_order(hx::DynamicPtr(this1),value);
