...
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_80_destroyContext,"lime.media.openal.ALC","destroyContext",0x9b5c4701,"lime.media.openal.ALC.destroyContext","lime/media/openal/ALC.hx",80,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_86_getContextsDevice,"lime.media.openal.ALC","getContextsDevice",0x197cc724,"lime.media.openal.ALC.getContextsDevice","lime/media/openal/ALC.hx",86,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_106_getCurrentContext,"lime.media.openal.ALC","getCurrentContext",0x166a9280,"lime.media.openal.ALC.getCurrentContext","lime/media/openal/ALC.hx",106,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_126_getError,"lime.media.openal.ALC","getError",0xb0a3653e,"lime.media.openal.ALC.getError","lime/media/openal/ALC.hx",126,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_136_getErrorString,"lime.media.openal.ALC","getErrorString",0x9cb484af,"lime.media.openal.ALC.getErrorString","lime/media/openal/ALC.hx",136,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_150_getIntegerv,"lime.media.openal.ALC","getIntegerv",0x44f57d42,"lime.media.openal.ALC.getIntegerv","lime/media/openal/ALC.hx",150,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_169_getString,"lime.media.openal.ALC","getString",0x9e1cd69b,"lime.media.openal.ALC.getString","lime/media/openal/ALC.hx",169,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_187_makeContextCurrent,"lime.media.openal.ALC","makeContextCurrent",0x65611584,"lime.media.openal.ALC.makeContextCurrent","lime/media/openal/ALC.hx",187,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_195_openDevice,"lime.media.openal.ALC","openDevice",0x31de24ec,"lime.media.openal.ALC.openDevice","lime/media/openal/ALC.hx",195,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_215_pauseDevice,"lime.media.openal.ALC","pauseDevice",0x636035c0,"lime.media.openal.ALC.pauseDevice","lime/media/openal/ALC.hx",215,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_224_processContext,"lime.media.openal.ALC","processContext",0xe14e9a2c,"lime.media.openal.ALC.processContext","lime/media/openal/ALC.hx",224,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_233_resumeDevice,"lime.media.openal.ALC","resumeDevice",0x6ff2aa0f,"lime.media.openal.ALC.resumeDevice","lime/media/openal/ALC.hx",233,0x4354dabb)
HX_LOCAL_STACK_FRAME(_hx_pos_3ab4d7f5cd522c83_242_suspendContext,"lime.media.openal.ALC","suspendContext",0x143578bf,"lime.media.openal.ALC.suspendContext","lime/media/openal/ALC.hx",242,0x4354dabb)
...
HXDLIN(  44)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_close_device(hx::DynamicPtr(device));
            	}
...
HXLINE(  63)		 ::hx::Object * handle = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_create_context(hx::DynamicPtr(device),hx::DynamicPtr(attrlist));
HXLINE(  65)		if (hx::IsNotEq( handle,hx::DynamicPtr(null()) )) {
HXLINE(  67)			 ::Dynamic this1 = ( ( ::Dynamic)(handle) );
...
void ALC_obj::destroyContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_80_destroyContext)
HXDLIN(  80)		::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_destroy_context(hx::DynamicPtr(context));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,destroyContext,(void))
 ...
 ::Dynamic ALC_obj::getContextsDevice( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_86_getContextsDevice)
HXLINE(  89)		 ::Dynamic handle = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_contexts_device(hx::DynamicPtr(context))) );
HXLINE(  91)		if (hx::IsNotNull( handle )) {
HXLINE(  93)			 ::Dynamic this1 = handle;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,getContextsDevice,return )
 ...
 ::Dynamic ALC_obj::getCurrentContext(){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_106_getCurrentContext)
HXLINE( 109)		 ::Dynamic handle = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_current_context()) );
HXLINE( 111)		if (hx::IsNotNull( handle )) {
HXLINE( 113)			 ::Dynamic this1 = handle;
...
int ALC_obj::getError( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_126_getError)
HXDLIN( 126)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_error(hx::DynamicPtr(device));
            	}
...
::String ALC_obj::getErrorString( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_136_getErrorString)
HXDLIN( 136)		int _g = ::lime::media::openal::ALC_obj::getError(device);
HXDLIN( 136)		switch((int)(_g)){
            			case (int)40961: {
HXLINE( 138)				return HX_("INVALID_DEVICE: Invalid device (or no device?)",8d,16,8a,9d);
            			}
            			break;
            			case (int)40962: {
HXLINE( 139)				return HX_("INVALID_CONTEXT: Invalid context (or no context?)",56,39,91,8b);
            			}
            			break;
            			case (int)40963: {
HXLINE( 140)				return HX_("INVALID_ENUM: Invalid enum value",0a,d7,df,59);
            			}
            			break;
            			case (int)40964: {
HXLINE( 141)				return HX_("INVALID_VALUE: Invalid param value",a6,0e,30,55);
            			}
            			break;
            			case (int)40965: {
HXLINE( 142)				return HX_("OUT_OF_MEMORY: OpenAL has run out of memory",b0,dd,fb,0a);
            			}
            			break;
            			default:{
...
::Array< int > ALC_obj::getIntegerv( ::Dynamic device,int param,int size){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_150_getIntegerv)
HXLINE( 153)		 ::hx::Object * result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_integerv(hx::DynamicPtr(device),param,size);
HXLINE( 160)		return ( ( ::Dynamic)(result) );
            	}
...
::String ALC_obj::getString( ::Dynamic device,int param){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_169_getString)
HXLINE( 172)		 ::hx::Object * result = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_get_string(hx::DynamicPtr(device),param);
HXLINE( 176)		return ( ( ::Dynamic)(result) );
            	}
...
bool ALC_obj::makeContextCurrent( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_187_makeContextCurrent)
HXDLIN( 187)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_make_context_current(hx::DynamicPtr(context));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ALC_obj,makeContextCurrent,return )
 ...
 ::Dynamic ALC_obj::openDevice(::String deviceName){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_195_openDevice)
HXLINE( 198)		 ::hx::Object * handle = ::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_open_device(deviceName);
HXLINE( 200)		if (hx::IsNotEq( handle,hx::DynamicPtr(null()) )) {
HXLINE( 202)			 ::Dynamic this1 = ( ( ::Dynamic)(handle) );
...
void ALC_obj::pauseDevice( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_215_pauseDevice)
HXDLIN( 215)		::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_pause_device(hx::DynamicPtr(device));
            	}
...
void ALC_obj::processContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_224_processContext)
HXDLIN( 224)		::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_process_context(hx::DynamicPtr(context));
            	}
...
void ALC_obj::resumeDevice( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_233_resumeDevice)
HXDLIN( 233)		::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_resume_device(hx::DynamicPtr(device));
            	}
...
void ALC_obj::suspendContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_3ab4d7f5cd522c83_242_suspendContext)
HXDLIN( 242)		::lime::_internal::backend::native::NativeCFFI_obj::lime_alc_suspend_context(hx::DynamicPtr(context));
            	}
