...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_474_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",474,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_503_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",503,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_87_fromBase64,"lime.media.AudioBuffer","fromBase64",0xbd10aef4,"lime.media.AudioBuffer.fromBase64","lime/media/AudioBuffer.hx",87,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_143_fromBytes,"lime.media.AudioBuffer","fromBytes",0x20c94aa6,"lime.media.AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",143,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_185_fromFile,"lime.media.AudioBuffer","fromFile",0x1084eca1,"lime.media.AudioBuffer.fromFile","lime/media/AudioBuffer.hx",185,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_243_fromFiles,"lime.media.AudioBuffer","fromFiles",0x63ca20b2,"lime.media.AudioBuffer.fromFiles","lime/media/AudioBuffer.hx",243,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_271_fromVorbisFile,"lime.media.AudioBuffer","fromVorbisFile",0x6dde6b54,"lime.media.AudioBuffer.fromVorbisFile","lime/media/AudioBuffer.hx",271,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_365_loadFromFile,"lime.media.AudioBuffer","loadFromFile",0x735d4267,"lime.media.AudioBuffer.loadFromFile","lime/media/AudioBuffer.hx",365,0xf6fabaad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_414_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",414,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_382_loadFromFiles,"lime.media.AudioBuffer","loadFromFiles",0x7e3cd82c,"lime.media.AudioBuffer.loadFromFiles","lime/media/AudioBuffer.hx",382,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_423___getCodec,"lime.media.AudioBuffer","__getCodec",0x720a859b,"lime.media.AudioBuffer.__getCodec","lime/media/AudioBuffer.hx",423,0xf6fabaad)
namespace lime{
namespace media{
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_474_get_src)
HXDLIN( 474)		return this->_hx___srcVorbisFile;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_503_set_src)
HXDLIN( 503)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::vorbis::VorbisFile)(value) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,set_src,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBase64(::String base64String){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_87_fromBase64)
HXLINE(  89)		if (hx::IsNull( base64String )) {
HXLINE(  89)			return null();
            		}
HXLINE( 108)		::Array< ::String > base64StringSplit = base64String.split(HX_(",",2c,00,00,00));
HXLINE( 109)		::String base64StringNoEncoding = base64StringSplit->__get((base64StringSplit->length - (int)1));
HXLINE( 110)		 ::haxe::io::Bytes bytes = ::haxe::crypto::Base64_obj::decode(base64StringNoEncoding,null());
HXLINE( 111)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 112)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 112)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 112)		if (hx::IsNotNull( buffer )) {
...
HXDLIN( 112)			int bufferByteLength = buffer->length;
...
HXDLIN( 112)		audioBuffer->data = this1;
HXLINE( 114)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_bytes(hx::DynamicPtr(bytes),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBase64,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_143_fromBytes)
HXLINE( 145)		if (hx::IsNull( bytes )) {
HXLINE( 145)			return null();
            		}
HXLINE( 157)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 158)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 158)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 158)		if (hx::IsNotNull( buffer )) {
HXLINE( 158)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 158)			int in_byteOffset = (int)0;
HXDLIN( 158)			if ((in_byteOffset < (int)0)) {
HXLINE( 158)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 158)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 158)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 158)			int bufferByteLength = buffer->length;
HXDLIN( 158)			int elementSize = _this->bytesPerElement;
HXDLIN( 158)			int newByteLength = bufferByteLength;
HXDLIN( 158)			{
HXLINE( 158)				newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN( 158)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 158)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 158)				if ((newByteLength < (int)0)) {
HXLINE( 158)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN( 158)			_this->buffer = buffer;
HXDLIN( 158)			_this->byteOffset = in_byteOffset;
HXDLIN( 158)			_this->byteLength = newByteLength;
HXDLIN( 158)			_this->length = ::Std_obj::_hx_int(((Float)newByteLength / (Float)_this->bytesPerElement));
HXDLIN( 158)			this1 = _this;
            		}
            		else {
HXLINE( 158)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 158)		audioBuffer->data = this1;
HXLINE( 160)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_bytes(hx::DynamicPtr(bytes),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromBytes,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_185_fromFile)
HXLINE( 187)		if (hx::IsNull( path )) {
HXLINE( 187)			return null();
            		}
HXLINE( 211)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 212)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 212)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 212)		if (hx::IsNotNull( buffer )) {
HXLINE( 212)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 212)			int in_byteOffset = (int)0;
HXDLIN( 212)			if ((in_byteOffset < (int)0)) {
HXLINE( 212)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 212)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 212)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 212)			int bufferByteLength = buffer->length;
HXDLIN( 212)			int elementSize = _this->bytesPerElement;
HXDLIN( 212)			int newByteLength = bufferByteLength;
HXDLIN( 212)			{
HXLINE( 212)				newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN( 212)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 212)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 212)				if ((newByteLength < (int)0)) {
HXLINE( 212)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
HXDLIN( 212)			_this->buffer = buffer;
HXDLIN( 212)			_this->byteOffset = in_byteOffset;
HXDLIN( 212)			_this->byteLength = newByteLength;
HXDLIN( 212)			_this->length = ::Std_obj::_hx_int(((Float)newByteLength / (Float)_this->bytesPerElement));
HXDLIN( 212)			this1 = _this;
            		}
            		else {
HXLINE( 212)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            		}
HXDLIN( 212)		audioBuffer->data = this1;
HXLINE( 214)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_audio_load_file(hx::DynamicPtr(path),hx::DynamicPtr(audioBuffer))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFile,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromFiles(::Array< ::String > paths){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_243_fromFiles)
HXLINE( 253)		 ::lime::media::AudioBuffer buffer = null();
HXLINE( 255)		{
HXLINE( 255)			int _g = (int)0;
HXDLIN( 255)			while((_g < paths->length)){
HXLINE( 255)				::String path = paths->__get(_g);
HXDLIN( 255)				_g = (_g + (int)1);
HXLINE( 257)				buffer = ::lime::media::AudioBuffer_obj::fromFile(path);
HXLINE( 258)				if (hx::IsNotNull( buffer )) {
HXLINE( 258)					goto _hx_goto_7;
            				}
            			}
            			_hx_goto_7:;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AudioBuffer_obj,fromFiles,return )
 ...
 ::lime::media::AudioBuffer AudioBuffer_obj::fromVorbisFile( ::lime::media::vorbis::VorbisFile vorbisFile){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_271_fromVorbisFile)
HXLINE( 273)		if (hx::IsNull( vorbisFile )) {
HXLINE( 273)			return null();
            		}
HXLINE( 275)		 ::lime::media::vorbis::VorbisInfo info = vorbisFile->info(null());
HXLINE( 277)		 ::lime::media::AudioBuffer audioBuffer =  ::lime::media::AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 278)		audioBuffer->channels = info->channels;
HXLINE( 279)		audioBuffer->sampleRate = info->rate;
HXLINE( 280)		audioBuffer->bitsPerSample = (int)16;
HXLINE( 281)		audioBuffer->_hx___srcVorbisFile = vorbisFile;
HXLINE( 283)		return audioBuffer;
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::media::AudioBuffer buffer){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_365_loadFromFile)
HXLINE( 365)			if (hx::IsNotNull( buffer )) {
HXLINE( 367)				return ::lime::app::Future_obj::withValue(buffer);
            			}
            			else {
HXLINE( 371)				return ::lime::app::Future_obj::withError(HX_("",00,00,00,00));
            			}
...
HXLINE( 362)		 ::lime::net::_HTTPRequest_lime_media_AudioBuffer request =  ::lime::net::_HTTPRequest_lime_media_AudioBuffer_obj::__alloc( HX_CTX ,null());
HXLINE( 363)		return request->load(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
 ...
 ::lime::app::Future AudioBuffer_obj::loadFromFiles(::Array< ::String > paths){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0,::Array< ::String >,paths) HXARGC(0)
            		 ::lime::media::AudioBuffer _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_414_loadFromFiles)
HXLINE( 414)			return ::lime::media::AudioBuffer_obj::fromFiles(paths);
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_382_loadFromFiles)
HXLINE( 384)		 ::lime::app::Promise_lime_media_AudioBuffer promise =  ::lime::app::Promise_lime_media_AudioBuffer_obj::__alloc( HX_CTX );
HXLINE( 414)		promise->completeWith( ::lime::app::Future_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(paths)),true));
HXLINE( 418)		return promise->future;
            	}
...
::String AudioBuffer_obj::_hx___getCodec( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_423___getCodec)
HXLINE( 425)		::String signature = bytes->getString((int)0,(int)4,null());
HXLINE( 427)		::String _hx_switch_0 = signature;
            		if (  (_hx_switch_0==HX_("OggS",44,5d,86,34)) ){
HXLINE( 429)			return HX_("audio/ogg",56,37,42,54);
HXDLIN( 429)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("RIFF",b7,20,6b,36)) ){
HXLINE( 431)			if ((bytes->getString((int)8,(int)4,null()) == HX_("WAVE",b9,2d,b3,39))) {
HXLINE( 431)				return HX_("audio/wav",33,44,48,54);
            			}
            			else {
HXLINE( 434)				int _g = bytes->b->__get((int)2);
HXDLIN( 434)				int _g1 = bytes->b->__get((int)1);
HXDLIN( 434)				int _g2 = bytes->b->__get((int)0);
HXDLIN( 434)				switch((int)(_g2)){
            					case (int)73: {
HXLINE( 434)						if ((_g1 == (int)68)) {
HXLINE( 434)							if ((_g == (int)51)) {
HXLINE( 436)								return HX_("audio/mp3",77,ba,40,54);
            							}
            						}
            					}
            					break;
            					case (int)255: {
HXLINE( 434)						switch((int)(_g1)){
...
HXLINE( 431)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("fLaC",68,c3,a5,43)) ){
HXLINE( 430)			return HX_("audio/flac",c1,0e,bf,5f);
HXDLIN( 430)			goto _hx_goto_14;
            		}
            		/* default */{
HXLINE( 434)			int _g3 = bytes->b->__get((int)2);
HXDLIN( 434)			int _g11 = bytes->b->__get((int)1);
HXDLIN( 434)			int _g21 = bytes->b->__get((int)0);
HXDLIN( 434)			switch((int)(_g21)){
            				case (int)73: {
HXLINE( 434)					if ((_g11 == (int)68)) {
HXLINE( 434)						if ((_g3 == (int)51)) {
HXLINE( 436)							return HX_("audio/mp3",77,ba,40,54);
            						}
            					}
            				}
...
HXLINE( 436)							return HX_("audio/mp3",77,ba,40,54);
            		...
            		_hx_goto_14:;
HXLINE( 443)		::lime::utils::Log_obj::error(HX_("Unsupported sound format",d3,74,34,38),hx::SourceInfo(HX_("AudioBuffer.hx",28,d6,7b,8c),443,HX_("lime.media.AudioBuffer",33,70,4b,3a),HX_("__getCodec",40,d9,65,4d)));
