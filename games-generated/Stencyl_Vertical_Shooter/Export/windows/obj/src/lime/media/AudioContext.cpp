...
HX_DEFINE_STACK_FRAME(_hx_pos_6bf3b860440ffc5d_36_new,"lime.media.AudioContext","new",0xf93a2e4e,"lime.media.AudioContext.new","lime/media/AudioContext.hx",36,0xa54b0860)
namespace lime{
namespace media{

void AudioContext_obj::__construct(::String type){
            	HX_GC_STACKFRAME(&_hx_pos_6bf3b860440ffc5d_36_new)
HXDLIN(  36)		if ((type != HX_("custom",b1,87,92,3f))) {
HXLINE(  66)			this->openal =  ::lime::media::OpenALAudioContext_obj::__alloc( HX_CTX );
HXLINE(  67)			this->type = HX_("openal",35,5f,94,21);
            		}
            		else {
HXLINE(  73)			this->type = HX_("custom",b1,87,92,3f);
            		}
            	}
