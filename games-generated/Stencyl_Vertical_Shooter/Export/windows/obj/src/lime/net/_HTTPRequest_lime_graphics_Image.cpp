...
HX_DEFINE_STACK_FRAME(_hx_pos_ad1cd84efbcc0480_131_new,"lime.net._HTTPRequest_lime_graphics_Image","new",0xb2d90076,"lime.net._HTTPRequest_lime_graphics_Image.new","lime/_internal/macros/HTTPRequestMacro.hx",131,0xf82711de)
HX_LOCAL_STACK_FRAME(_hx_pos_31224ac778a9eff4_1187_fromBytes,"lime.net._HTTPRequest_lime_graphics_Image","fromBytes",0xef825737,"lime.net._HTTPRequest_lime_graphics_Image.fromBytes","lime/graphics/Image.hx",1187,0xc7b862ad)
namespace lime{
namespace net{

void _HTTPRequest_lime_graphics_Image_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_ad1cd84efbcc0480_131_new)
...
bool _HTTPRequest_lime_graphics_Image_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_graphics_Image_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_31224ac778a9eff4_1187_fromBytes)
HXDLIN(1187)		return ::lime::graphics::Image_obj::fromBytes(bytes);
            	}
