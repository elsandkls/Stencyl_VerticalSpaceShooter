...
HX_DEFINE_STACK_FRAME(_hx_pos_6031011c5de7d4fd_131_new,"lime.net._HTTPRequest_lime_media_AudioBuffer","new",0xe9102f50,"lime.net._HTTPRequest_lime_media_AudioBuffer.new","lime/_internal/macros/HTTPRequestMacro.hx",131,0xf82711de)
HX_LOCAL_STACK_FRAME(_hx_pos_66fce3bdaaf914c3_362_fromBytes,"lime.net._HTTPRequest_lime_media_AudioBuffer","fromBytes",0x6d972591,"lime.net._HTTPRequest_lime_media_AudioBuffer.fromBytes","lime/media/AudioBuffer.hx",362,0xf6fabaad)
namespace lime{
namespace net{

void _HTTPRequest_lime_media_AudioBuffer_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_6031011c5de7d4fd_131_new)
...
bool _HTTPRequest_lime_media_AudioBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_media_AudioBuffer_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_66fce3bdaaf914c3_362_fromBytes)
HXDLIN( 362)		return ::lime::media::AudioBuffer_obj::fromBytes(bytes);
            	}
