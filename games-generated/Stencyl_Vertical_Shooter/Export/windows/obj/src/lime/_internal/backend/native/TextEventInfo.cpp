...
HX_DEFINE_STACK_FRAME(_hx_pos_48b909785036aaec_1086_new,"lime._internal.backend.native.TextEventInfo","new",0x7aff2f5b,"lime._internal.backend.native.TextEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1086,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_48b909785036aaec_1099_clone,"lime._internal.backend.native.TextEventInfo","clone",0x4be06718,"lime._internal.backend.native.TextEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1099,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_48b909785036aaec_1086_new)
HXLINE(1088)		this->type = type;
HXLINE(1089)		this->windowID = windowID;
HXLINE(1090)		this->text = text;
HXLINE(1091)		this->start = start;
HXLINE(1092)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_1099_clone)
HXDLIN(1099)		return  ::lime::_internal::backend::native::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
