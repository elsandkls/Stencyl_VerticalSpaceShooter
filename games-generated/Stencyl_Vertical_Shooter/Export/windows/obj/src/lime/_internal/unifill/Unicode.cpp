...
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_18_decodeSurrogate,"lime._internal.unifill.Unicode","decodeSurrogate",0x4f9cddf3,"lime._internal.unifill.Unicode.decodeSurrogate","lime/_internal/unifill/Unicode.hx",18,0xd21f708a)
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_21_encodeHighSurrogate,"lime._internal.unifill.Unicode","encodeHighSurrogate",0x5afaadc9,"lime._internal.unifill.Unicode.encodeHighSurrogate","lime/_internal/unifill/Unicode.hx",21,0xd21f708a)
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_24_encodeLowSurrogate,"lime._internal.unifill.Unicode","encodeLowSurrogate",0x2dadfa51,"lime._internal.unifill.Unicode.encodeLowSurrogate","lime/_internal/unifill/Unicode.hx",24,0xd21f708a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_31_isHighSurrogate,"lime._internal.unifill.Unicode","isHighSurrogate",0xbbb266f5,"lime._internal.unifill.Unicode.isHighSurrogate","lime/_internal/unifill/Unicode.hx",31,0xd21f708a)
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_35_isLowSurrogate,"lime._internal.unifill.Unicode","isLowSurrogate",0x32b48aa5,"lime._internal.unifill.Unicode.isLowSurrogate","lime/_internal/unifill/Unicode.hx",35,0xd21f708a)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0663e9d051a0537_15_boot,"lime._internal.unifill.Unicode","boot",0x0d9f9669,"lime._internal.unifill.Unicode.boot","lime/_internal/unifill/Unicode.hx",15,0xd21f708a)
namespace lime{
namespace _internal{
namespace unifill{
...
int Unicode_obj::decodeSurrogate(int hi,int lo){
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_18_decodeSurrogate)
...
int Unicode_obj::encodeHighSurrogate(int c){
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_21_encodeHighSurrogate)
...
int Unicode_obj::encodeLowSurrogate(int c){
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_24_encodeLowSurrogate)
...
bool Unicode_obj::isHighSurrogate(int code){
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_31_isHighSurrogate)
...
bool Unicode_obj::isLowSurrogate(int code){
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_35_isLowSurrogate)
...
{
            	HX_STACKFRAME(&_hx_pos_a0663e9d051a0537_15_boot)
