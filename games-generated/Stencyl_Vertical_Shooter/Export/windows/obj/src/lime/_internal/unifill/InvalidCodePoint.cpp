...
HX_DEFINE_STACK_FRAME(_hx_pos_1a966284ab6346e0_23_new,"lime._internal.unifill.InvalidCodePoint","new",0x43085824,"lime._internal.unifill.InvalidCodePoint.new","lime/_internal/unifill/Exception.hx",23,0x1ae400d8)
HX_LOCAL_STACK_FRAME(_hx_pos_1a966284ab6346e0_28_toString,"lime._internal.unifill.InvalidCodePoint","toString",0x34e3a268,"lime._internal.unifill.InvalidCodePoint.toString","lime/_internal/unifill/Exception.hx",28,0x1ae400d8)
namespace lime{
namespace _internal{
namespace unifill{

void InvalidCodePoint_obj::__construct(int code){
            	HX_STACKFRAME(&_hx_pos_1a966284ab6346e0_23_new)
...
::String InvalidCodePoint_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_1a966284ab6346e0_28_toString)
