...
HX_DEFINE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1172_new,"lime._internal.backend.native.WindowEventInfo","new",0x4cd621b8,"lime._internal.backend.native.WindowEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1172,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1186_clone,"lime._internal.backend.native.WindowEventInfo","clone",0x771e6ab5,"lime._internal.backend.native.WindowEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1186,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_1172_new)
HXLINE(1174)		this->type = type;
HXLINE(1175)		this->windowID = windowID;
HXLINE(1176)		this->width = width;
HXLINE(1177)		this->height = height;
HXLINE(1178)		this->x = x;
HXLINE(1179)		this->y = y;
            	}
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_1186_clone)
HXDLIN(1186)		return  ::lime::_internal::backend::native::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
