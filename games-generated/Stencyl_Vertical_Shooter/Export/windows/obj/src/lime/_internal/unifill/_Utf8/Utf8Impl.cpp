...
HX_LOCAL_STACK_FRAME(_hx_pos_166eb997cfb34041_171_code_point_width,"lime._internal.unifill._Utf8.Utf8Impl","code_point_width",0xfe39ba5e,"lime._internal.unifill._Utf8.Utf8Impl.code_point_width","lime/_internal/unifill/Utf8.hx",171,0x18196bc4)
HX_LOCAL_STACK_FRAME(_hx_pos_166eb997cfb34041_174_find_prev_code_point,"lime._internal.unifill._Utf8.Utf8Impl","find_prev_code_point",0xa17b7cdd,"lime._internal.unifill._Utf8.Utf8Impl.find_prev_code_point","lime/_internal/unifill/Utf8.hx",174,0x18196bc4)
HX_LOCAL_STACK_FRAME(_hx_pos_166eb997cfb34041_184_encode_code_point,"lime._internal.unifill._Utf8.Utf8Impl","encode_code_point",0x62732b0e,"lime._internal.unifill._Utf8.Utf8Impl.encode_code_point","lime/_internal/unifill/Utf8.hx",184,0x18196bc4)
HX_LOCAL_STACK_FRAME(_hx_pos_166eb997cfb34041_203_decode_code_point,"lime._internal.unifill._Utf8.Utf8Impl","decode_code_point",0xdecde6f6,"lime._internal.unifill._Utf8.Utf8Impl.decode_code_point","lime/_internal/unifill/Utf8.hx",203,0x18196bc4)
namespace lime{
namespace _internal{
namespace unifill{
namespace _Utf8{
...
int Utf8Impl_obj::code_point_width(int c){
            	HX_STACKFRAME(&_hx_pos_166eb997cfb34041_171_code_point_width)
...
int Utf8Impl_obj::find_prev_code_point( ::Dynamic accessor,int index){
            	HX_STACKFRAME(&_hx_pos_166eb997cfb34041_174_find_prev_code_point)
...
void Utf8Impl_obj::encode_code_point( ::Dynamic addUnit,int codePoint){
            	HX_GC_STACKFRAME(&_hx_pos_166eb997cfb34041_184_encode_code_point)
...
HXLINE( 199)						HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,codePoint));
            					}
            				}
            			}
            		}
...
int Utf8Impl_obj::decode_code_point(int len, ::Dynamic accessor,int index){
            	HX_GC_STACKFRAME(&_hx_pos_166eb997cfb34041_203_decode_code_point)
...
HXLINE( 206)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            		}
...
HXLINE( 212)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            		}
...
HXLINE( 216)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            		}
...
HXLINE( 222)				HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            			}
            		}
...
HXLINE( 226)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            		}
...
HXLINE( 233)				HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            			}
            		}
...
HXLINE( 237)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            		}
...
HXLINE( 244)				HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
            			}
            		}
HXLINE( 246)		HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodeUnitSequence_obj::__alloc( HX_CTX ,index));
