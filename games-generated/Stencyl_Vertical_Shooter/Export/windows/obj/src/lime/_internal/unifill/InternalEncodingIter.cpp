...
HX_DEFINE_STACK_FRAME(_hx_pos_60025502df6d376a_8_new,"lime._internal.unifill.InternalEncodingIter","new",0xab03e1a0,"lime._internal.unifill.InternalEncodingIter.new","lime/_internal/unifill/InternalEncodingIter.hx",8,0xc0cbfced)
HX_LOCAL_STACK_FRAME(_hx_pos_60025502df6d376a_21_hasNext,"lime._internal.unifill.InternalEncodingIter","hasNext",0x847856ad,"lime._internal.unifill.InternalEncodingIter.hasNext","lime/_internal/unifill/InternalEncodingIter.hx",21,0xc0cbfced)
HX_LOCAL_STACK_FRAME(_hx_pos_60025502df6d376a_25_next,"lime._internal.unifill.InternalEncodingIter","next",0xf8618bb3,"lime._internal.unifill.InternalEncodingIter.next","lime/_internal/unifill/InternalEncodingIter.hx",25,0xc0cbfced)
namespace lime{
namespace _internal{
namespace unifill{

void InternalEncodingIter_obj::__construct(::String s,int beginIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_60025502df6d376a_8_new)
...
bool InternalEncodingIter_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_60025502df6d376a_21_hasNext)
...
int InternalEncodingIter_obj::next(){
            	HX_STACKFRAME(&_hx_pos_60025502df6d376a_25_next)
HXLINE(  26)		this->i = this->index;
HXLINE(  27)		 ::lime::_internal::unifill::InternalEncodingIter _hx_tmp = hx::ObjectPtr<OBJ_>(this);
