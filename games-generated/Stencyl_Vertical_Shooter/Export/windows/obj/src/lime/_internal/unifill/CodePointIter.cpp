...
HX_DEFINE_STACK_FRAME(_hx_pos_1778f57ebffe87a0_8_new,"lime._internal.unifill.CodePointIter","new",0x458ebe07,"lime._internal.unifill.CodePointIter.new","lime/_internal/unifill/CodePointIter.hx",8,0x04c9928c)
HX_LOCAL_STACK_FRAME(_hx_pos_1778f57ebffe87a0_21_hasNext,"lime._internal.unifill.CodePointIter","hasNext",0xa1e6f294,"lime._internal.unifill.CodePointIter.hasNext","lime/_internal/unifill/CodePointIter.hx",21,0x04c9928c)
HX_LOCAL_STACK_FRAME(_hx_pos_1778f57ebffe87a0_25_next,"lime._internal.unifill.CodePointIter","next",0x9757896c,"lime._internal.unifill.CodePointIter.next","lime/_internal/unifill/CodePointIter.hx",25,0x04c9928c)
namespace lime{
namespace _internal{
namespace unifill{

void CodePointIter_obj::__construct(::String s){
            	HX_STACKFRAME(&_hx_pos_1778f57ebffe87a0_8_new)
...
bool CodePointIter_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_1778f57ebffe87a0_21_hasNext)
...
int CodePointIter_obj::next(){
            	HX_STACKFRAME(&_hx_pos_1778f57ebffe87a0_25_next)
HXLINE(  26)		this->i = this->index;
HXLINE(  27)		 ::lime::_internal::unifill::CodePointIter _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN(  28)		return ::lime::_internal::unifill::_Utf8::Utf8_Impl__obj::codePointAt(this4,this->i);
            	}
