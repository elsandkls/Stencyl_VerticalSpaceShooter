...
HX_DEFINE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_972_new,"lime._internal.backend.native.MouseEventInfo","new",0x46fd57c7,"lime._internal.backend.native.MouseEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",972,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_3eb566585b06ea2e_987_clone,"lime._internal.backend.native.MouseEventInfo","clone",0xb20a8284,"lime._internal.backend.native.MouseEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",987,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_3eb566585b06ea2e_972_new)
HXLINE( 974)		this->type = type;
HXLINE( 975)		this->windowID = (int)0;
HXLINE( 976)		this->x = x;
HXLINE( 977)		this->y = y;
HXLINE( 978)		this->button = button;
HXLINE( 979)		this->movementX = movementX;
HXLINE( 980)		this->movementY = movementY;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3eb566585b06ea2e_987_clone)
HXDLIN( 987)		return  ::lime::_internal::backend::native::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
