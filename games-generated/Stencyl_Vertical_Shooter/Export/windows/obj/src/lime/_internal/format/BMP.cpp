...
HX_LOCAL_STACK_FRAME(_hx_pos_b7d25674645dcbd1_17_encode,"lime._internal.format.BMP","encode",0xed49c7eb,"lime._internal.format.BMP.encode","lime/_internal/format/BMP.hx",17,0x5d470ca4)
namespace lime{
namespace _internal{
namespace format{
...
bool BMP_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BMP_obj::encode( ::lime::graphics::Image image, ::lime::_internal::format::BMPType type){
            	HX_GC_STACKFRAME(&_hx_pos_b7d25674645dcbd1_17_encode)
...
HXLINE(  31)			type = ::lime::_internal::format::BMPType_obj::RGB_dyn();
            		}
...
HXDLIN(  52)					pixelValuesLength = ((pixelValuesLength1 + hx::Mod((image->width * (int)3),(int)4)) * image->height);
            				}
            				break;
            				case (int)1: {
...
HXLINE(  74)		{
HXLINE(  74)			int v3;
HXDLIN(  74)			if (hx::IsEq( type,::lime::_internal::format::BMPType_obj::ICO_dyn() )) {
...
HXLINE(  76)		{
HXLINE(  76)			int v4;
HXDLIN(  76)			if (hx::IsEq( type,::lime::_internal::format::BMPType_obj::RGB_dyn() )) {
HXLINE(  76)				v4 = (int)24;
            			}
            			else {
HXLINE(  76)				v4 = (int)32;
...
HXLINE(  77)		{
HXLINE(  77)			int v5;
HXDLIN(  77)			if (hx::IsEq( type,::lime::_internal::format::BMPType_obj::BITFIELD_dyn() )) {
HXLINE(  77)				v5 = (int)3;
            			}
            			else {
HXLINE(  77)				v5 = (int)0;
...
HXLINE(  84)		if (hx::IsEq( type,::lime::_internal::format::BMPType_obj::BITFIELD_dyn() )) {
HXLINE(  86)			{
