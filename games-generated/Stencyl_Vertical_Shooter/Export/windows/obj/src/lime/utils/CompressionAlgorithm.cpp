...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("lime.utils.CompressionAlgorithm","\x5f","\x30","\x48","\xca"), hx::TCanCast< CompressionAlgorithm_obj >,CompressionAlgorithm_obj_sStaticFields,0,
...
GZIP = hx::CreateEnum< CompressionAlgorithm_obj >(HX_HCSTRING("GZIP","\xda","\xb0","\x32","\x2f"),1,0);
LZMA = hx::CreateEnum< CompressionAlgorithm_obj >(HX_HCSTRING("LZMA","\x62","\xc5","\x80","\x32"),2,0);
ZLIB = hx::CreateEnum< CompressionAlgorithm_obj >(HX_HCSTRING("ZLIB","\x0b","\x1f","\xb7","\x3b"),3,0);
}
