...
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_631___cacheBreak,"lime.utils.Assets","__cacheBreak",0xe7faf592,"lime.utils.Assets.__cacheBreak","lime/utils/Assets.hx",631,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_636___libraryNotFound,"lime.utils.Assets","__libraryNotFound",0x7dfa37b5,"lime.utils.Assets.__libraryNotFound","lime/utils/Assets.hx",636,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_df5754140b017d9f_664_library_onChange,"lime.utils.Assets","library_onChange",0x3a89dec8,"lime.utils.Assets.library_onChange","lime/utils/Assets.hx",664,0x95055f23)
...
::String Assets_obj::_hx___cacheBreak(::String path){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_631___cacheBreak)
HXDLIN( 631)		return path;
            	}
...
::String Assets_obj::_hx___libraryNotFound(::String name){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_636___libraryNotFound)
HXLINE( 638)		bool _hx_tmp;
HXDLIN( 638)		if (hx::IsNotNull( name )) {
HXLINE( 638)			_hx_tmp = (name == HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 638)			_hx_tmp = true;
            		}
HXDLIN( 638)		if (_hx_tmp) {
HXLINE( 640)			name = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 644)		bool _hx_tmp1;
HXDLIN( 644)		bool _hx_tmp2;
HXDLIN( 644)		if (hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXLINE( 644)			_hx_tmp2 = hx::IsNotNull( ::lime::app::Application_obj::current->_hx___preloader );
            		}
            		else {
HXLINE( 644)			_hx_tmp2 = false;
            		}
HXDLIN( 644)		if (_hx_tmp2) {
HXLINE( 644)			_hx_tmp1 = !(::lime::app::Application_obj::current->_hx___preloader->complete);
            		}
            		else {
HXLINE( 644)			_hx_tmp1 = false;
            		}
HXDLIN( 644)		if (_hx_tmp1) {
HXLINE( 646)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\", or it is not yet preloaded",db,ac,d4,2f));
            		}
            		else {
HXLINE( 650)			return ((HX_("There is no asset library named \"",a1,83,5f,51) + name) + HX_("\"",22,00,00,00));
            		}
...
void Assets_obj::library_onChange(){
            	HX_STACKFRAME(&_hx_pos_df5754140b017d9f_664_library_onChange)
HXLINE( 666)		::lime::utils::Assets_obj::cache->clear(null());
HXLINE( 667)		::lime::utils::Assets_obj::onChange->dispatch();
            	}
