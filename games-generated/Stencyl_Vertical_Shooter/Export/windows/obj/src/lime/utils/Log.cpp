...
HXLINE(  26)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
HXDLIN(  26)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
HXLINE(  38)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ERROR: ",8b,d9,df,31));
HXDLIN(  38)			::String message2 = (message1 + ::Std_obj::string(message));
HXLINE(  40)			if (::lime::utils::Log_obj::throwErrors) {
HXLINE(  42)				HX_STACK_DO_THROW(message2);
            			}
            			else {
HXLINE(  49)				::Sys_obj::println(::Std_obj::string(message2));
            			}
            		}
            	}
...
HXLINE(  66)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
HXDLIN(  66)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
HXDLIN(  77)		::Sys_obj::print(::Std_obj::string(message));
            	}
...
HXDLIN(  92)		::Sys_obj::println(::Std_obj::string(message));
            	}
...
HXLINE( 108)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
HXDLIN( 108)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
...
HXLINE( 122)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] WARNING: ",5f,da,b0,cd));
HXDLIN( 122)			::Sys_obj::println(::Std_obj::string((message1 + ::Std_obj::string(message))));
            		}
            	}
