...
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_82_queue,"lime.system.ThreadPool","queue",0xd03ecc0f,"lime.system.ThreadPool.queue","lime/system/ThreadPool.hx",82,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_116_sendComplete,"lime.system.ThreadPool","sendComplete",0x5f287f63,"lime.system.ThreadPool.sendComplete","lime/system/ThreadPool.hx",116,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_132_sendError,"lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",132,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_148_sendProgress,"lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",148,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_164_runWork,"lime.system.ThreadPool","runWork",0xbaf970ba,"lime.system.ThreadPool.runWork","lime/system/ThreadPool.hx",164,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_186___doWork,"lime.system.ThreadPool","__doWork",0xcfdf765e,"lime.system.ThreadPool.__doWork","lime/system/ThreadPool.hx",186,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_207___update,"lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",207,0x8993fbb2)
namespace lime{
...
void ThreadPool_obj::queue( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_82_queue)
HXDLIN(  82)		bool _hx_tmp;
HXDLIN(  82)		bool _hx_tmp1;
HXDLIN(  82)		if (hx::IsNotNull( ::lime::app::Application_obj::current )) {
HXDLIN(  82)			_hx_tmp1 = hx::IsNotNull( ::lime::app::Application_obj::current->_hx___window );
            		}
            		else {
HXDLIN(  82)			_hx_tmp1 = false;
            		}
HXDLIN(  82)		if (_hx_tmp1) {
HXDLIN(  82)			_hx_tmp = !(this->_hx___synchronous);
            		}
            		else {
HXDLIN(  82)			_hx_tmp = false;
            		}
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  84)			 ::cpp::vm::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN(  84)			_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE(  85)			this->_hx___workQueued++;
HXLINE(  87)			bool _hx_tmp3;
HXDLIN(  87)			if ((this->currentThreads < this->maxThreads)) {
HXLINE(  87)				int _hx_tmp4 = this->currentThreads;
HXDLIN(  87)				_hx_tmp3 = (_hx_tmp4 < (this->_hx___workQueued - this->_hx___workCompleted));
            			}
            			else {
HXLINE(  87)				_hx_tmp3 = false;
            			}
HXDLIN(  87)			if (_hx_tmp3) {
HXLINE(  89)				this->currentThreads++;
HXLINE(  90)				::cpp::vm::Thread_obj::create(this->_hx___doWork_dyn());
            			}
HXLINE(  94)			if (!(::lime::app::Application_obj::current->onUpdate->has(this->_hx___update_dyn()))) {
HXLINE(  96)				::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            			}
            		}
            		else {
HXLINE( 102)			this->_hx___synchronous = true;
HXLINE( 103)			this->runWork(state);
            		}
            	}
...
void ThreadPool_obj::sendComplete( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_116_sendComplete)
HXLINE( 119)		if (!(this->_hx___synchronous)) {
HXLINE( 121)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 121)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
HXLINE( 122)			return;
            		}
HXLINE( 127)		this->onComplete->dispatch(state);
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_132_sendError)
HXLINE( 135)		if (!(this->_hx___synchronous)) {
HXLINE( 137)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 137)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
HXLINE( 138)			return;
            		}
HXLINE( 143)		this->onError->dispatch(state);
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_148_sendProgress)
HXLINE( 151)		if (!(this->_hx___synchronous)) {
HXLINE( 153)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 153)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
HXLINE( 154)			return;
            		}
HXLINE( 159)		this->onProgress->dispatch(state);
            	}
...
void ThreadPool_obj::runWork( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_164_runWork)
HXLINE( 167)		if (!(this->_hx___synchronous)) {
HXLINE( 169)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 169)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE( 170)			this->doWork->dispatch(state);
HXLINE( 171)			return;
            		}
HXLINE( 176)		this->onRun->dispatch(state);
HXLINE( 177)		this->doWork->dispatch(state);
            	}
...
void ThreadPool_obj::_hx___doWork(){
            	HX_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_186___doWork)
HXDLIN( 186)		while(true){
HXLINE( 188)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workIncoming->pop(true).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 190)			if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn() )) {
HXLINE( 192)				this->runWork(message->state);
            			}
            			else {
HXLINE( 194)				if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn() )) {
...
void ThreadPool_obj::_hx___update(int deltaTime){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_207___update)
HXDLIN( 207)		if ((this->_hx___workQueued > this->_hx___workCompleted)) {
HXLINE( 209)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 211)			while(hx::IsNotNull( message )){
HXLINE( 213)				{
HXLINE( 213)					 ::lime::_hx_system::_ThreadPool::ThreadPoolMessageType _g = message->type;
HXDLIN( 213)					switch((int)(_hx_getEnumValueIndex(_g))){
            						case (int)0: case (int)1: {
HXLINE( 225)							this->_hx___workCompleted++;
HXLINE( 227)							bool _hx_tmp;
HXDLIN( 227)							int _hx_tmp1 = this->currentThreads;
HXDLIN( 227)							if ((_hx_tmp1 <= (this->_hx___workQueued - this->_hx___workCompleted))) {
HXLINE( 227)								_hx_tmp = (this->currentThreads > this->maxThreads);
            							}
            							else {
HXLINE( 227)								_hx_tmp = true;
            							}
HXDLIN( 227)							if (_hx_tmp) {
HXLINE( 229)								this->currentThreads--;
HXLINE( 230)								 ::cpp::vm::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN( 230)								_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
HXLINE( 234)							if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn() )) {
HXLINE( 236)								this->onComplete->dispatch(message->state);
            							}
            							else {
HXLINE( 240)								this->onError->dispatch(message->state);
            							}
            						}
            						break;
            						case (int)3: {
HXLINE( 221)							this->onProgress->dispatch(message->state);
            						}
            						break;
            						case (int)4: {
HXLINE( 217)							this->onRun->dispatch(message->state);
            						}
            						break;
            						default:{
            						}
...
HXLINE( 248)				message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
            			}
            		}
            		else {
HXLINE( 256)			bool _hx_tmp3;
HXDLIN( 256)			bool _hx_tmp4;
HXDLIN( 256)			if ((this->currentThreads == (int)0)) {
HXLINE( 256)				_hx_tmp4 = (this->minThreads <= (int)0);
            			}
            			else {
HXLINE( 256)				_hx_tmp4 = false;
            			}
HXDLIN( 256)			if (_hx_tmp4) {
HXLINE( 256)				_hx_tmp3 = hx::IsNotNull( ::lime::app::Application_obj::current );
            			}
            			else {
HXLINE( 256)				_hx_tmp3 = false;
            			}
HXDLIN( 256)			if (_hx_tmp3) {
HXLINE( 258)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
            			}
            		}
            	}
