...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_76_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",76,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_81_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",81,0x9490b5ee)
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_76_get_text)
HXDLIN(  76)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_81_set_text)
HXLINE(  83)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  84)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE(  87)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE(  99)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 101)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
