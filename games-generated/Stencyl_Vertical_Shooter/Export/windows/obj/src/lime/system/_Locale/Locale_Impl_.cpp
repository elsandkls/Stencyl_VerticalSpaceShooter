...
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_66___init,"lime.system._Locale.Locale_Impl_","__init",0x9517de69,"lime.system._Locale.Locale_Impl_.__init","lime/system/Locale.hx",66,0x3407735e)
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_121_get_language,"lime.system._Locale.Locale_Impl_","get_language",0xd286e55a,"lime.system._Locale.Locale_Impl_.get_language","lime/system/Locale.hx",121,0x3407735e)
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_151_get_region,"lime.system._Locale.Locale_Impl_","get_region",0x0a6f8176,"lime.system._Locale.Locale_Impl_.get_region","lime/system/Locale.hx",151,0x3407735e)
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_199_get_currentLocale,"lime.system._Locale.Locale_Impl_","get_currentLocale",0xf4af2971,"lime.system._Locale.Locale_Impl_.get_currentLocale","lime/system/Locale.hx",199,0x3407735e)
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_208_set_currentLocale,"lime.system._Locale.Locale_Impl_","set_currentLocale",0x181d017d,"lime.system._Locale.Locale_Impl_.set_currentLocale","lime/system/Locale.hx",208,0x3407735e)
HX_LOCAL_STACK_FRAME(_hx_pos_edbc5bc898b35f40_217_get_systemLocale,"lime.system._Locale.Locale_Impl_","get_systemLocale",0x132deaeb,"lime.system._Locale.Locale_Impl_.get_systemLocale","lime/system/Locale.hx",217,0x3407735e)
namespace lime{
...
void Locale_Impl__obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_66___init)
HXDLIN(  66)		if (hx::IsNull( ::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___systemLocale )) {
HXLINE(  68)			::String locale = null();
HXLINE(  91)			locale = ( (::String)(::lime::_hx_system::CFFI_obj::load(HX_("lime",15,17,b3,47),HX_("lime_locale_get_system_locale",06,d8,a2,c2),(int)0,null())()) );
HXLINE(  96)			if (hx::IsNotNull( locale )) {
HXLINE(  98)				::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___systemLocale = locale;
            			}
            			else {
HXLINE( 102)				::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___systemLocale = HX_("en-US",02,7f,50,70);
            			}
HXLINE( 106)			::lime::_hx_system::_Locale::Locale_Impl__obj::set_currentLocale(::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___systemLocale);
            		}
            	}
...
::String Locale_Impl__obj::get_language(::String this1){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_121_get_language)
HXLINE( 123)		if (hx::IsNotNull( this1 )) {
HXLINE( 125)			int index = this1.indexOf(HX_("_",5f,00,00,00),null());
HXLINE( 127)			if ((index > (int)-1)) {
HXLINE( 129)				int dashIndex = this1.indexOf(HX_("-",2d,00,00,00),null());
HXLINE( 130)				bool _hx_tmp;
HXDLIN( 130)				if ((dashIndex > (int)-1)) {
HXLINE( 130)					_hx_tmp = (dashIndex < index);
            				}
            				else {
HXLINE( 130)					_hx_tmp = false;
            				}
HXDLIN( 130)				if (_hx_tmp) {
HXLINE( 130)					index = dashIndex;
            				}
HXLINE( 132)				return this1.substring((int)0,index);
            			}
HXLINE( 136)			index = this1.indexOf(HX_("-",2d,00,00,00),null());
HXLINE( 138)			if ((index > (int)-1)) {
HXLINE( 140)				return this1.substring((int)0,index);
            			}
            		}
...
::String Locale_Impl__obj::get_region(::String this1){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_151_get_region)
HXLINE( 153)		if (hx::IsNotNull( this1 )) {
HXLINE( 155)			int underscoreIndex = this1.indexOf(HX_("_",5f,00,00,00),null());
HXLINE( 156)			int dotIndex = this1.indexOf(HX_(".",2e,00,00,00),null());
HXLINE( 157)			int dashIndex = this1.indexOf(HX_("-",2d,00,00,00),null());
HXLINE( 159)			if ((underscoreIndex > (int)-1)) {
HXLINE( 161)				if ((dotIndex > (int)-1)) {
HXLINE( 163)					return this1.substring((underscoreIndex + (int)1),dotIndex);
            				}
            				else {
HXLINE( 167)					return this1.substring((underscoreIndex + (int)1),null());
            				}
            			}
            			else {
HXLINE( 171)				if ((dashIndex > (int)-1)) {
HXLINE( 173)					if ((dotIndex > (int)-1)) {
HXLINE( 175)						return this1.substring((dashIndex + (int)1),dotIndex);
            					}
            					else {
HXLINE( 179)						return this1.substring((dashIndex + (int)1),null());
            					}
            				}
            			}
            		}
...
::String Locale_Impl__obj::get_currentLocale(){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_199_get_currentLocale)
HXLINE( 201)		::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___init();
HXLINE( 203)		return ::lime::_hx_system::_Locale::Locale_Impl__obj::currentLocale;
            	}
...
::String Locale_Impl__obj::set_currentLocale(::String value){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_208_set_currentLocale)
HXLINE( 210)		::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___init();
HXLINE( 212)		return (::lime::_hx_system::_Locale::Locale_Impl__obj::currentLocale = value);
            	}
...
::String Locale_Impl__obj::get_systemLocale(){
            	HX_STACKFRAME(&_hx_pos_edbc5bc898b35f40_217_get_systemLocale)
HXLINE( 219)		::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___init();
HXLINE( 221)		return ::lime::_hx_system::_Locale::Locale_Impl__obj::_hx___systemLocale;
            	}
