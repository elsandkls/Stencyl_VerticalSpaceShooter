...
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_234___findHaxelib,"lime.system.CFFI","__findHaxelib",0xf1a39a44,"lime.system.CFFI.__findHaxelib","lime/system/CFFI.hx",234,0x441ad672)
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_279___loaderTrace,"lime.system.CFFI","__loaderTrace",0x9278b410,"lime.system.CFFI.__loaderTrace","lime/system/CFFI.hx",279,0x441ad672)
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_360___sysName,"lime.system.CFFI","__sysName",0x178f5196,"lime.system.CFFI.__sysName","lime/system/CFFI.hx",360,0x441ad672)
HX_LOCAL_STACK_FRAME(_hx_pos_9b11a74d7222574a_376___tryLoad,"lime.system.CFFI","__tryLoad",0xe7c4e49f,"lime.system.CFFI.__tryLoad","lime/system/CFFI.hx",376,0x441ad672)
...
HXLINE( 156)			::lime::_hx_system::CFFI_obj::_hx___moduleNames->set(library,library);
HXLINE( 158)			result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((HX_("./",41,28,00,00) + library),library,method,args);
HXLINE( 160)			if (hx::IsNull( result )) {
HXLINE( 162)				result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((HX_(".\\",6e,28,00,00) + library),library,method,args);
            			}
HXLINE( 166)			if (hx::IsNull( result )) {
HXLINE( 168)				result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(library,library,method,args);
            			}
HXLINE( 172)			if (hx::IsNull( result )) {
HXLINE( 174)				::String slash;
HXDLIN( 174)				if ((::lime::_hx_system::CFFI_obj::_hx___sysName().substr((int)7,null()).toLowerCase() == HX_("windows",83,de,74,e8))) {
HXLINE( 174)					slash = HX_("\\",5c,00,00,00);
            				}
            				else {
HXLINE( 174)					slash = HX_("/",2f,00,00,00);
            				}
HXLINE( 175)				::String haxelib = ::lime::_hx_system::CFFI_obj::_hx___findHaxelib(HX_("lime",15,17,b3,47));
HXLINE( 177)				if ((haxelib != HX_("",00,00,00,00))) {
HXLINE( 179)					result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad(((((((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash) + ::lime::_hx_system::CFFI_obj::_hx___sysName()) + slash) + library),library,method,args);
HXLINE( 181)					if (hx::IsNull( result )) {
HXLINE( 183)						result = ::lime::_hx_system::CFFI_obj::_hx___tryLoad((((((((haxelib + slash) + HX_("ndll",36,b8,01,49)) + slash) + ::lime::_hx_system::CFFI_obj::_hx___sysName()) + HX_("64",3e,2f,00,00)) + slash) + library),library,method,args);
            					}
            				}
            			}
HXLINE( 191)			::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Result : ",e9,19,2c,14) + ::Std_obj::string(result)));
            		}
...
::String CFFI_obj::_hx___findHaxelib(::String library){
            	HX_GC_STACKFRAME(&_hx_pos_9b11a74d7222574a_234___findHaxelib)
HXLINE( 238)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 240)			 ::sys::io::Process proc =  ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("haxelib",df,b6,80,08),::Array_obj< ::String >::__new(2)->init(0,HX_("path",a5,e5,51,4a))->init(1,library));
HXLINE( 242)			if (hx::IsNotNull( proc )) {
HXLINE( 244)				 ::haxe::io::Input stream = proc->_hx_stdout;
HXLINE( 246)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 248)					while(true){
HXLINE( 250)						::String s = stream->readLine();
HXLINE( 252)						if ((s.substr((int)0,(int)1) != HX_("-",2d,00,00,00))) {
HXLINE( 254)							stream->close();
HXLINE( 255)							proc->close();
HXLINE( 256)							::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Found haxelib ",1f,a6,4d,c9) + s));
HXLINE( 257)							return s;
            						}
            					}
            				}
...
HXLINE( 265)				stream->close();
HXLINE( 266)				proc->close();
            			}
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){
...
HXLINE( 274)		return HX_("",00,00,00,00);
            	}
...
void CFFI_obj::_hx___loaderTrace(::String message){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_279___loaderTrace)
HXLINE( 286)		bool debug = hx::IsNotNull( ::Sys_obj::getEnv(HX_("OPENFL_LOAD_DEBUG",a9,1b,ff,9b)) );
HXLINE( 289)		if (debug) {
HXLINE( 291)			::Sys_obj::println(message);
            		}
            	}
...
::String CFFI_obj::_hx___sysName(){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_360___sysName)
HXLINE( 364)		 ::Dynamic sys_string = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),(int)0);
HXLINE( 365)		return ( (::String)(sys_string()) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(CFFI_obj,_hx___sysName,return )
 ...
 ::Dynamic CFFI_obj::_hx___tryLoad(::String name,::String library,::String func,int args){
            	HX_STACKFRAME(&_hx_pos_9b11a74d7222574a_376___tryLoad)
HXLINE( 380)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 383)			 ::Dynamic result = ::cpp::Lib_obj::load(name,func,args);
HXLINE( 396)			if (hx::IsNotNull( result )) {
HXLINE( 398)				::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Got result ",af,e9,02,45) + name));
HXLINE( 399)				::lime::_hx_system::CFFI_obj::_hx___moduleNames->set(library,name);
HXLINE( 400)				return result;
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 406)				::lime::_hx_system::CFFI_obj::_hx___loaderTrace((HX_("Failed to load : ",1e,ca,38,9b) + name));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
