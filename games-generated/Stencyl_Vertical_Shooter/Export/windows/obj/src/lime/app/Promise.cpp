...
HX_DEFINE_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_95_new,"lime.app.Promise","new",0x895fc147,"lime.app.Promise.new","lime/app/Promise.hx",95,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_105_complete,"lime.app.Promise","complete",0x51e66a72,"lime.app.Promise.complete","lime/app/Promise.hx",105,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_137_completeWith,"lime.app.Promise","completeWith",0x93e32d98,"lime.app.Promise.completeWith","lime/app/Promise.hx",137,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_153_error,"lime.app.Promise","error",0x4bc1046f,"lime.app.Promise.error","lime/app/Promise.hx",153,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_185_progress,"lime.app.Promise","progress",0x58496166,"lime.app.Promise.progress","lime/app/Promise.hx",185,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_215_get_isComplete,"lime.app.Promise","get_isComplete",0x07c29585,"lime.app.Promise.get_isComplete","lime/app/Promise.hx",215,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_1fbf33b6b1186a81_222_get_isError,"lime.app.Promise","get_isError",0x4bfb7f7c,"lime.app.Promise.get_isError","lime/app/Promise.hx",222,0x10ba4f0b)
namespace lime{
namespace app{

void Promise_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_95_new)
...
bool Promise_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Promise Promise_obj::complete( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_105_complete)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,complete,return )
 ...
 ::lime::app::Promise Promise_obj::completeWith( ::lime::app::Future future){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_137_completeWith)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,completeWith,return )
 ...
 ::lime::app::Promise Promise_obj::error( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_153_error)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_obj,error,return )
 ...
 ::lime::app::Promise Promise_obj::progress(int progress,int total){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_185_progress)
...
bool Promise_obj::get_isComplete(){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_215_get_isComplete)
...
bool Promise_obj::get_isError(){
            	HX_STACKFRAME(&_hx_pos_1fbf33b6b1186a81_222_get_isError)
