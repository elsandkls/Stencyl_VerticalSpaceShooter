...
HX_DEFINE_STACK_FRAME(_hx_pos_b16b96f10668b207_84_new,"lime.app.Future","new",0xc0e3b2bb,"lime.app.Future.new","lime/app/Future.hx",84,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_137_onComplete,"lime.app.Future","onComplete",0x3a7dc3fd,"lime.app.Future.onComplete","lime/app/Future.hx",137,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_171_onError,"lime.app.Future","onError",0xb2071604,"lime.app.Future.onError","lime/app/Future.hx",171,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_205_onProgress,"lime.app.Future","onProgress",0x40e0baf1,"lime.app.Future.onProgress","lime/app/Future.hx",205,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_246_ready,"lime.app.Future","ready",0xd4cc0f7e,"lime.app.Future.ready","lime/app/Future.hx",246,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_279_result,"lime.app.Future","result",0x69b43162,"lime.app.Future.result","lime/app/Future.hx",279,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_302_then,"lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",302,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_320_then,"lime.app.Future","then",0x0a523022,"lime.app.Future.then","lime/app/Future.hx",320,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_121_ofEvents,"lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",121,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_117_ofEvents,"lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",117,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_122_ofEvents,"lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",122,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_123_ofEvents,"lime.app.Future","ofEvents",0x0c824355,"lime.app.Future.ofEvents","lime/app/Future.hx",123,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_340_withError,"lime.app.Future","withError",0xc7ddc87d,"lime.app.Future.withError","lime/app/Future.hx",340,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_355_withValue,"lime.app.Future","withValue",0x866c7c26,"lime.app.Future.withValue","lime/app/Future.hx",355,0x058e0853)
namespace lime{
namespace app{

void Future_obj::__construct( ::Dynamic work,hx::Null< bool >  __o_async){
bool async = __o_async.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_84_new)
HXDLIN(  84)		if (hx::IsNotNull( work )) {
HXLINE(  86)			if (async) {
HXLINE(  88)				 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE(  89)				promise->future = hx::ObjectPtr<OBJ_>(this);
HXLINE(  91)				::lime::app::_Future::FutureWork_obj::queue( ::Dynamic(hx::Anon_obj::Create(2)
...
HXLINE(  97)					this->value = work();
HXLINE(  98)					this->isComplete = true;
            				}
            				catch( ::Dynamic _hx_e){
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic e = _hx_e;
HXLINE( 102)						this->error = e;
HXLINE( 103)						this->isError = true;
            					}
            					else {
...
bool Future_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Future Future_obj::onComplete( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_137_onComplete)
HXLINE( 139)		if (hx::IsNotNull( listener )) {
HXLINE( 141)			if (this->isComplete) {
HXLINE( 143)				listener(this->value);
            			}
            			else {
HXLINE( 145)				if (!(this->isError)) {
HXLINE( 147)					if (hx::IsNull( this->_hx___completeListeners )) {
HXLINE( 149)						this->_hx___completeListeners = ::Array_obj< ::Dynamic>::__new();
            					}
HXLINE( 153)					this->_hx___completeListeners->push(listener);
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onComplete,return )
 ...
 ::lime::app::Future Future_obj::onError( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_171_onError)
HXLINE( 173)		if (hx::IsNotNull( listener )) {
HXLINE( 175)			if (this->isError) {
HXLINE( 177)				listener(this->error);
            			}
            			else {
HXLINE( 179)				if (!(this->isComplete)) {
HXLINE( 181)					if (hx::IsNull( this->_hx___errorListeners )) {
HXLINE( 183)						this->_hx___errorListeners = ::Array_obj< ::Dynamic>::__new();
            					}
HXLINE( 187)					this->_hx___errorListeners->push(listener);
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onError,return )
 ...
 ::lime::app::Future Future_obj::onProgress( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_205_onProgress)
HXLINE( 207)		if (hx::IsNotNull( listener )) {
HXLINE( 209)			if (hx::IsNull( this->_hx___progressListeners )) {
HXLINE( 211)				this->_hx___progressListeners = ::Array_obj< ::Dynamic>::__new();
            			}
HXLINE( 215)			this->_hx___progressListeners->push(listener);
            		}
...
int waitTime = __o_waitTime.Default(-1);
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_246_ready)
HXDLIN( 246)		bool _hx_tmp;
HXDLIN( 246)		if (!(this->isComplete)) {
HXDLIN( 246)			_hx_tmp = this->isError;
            		}
            		else {
HXDLIN( 246)			_hx_tmp = true;
            		}
HXDLIN( 246)		if (_hx_tmp) {
HXLINE( 248)			return hx::ObjectPtr<OBJ_>(this);
            		}
            		else {
HXLINE( 252)			int time = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 253)			int end = (time + waitTime);
HXLINE( 255)			while(true){
HXLINE( 255)				bool _hx_tmp1;
HXDLIN( 255)				bool _hx_tmp2;
HXDLIN( 255)				if (!(this->isComplete)) {
HXLINE( 255)					_hx_tmp2 = !(this->isError);
            				}
            				else {
HXLINE( 255)					_hx_tmp2 = false;
            				}
HXDLIN( 255)				if (_hx_tmp2) {
HXLINE( 255)					_hx_tmp1 = (time <= end);
            				}
            				else {
HXLINE( 255)					_hx_tmp1 = false;
            				}
HXDLIN( 255)				if (!(_hx_tmp1)) {
HXLINE( 255)					goto _hx_goto_4;
            				}
HXLINE( 258)				::Sys_obj::sleep(((Float)0.01));
HXLINE( 261)				time = ::lime::_hx_system::System_obj::getTimer();
            			}
            			_hx_goto_4:;
...
int waitTime = __o_waitTime.Default(-1);
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_279_result)
HXLINE( 281)		this->ready(waitTime);
HXLINE( 283)		if (this->isComplete) {
HXLINE( 285)			return this->value;
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,result,return )
 ...
 ::lime::app::Future Future_obj::then( ::Dynamic next){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_302_then)
HXDLIN( 302)		if (this->isComplete) {
HXLINE( 304)			return ( ( ::lime::app::Future)(next(this->value)) );
            		}
            		else {
HXLINE( 306)			if (this->isError) {
HXLINE( 308)				 ::lime::app::Future future =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 309)				future->isError = true;
HXLINE( 310)				future->error = this->error;
HXLINE( 311)				return future;
            			}
            			else {
            				HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::Dynamic,next, ::lime::app::Promise,promise) HXARGC(1)
            				void _hx_run( ::Dynamic val){
            					HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_320_then)
HXLINE( 322)					 ::lime::app::Future future1 = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 323)					future1->onError(promise->error_dyn());
HXLINE( 324)					future1->onComplete(promise->complete_dyn());
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 315)				 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 317)				this->onError(promise->error_dyn());
HXLINE( 318)				this->onProgress(promise->progress_dyn());
HXLINE( 320)				this->onComplete( ::Dynamic(new _hx_Closure_0(next,promise)));
HXLINE( 328)				return promise->future;
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,then,return )
 ...
 ::lime::app::Future Future_obj::ofEvents( ::lime::app::_Event_ofEvents_T_Void onComplete, ::lime::app::_Event_Dynamic_Void onError, ::lime::app::_Event_Int_Int_Void onProgress){
            		...
            		void _hx_run( ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_121_ofEvents)
HXLINE( 121)			promise->complete(data);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_117_ofEvents)
HXLINE( 119)		 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 121)		onComplete->add( ::Dynamic(new _hx_Closure_0(promise)),true,null());
HXLINE( 122)		if (hx::IsNotNull( onError )) {
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_1, ::lime::app::Promise,promise) HXARGC(1)
            			void _hx_run( ::Dynamic error){
            				HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_122_ofEvents)
HXLINE( 122)				promise->error(error);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 122)			onError->add( ::Dynamic(new _hx_Closure_1(promise)),true,null());
            		}
HXLINE( 123)		if (hx::IsNotNull( onProgress )) {
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_2, ::lime::app::Promise,promise) HXARGC(2)
            			void _hx_run(int progress,int total){
            				HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_123_ofEvents)
HXLINE( 123)				promise->progress(progress,total);
            			}
            			HX_END_LOCAL_FUNC2((void))

HXLINE( 123)			onProgress->add( ::Dynamic(new _hx_Closure_2(promise)),true,null());
            		}
HXLINE( 125)		return promise->future;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Future_obj,ofEvents,return )
 ...
 ::lime::app::Future Future_obj::withError( ::Dynamic error){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_340_withError)
HXLINE( 342)		 ::lime::app::Future future =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 343)		future->isError = true;
HXLINE( 344)		future->error = error;
HXLINE( 345)		return future;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Future_obj,withError,return )
 ...
 ::lime::app::Future Future_obj::withValue( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_355_withValue)
HXLINE( 357)		 ::lime::app::Future future =  ::lime::app::Future_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 358)		future->isComplete = true;
HXLINE( 359)		future->value = value;
