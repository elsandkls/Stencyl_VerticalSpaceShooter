...
HX_DEFINE_STACK_FRAME(_hx_pos_516576a6efa98cd2_47_new,"lime.app._Event_Int_Float_Void","new",0x70f46217,"lime.app._Event_Int_Float_Void.new","lime/app/Event.hx",47,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_65_add,"lime.app._Event_Int_Float_Void","add",0x70ea83d8,"lime.app._Event_Int_Float_Void.add","lime/app/Event.hx",65,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_94_cancel,"lime.app._Event_Int_Float_Void","cancel",0xbc7a0823,"lime.app._Event_Int_Float_Void.cancel","lime/app/Event.hx",94,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_141_has,"lime.app._Event_Int_Float_Void","has",0x70efd111,"lime.app._Event_Int_Float_Void.has","lime/app/Event.hx",141,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_516576a6efa98cd2_160_remove,"lime.app._Event_Int_Float_Void","remove",0x08ceb6ed,"lime.app._Event_Int_Float_Void.remove","lime/app/Event.hx",160,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_134e1ebc6ac98294_91_dispatch,"lime.app._Event_Int_Float_Void","dispatch",0x5464a5a3,"lime.app._Event_Int_Float_Void.dispatch","lime/_internal/macros/EventMacro.hx",91,0xc5a10671)
namespace lime{
namespace app{

void _Event_Int_Float_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_47_new)
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_65_add)
HXLINE(  68)		{
...
void _Event_Int_Float_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_94_cancel)
...
bool _Event_Int_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_141_has)
HXLINE( 144)		{
...
void _Event_Int_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_516576a6efa98cd2_160_remove)
...
void _Event_Int_Float_Void_obj::dispatch(int a,Float a1){
            	HX_STACKFRAME(&_hx_pos_134e1ebc6ac98294_91_dispatch)
