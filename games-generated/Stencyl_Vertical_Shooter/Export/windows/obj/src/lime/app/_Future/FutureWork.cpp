...
HX_LOCAL_STACK_FRAME(_hx_pos_07b7a29bdf563898_380_queue,"lime.app._Future.FutureWork","queue",0x91987fc9,"lime.app._Future.FutureWork.queue","lime/app/Future.hx",380,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_07b7a29bdf563898_405_threadPool_doWork,"lime.app._Future.FutureWork","threadPool_doWork",0x0c558ecd,"lime.app._Future.FutureWork.threadPool_doWork","lime/app/Future.hx",405,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_07b7a29bdf563898_421_threadPool_onComplete,"lime.app._Future.FutureWork","threadPool_onComplete",0x6b927949,"lime.app._Future.FutureWork.threadPool_onComplete","lime/app/Future.hx",421,0x058e0853)
HX_LOCAL_STACK_FRAME(_hx_pos_07b7a29bdf563898_428_threadPool_onError,"lime.app._Future.FutureWork","threadPool_onError",0xc65d5938,"lime.app._Future.FutureWork.threadPool_onError","lime/app/Future.hx",428,0x058e0853)
namespace lime{
namespace app{
namespace _Future{
...
void FutureWork_obj::queue( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_07b7a29bdf563898_380_queue)
HXLINE( 382)		if (hx::IsNull( ::lime::app::_Future::FutureWork_obj::threadPool )) {
HXLINE( 384)			::lime::app::_Future::FutureWork_obj::threadPool =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 385)			::lime::app::_Future::FutureWork_obj::threadPool->doWork->add(::lime::app::_Future::FutureWork_obj::threadPool_doWork_dyn(),null(),null());
HXLINE( 386)			::lime::app::_Future::FutureWork_obj::threadPool->onComplete->add(::lime::app::_Future::FutureWork_obj::threadPool_onComplete_dyn(),null(),null());
HXLINE( 387)			::lime::app::_Future::FutureWork_obj::threadPool->onError->add(::lime::app::_Future::FutureWork_obj::threadPool_onError_dyn(),null(),null());
            		}
HXLINE( 391)		::lime::app::_Future::FutureWork_obj::threadPool->queue(state);
            	}
...
void FutureWork_obj::threadPool_doWork( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_07b7a29bdf563898_405_threadPool_doWork)
HXDLIN( 405)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 407)			 ::Dynamic result = state->__Field(HX_("work",d1,01,fd,4e),hx::paccDynamic)();
HXLINE( 408)			::lime::app::_Future::FutureWork_obj::threadPool->sendComplete( ::Dynamic(hx::Anon_obj::Create(2)
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE( 412)				::lime::app::_Future::FutureWork_obj::threadPool->sendError( ::Dynamic(hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("promise",9b,cd,e9,f7), ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic)))
...
void FutureWork_obj::threadPool_onComplete( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_07b7a29bdf563898_421_threadPool_onComplete)
HXDLIN( 421)		 ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("complete",b9,00,c8,7f),hx::paccDynamic)( ::Dynamic(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)));
            	}
...
void FutureWork_obj::threadPool_onError( ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_07b7a29bdf563898_428_threadPool_onError)
HXDLIN( 428)		 ::Dynamic(state->__Field(HX_("promise",9b,cd,e9,f7),hx::paccDynamic))->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)( ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),hx::paccDynamic)));
            	}
