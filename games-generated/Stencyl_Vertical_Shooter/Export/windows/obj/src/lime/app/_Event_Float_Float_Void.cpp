...
HX_DEFINE_STACK_FRAME(_hx_pos_ac55b5a79008e8e5_47_new,"lime.app._Event_Float_Float_Void","new",0xa66d9f8a,"lime.app._Event_Float_Float_Void.new","lime/app/Event.hx",47,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ac55b5a79008e8e5_65_add,"lime.app._Event_Float_Float_Void","add",0xa663c14b,"lime.app._Event_Float_Float_Void.add","lime/app/Event.hx",65,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ac55b5a79008e8e5_94_cancel,"lime.app._Event_Float_Float_Void","cancel",0x16a87490,"lime.app._Event_Float_Float_Void.cancel","lime/app/Event.hx",94,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ac55b5a79008e8e5_141_has,"lime.app._Event_Float_Float_Void","has",0xa6690e84,"lime.app._Event_Float_Float_Void.has","lime/app/Event.hx",141,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ac55b5a79008e8e5_160_remove,"lime.app._Event_Float_Float_Void","remove",0x62fd235a,"lime.app._Event_Float_Float_Void.remove","lime/app/Event.hx",160,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_327059d4f22ea8db_91_dispatch,"lime.app._Event_Float_Float_Void","dispatch",0x6858c750,"lime.app._Event_Float_Float_Void.dispatch","lime/_internal/macros/EventMacro.hx",91,0xc5a10671)
namespace lime{
namespace app{

void _Event_Float_Float_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_ac55b5a79008e8e5_47_new)
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_ac55b5a79008e8e5_65_add)
HXLINE(  68)		{
...
void _Event_Float_Float_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_ac55b5a79008e8e5_94_cancel)
...
bool _Event_Float_Float_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_ac55b5a79008e8e5_141_has)
HXLINE( 144)		{
...
void _Event_Float_Float_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_ac55b5a79008e8e5_160_remove)
...
void _Event_Float_Float_Void_obj::dispatch(Float a,Float a1){
            	HX_STACKFRAME(&_hx_pos_327059d4f22ea8db_91_dispatch)
