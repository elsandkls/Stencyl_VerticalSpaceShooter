...
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_47_new,"lime.app.Event","new",0xaf38c4c6,"lime.app.Event.new","lime/app/Event.hx",47,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_65_add,"lime.app.Event","add",0xaf2ee687,"lime.app.Event.add","lime/app/Event.hx",65,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_94_cancel,"lime.app.Event","cancel",0xfb4b3cd4,"lime.app.Event.cancel","lime/app/Event.hx",94,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_141_has,"lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",141,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_160_remove,"lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",160,0xbda45bec)
namespace lime{
namespace app{

void Event_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_47_new)
HXLINE(  50)		this->canceled = false;
HXLINE(  51)		this->_hx___listeners = ::cpp::VirtualArray_obj::__new();
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_65_add)
HXLINE(  68)		{
...
void Event_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_94_cancel)
...
bool Event_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_141_has)
HXLINE( 144)		{
HXLINE( 144)			int _g = (int)0;
HXDLIN( 144)			::cpp::VirtualArray _g1 = this->_hx___listeners;
...
void Event_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_160_remove)
HXLINE( 163)		int i = this->_hx___listeners->get_length();
...
HXLINE( 169)				this->_hx___listeners->splice(i,(int)1);
