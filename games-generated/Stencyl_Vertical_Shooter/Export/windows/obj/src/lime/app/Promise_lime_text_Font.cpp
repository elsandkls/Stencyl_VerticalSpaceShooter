...
HX_DEFINE_STACK_FRAME(_hx_pos_29facf1bb5373994_95_new,"lime.app.Promise_lime_text_Font","new",0x708368f3,"lime.app.Promise_lime_text_Font.new","lime/app/Promise.hx",95,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_105_complete,"lime.app.Promise_lime_text_Font","complete",0x0a877346,"lime.app.Promise_lime_text_Font.complete","lime/app/Promise.hx",105,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_137_completeWith,"lime.app.Promise_lime_text_Font","completeWith",0xf69b306c,"lime.app.Promise_lime_text_Font.completeWith","lime/app/Promise.hx",137,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_153_error,"lime.app.Promise_lime_text_Font","error",0x00deef1b,"lime.app.Promise_lime_text_Font.error","lime/app/Promise.hx",153,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_185_progress,"lime.app.Promise_lime_text_Font","progress",0x10ea6a3a,"lime.app.Promise_lime_text_Font.progress","lime/app/Promise.hx",185,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_215_get_isComplete,"lime.app.Promise_lime_text_Font","get_isComplete",0x8a9ff559,"lime.app.Promise_lime_text_Font.get_isComplete","lime/app/Promise.hx",215,0x10ba4f0b)
HX_LOCAL_STACK_FRAME(_hx_pos_29facf1bb5373994_222_get_isError,"lime.app.Promise_lime_text_Font","get_isError",0xc3d0b328,"lime.app.Promise_lime_text_Font.get_isError","lime/app/Promise.hx",222,0x10ba4f0b)
namespace lime{
namespace app{

void Promise_lime_text_Font_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_29facf1bb5373994_95_new)
...
bool Promise_lime_text_Font_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::complete( ::lime::text::Font data){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_105_complete)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,complete,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::completeWith( ::lime::app::Future future){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_137_completeWith)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,completeWith,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::error( ::Dynamic msg){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_153_error)
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_text_Font_obj,error,return )
 ...
 ::lime::app::Promise_lime_text_Font Promise_lime_text_Font_obj::progress(int progress,int total){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_185_progress)
...
bool Promise_lime_text_Font_obj::get_isComplete(){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_215_get_isComplete)
...
bool Promise_lime_text_Font_obj::get_isError(){
            	HX_STACKFRAME(&_hx_pos_29facf1bb5373994_222_get_isError)
