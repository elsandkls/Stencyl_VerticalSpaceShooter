...
HX_LOCAL_STACK_FRAME(_hx_pos_5f5d269148cb5824_15_shape,"lime.text.harfbuzz.HB","shape",0x0dca5a53,"lime.text.harfbuzz.HB.shape","lime/text/harfbuzz/HB.hx",15,0xea51f15d)
namespace lime{
namespace text{
namespace harfbuzz{
...
void HB_obj::shape( ::Dynamic font, ::Dynamic buffer,::Array< ::Dynamic> features){
            	HX_STACKFRAME(&_hx_pos_5f5d269148cb5824_15_shape)
HXDLIN(  15)		::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_shape(hx::DynamicPtr(font),hx::DynamicPtr(buffer),hx::DynamicPtr(features));
            	}
