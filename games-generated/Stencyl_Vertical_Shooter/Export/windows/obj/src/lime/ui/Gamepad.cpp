...
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_90_get_guid,"lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",90,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_108_get_name,"lime.ui.Gamepad","get_name",0x33fdf6e2,"lime.ui.Gamepad.get_name","lime/ui/Gamepad.hx",108,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_48_addMappings,"lime.ui.Gamepad","addMappings",0x7dce3c98,"lime.ui.Gamepad.addMappings","lime/ui/Gamepad.hx",48,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_56___connect,"lime.ui.Gamepad","__connect",0x06daaffc,"lime.ui.Gamepad.__connect","lime/ui/Gamepad.hx",56,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_67___disconnect,"lime.ui.Gamepad","__disconnect",0x04d0478a,"lime.ui.Gamepad.__disconnect","lime/ui/Gamepad.hx",67,0x36bc843e)
...
::String Gamepad_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_90_get_guid)
HXDLIN(  90)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_guid(this->id)) );
            	}
...
::String Gamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_108_get_name)
HXDLIN( 108)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(this->id)) );
            	}
...
void Gamepad_obj::addMappings(::Array< ::String > mappings){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_48_addMappings)
HXDLIN(  48)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_add_mappings(hx::DynamicPtr(mappings));
            	}
...
void Gamepad_obj::_hx___connect(int id){
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_56___connect)
HXDLIN(  56)		if (!(::lime::ui::Gamepad_obj::devices->exists(id))) {
HXLINE(  58)			 ::lime::ui::Gamepad gamepad =  ::lime::ui::Gamepad_obj::__alloc( HX_CTX ,id);
HXLINE(  59)			::lime::ui::Gamepad_obj::devices->set(id,gamepad);
HXLINE(  60)			::lime::ui::Gamepad_obj::onConnect->dispatch(gamepad);
            		}
            	}
...
void Gamepad_obj::_hx___disconnect(int id){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_67___disconnect)
HXLINE(  69)		 ::lime::ui::Gamepad gamepad = ::lime::ui::Gamepad_obj::devices->get(id).StaticCast<  ::lime::ui::Gamepad >();
HXLINE(  70)		if (hx::IsNotNull( gamepad )) {
HXLINE(  70)			gamepad->connected = false;
            		}
HXLINE(  71)		::lime::ui::Gamepad_obj::devices->remove(id);
HXLINE(  72)		if (hx::IsNotNull( gamepad )) {
HXLINE(  72)			gamepad->onDisconnect->dispatch();
            		}
            	}
