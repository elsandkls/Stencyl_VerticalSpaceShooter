...
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_90_get_guid,"lime.ui.Joystick","get_guid",0xa0372443,"lime.ui.Joystick.get_guid","lime/ui/Joystick.hx",90,0x26e848e1)
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_108_get_name,"lime.ui.Joystick","get_name",0xa4c87905,"lime.ui.Joystick.get_name","lime/ui/Joystick.hx",108,0x26e848e1)
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_123_get_numAxes,"lime.ui.Joystick","get_numAxes",0x6e0a2811,"lime.ui.Joystick.get_numAxes","lime/ui/Joystick.hx",123,0x26e848e1)
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_137_get_numButtons,"lime.ui.Joystick","get_numButtons",0x8a7f5ed5,"lime.ui.Joystick.get_numButtons","lime/ui/Joystick.hx",137,0x26e848e1)
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_151_get_numHats,"lime.ui.Joystick","get_numHats",0x72993fa4,"lime.ui.Joystick.get_numHats","lime/ui/Joystick.hx",151,0x26e848e1)
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_162_get_numTrackballs,"lime.ui.Joystick","get_numTrackballs",0xfaa6bf15,"lime.ui.Joystick.get_numTrackballs","lime/ui/Joystick.hx",162,0x26e848e1)
...
::String Joystick_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_90_get_guid)
HXDLIN(  90)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_device_guid(this->id)) );
            	}
...
::String Joystick_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_108_get_name)
HXDLIN( 108)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_device_name(this->id)) );
            	}
...
int Joystick_obj::get_numAxes(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_123_get_numAxes)
HXDLIN( 123)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_num_axes(this->id);
            	}
...
int Joystick_obj::get_numButtons(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_137_get_numButtons)
HXDLIN( 137)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_num_buttons(this->id);
            	}
...
int Joystick_obj::get_numHats(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_151_get_numHats)
HXDLIN( 151)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_num_hats(this->id);
            	}
...
int Joystick_obj::get_numTrackballs(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_162_get_numTrackballs)
HXDLIN( 162)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_num_trackballs(this->id);
            	}
