...
class HXCPP_CLASS_ATTRIBUTES HBFace_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< HBFace_Impl__obj > __new() {
			hx::ObjectPtr< HBFace_Impl__obj > __this = new HBFace_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< HBFace_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("HBFace_Impl_","\x97","\x44","\x07","\x0c"); }
