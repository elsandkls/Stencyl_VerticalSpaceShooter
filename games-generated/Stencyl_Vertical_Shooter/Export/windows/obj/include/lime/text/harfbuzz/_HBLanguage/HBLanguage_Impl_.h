...
class HXCPP_CLASS_ATTRIBUTES HBLanguage_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< HBLanguage_Impl__obj > __new() {
			hx::ObjectPtr< HBLanguage_Impl__obj > __this = new HBLanguage_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< HBLanguage_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("HBLanguage_Impl_","\x92","\xe3","\xdb","\x48"); }
