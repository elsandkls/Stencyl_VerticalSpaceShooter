...
class HXCPP_CLASS_ATTRIBUTES AudioManager_obj : public hx::Object
{
	...
	public:
		...
		static ::Array< ::Dynamic> audioSources;
		static ::Array< ::Dynamic> sourcesToRemove;
		...
		static void addAudioSource( ::lime::media::AudioSource source);
		static ::Dynamic addAudioSource_dyn();

		static void removeAudioSource( ::lime::media::AudioSource source);
		static ::Dynamic removeAudioSource_dyn();
