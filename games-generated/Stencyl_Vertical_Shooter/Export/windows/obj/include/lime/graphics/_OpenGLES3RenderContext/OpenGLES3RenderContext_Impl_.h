...
class HXCPP_CLASS_ATTRIBUTES OpenGLES3RenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< OpenGLES3RenderContext_Impl__obj > __new() {
			hx::ObjectPtr< OpenGLES3RenderContext_Impl__obj > __this = new OpenGLES3RenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< OpenGLES3RenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("OpenGLES3RenderContext_Impl_","\x63","\xe1","\x2c","\xe3"); }
