...
class HXCPP_CLASS_ATTRIBUTES DOMRenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< DOMRenderContext_Impl__obj > __new() {
			hx::ObjectPtr< DOMRenderContext_Impl__obj > __this = new DOMRenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< DOMRenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("DOMRenderContext_Impl_","\x57","\xd5","\x75","\x22"); }
