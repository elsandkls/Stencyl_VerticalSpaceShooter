...
class HXCPP_CLASS_ATTRIBUTES CairoRenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< CairoRenderContext_Impl__obj > __new() {
			hx::ObjectPtr< CairoRenderContext_Impl__obj > __this = new CairoRenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< CairoRenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("CairoRenderContext_Impl_","\x11","\x2f","\xc0","\x0c"); }
