...
class HXCPP_CLASS_ATTRIBUTES OpenGLRenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< OpenGLRenderContext_Impl__obj > __new() {
			hx::ObjectPtr< OpenGLRenderContext_Impl__obj > __this = new OpenGLRenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< OpenGLRenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("OpenGLRenderContext_Impl_","\x4a","\xa7","\x74","\x1b"); }
