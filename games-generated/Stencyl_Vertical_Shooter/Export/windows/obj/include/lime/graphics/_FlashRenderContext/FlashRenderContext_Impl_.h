...
class HXCPP_CLASS_ATTRIBUTES FlashRenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FlashRenderContext_Impl__obj > __new() {
			hx::ObjectPtr< FlashRenderContext_Impl__obj > __this = new FlashRenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< FlashRenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("FlashRenderContext_Impl_","\xe9","\x02","\x1e","\xd6"); }
