...
class HXCPP_CLASS_ATTRIBUTES WebGL2RenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< WebGL2RenderContext_Impl__obj > __new() {
			hx::ObjectPtr< WebGL2RenderContext_Impl__obj > __this = new WebGL2RenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< WebGL2RenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("WebGL2RenderContext_Impl_","\xa0","\x77","\xab","\xa6"); }
