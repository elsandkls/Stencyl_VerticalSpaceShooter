...
class HXCPP_CLASS_ATTRIBUTES DataPointer_Impl__obj : public hx::Object
{
	...
	public:
		...
		static Float fromCharPointer(::cpp::Pointer< char > pointer);
		static ::Dynamic fromCharPointer_dyn();

		static Float fromUint8Pointer(::cpp::Pointer< unsigned char > pointer);
		static ::Dynamic fromUint8Pointer_dyn();
