...
HX_DECLARE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1047_new)
...
HXLINE(1049)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->type = type;
HXLINE(1050)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->id = id;
HXLINE(1051)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->x = x;
HXLINE(1052)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->y = y;
HXLINE(1053)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->z = z;
            	}
