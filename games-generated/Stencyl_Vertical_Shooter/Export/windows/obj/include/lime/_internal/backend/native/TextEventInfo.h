...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_1086_new)
...
HXLINE(1088)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = type;
HXLINE(1089)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE(1090)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->text = text;
HXLINE(1091)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE(1092)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}
