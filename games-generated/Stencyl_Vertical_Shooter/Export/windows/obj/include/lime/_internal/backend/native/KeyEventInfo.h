...
HX_DECLARE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_931_new)
...
HXLINE( 933)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->type = type;
HXLINE( 934)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 935)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 936)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->modifier = modifier;
            	}
