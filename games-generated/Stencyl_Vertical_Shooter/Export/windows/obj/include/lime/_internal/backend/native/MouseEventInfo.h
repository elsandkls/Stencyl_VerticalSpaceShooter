...
HX_DECLARE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_972_new)
...
HXLINE( 974)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->type = type;
HXLINE( 975)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->windowID = (int)0;
HXLINE( 976)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->x = x;
HXLINE( 977)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->y = y;
HXLINE( 978)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->button = button;
HXLINE( 979)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 980)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementY = movementY;
            	}
