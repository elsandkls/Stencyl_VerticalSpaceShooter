...
HX_DECLARE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_1128_new)
...
HXLINE(1130)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->type = type;
HXLINE(1131)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->x = x;
HXLINE(1132)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->y = y;
HXLINE(1133)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->id = id;
HXLINE(1134)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dx = dx;
HXLINE(1135)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dy = dy;
HXLINE(1136)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE(1137)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->device = device;
            	}
