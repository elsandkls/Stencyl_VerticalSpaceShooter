...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_809_new)
...
HXLINE( 811)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = type;
HXLINE( 812)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
