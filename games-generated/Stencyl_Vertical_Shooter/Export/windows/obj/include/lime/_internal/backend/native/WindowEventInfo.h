...
HX_DECLARE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1172_new)
...
HXLINE(1174)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->type = type;
HXLINE(1175)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1176)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->width = width;
HXLINE(1177)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->height = height;
HXLINE(1178)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->x = x;
HXLINE(1179)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->y = y;
            	}
