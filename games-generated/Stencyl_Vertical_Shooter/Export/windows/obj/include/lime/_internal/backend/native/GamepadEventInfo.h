...
HX_DECLARE_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_844_new)
...
HXLINE( 846)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->type = type;
HXLINE( 847)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->id = id;
HXLINE( 848)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->button = button;
HXLINE( 849)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axis = axis;
HXLINE( 850)		( ( ::lime::_internal::backend::native::GamepadEventInfo)(__this) )->axisValue = value;
            	}
