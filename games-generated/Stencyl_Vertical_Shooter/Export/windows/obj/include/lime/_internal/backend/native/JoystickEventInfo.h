...
HX_DECLARE_STACK_FRAME(_hx_pos_21cd05885e6e0032_887_new)
...
HXLINE( 889)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->type = type;
HXLINE( 890)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->id = id;
HXLINE( 891)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->index = index;
HXLINE( 892)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->eventValue = value;
HXLINE( 893)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->x = x;
HXLINE( 894)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->y = y;
            	}
