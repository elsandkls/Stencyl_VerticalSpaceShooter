...
class MouseWheelMode_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("lime.ui.MouseWheelMode","\x1a","\x08","\x21","\x1a"); }
		::String __ToString() const { return HX_HCSTRING("MouseWheelMode.","\x35","\xef","\xde","\x4c") + _hx_tag; }
