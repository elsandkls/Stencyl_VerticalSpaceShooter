...
class HXCPP_CLASS_ATTRIBUTES SepiaShader_obj : public  ::com::stencyl::graphics::shaders::BasicShader_obj
{
	...
	public:
		enum { _hx_ClassId = 0x0c7c7cc3 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="com.stencyl.graphics.shaders.SepiaShader")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"com.stencyl.graphics.shaders.SepiaShader"); }
		static hx::ObjectPtr< SepiaShader_obj > __new();
		static hx::ObjectPtr< SepiaShader_obj > __alloc(hx::Ctx *_hx_ctx);
		...
		::String __ToString() const { return HX_HCSTRING("SepiaShader","\x9b","\x02","\x24","\x78"); }
