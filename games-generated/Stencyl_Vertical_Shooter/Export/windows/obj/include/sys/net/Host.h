...
HX_DECLARE_STACK_FRAME(_hx_pos_1e53caa73002206d_35_new)
...
class HXCPP_CLASS_ATTRIBUTES Host_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Host_obj > __new(::String name) {
			hx::ObjectPtr< Host_obj > __this = new Host_obj();
			__this->__construct(name);
			return __this;
		}

		static hx::ObjectPtr< Host_obj > __alloc(hx::Ctx *_hx_ctx,::String name) {
...
HXLINE(  38)			( ( ::sys::net::Host)(__this) )->ip = _hx_std_host_resolve(name);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic e = _hx_e;
HXLINE(  42)				( ( ::sys::net::Host)(__this) )->ipv6 = _hx_std_host_resolve_ipv6(name);
            			}
            			else {
