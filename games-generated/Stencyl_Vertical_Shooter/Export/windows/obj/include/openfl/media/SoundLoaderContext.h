...
HX_DECLARE_STACK_FRAME(_hx_pos_baeaab40d0a56ac0_158_new)
...
HXLINE( 160)		( ( ::openfl::media::SoundLoaderContext)(__this) )->bufferTime = bufferTime;
HXLINE( 161)		( ( ::openfl::media::SoundLoaderContext)(__this) )->checkPolicyFile = checkPolicyFile;
            	}
