...
HX_DECLARE_STACK_FRAME(_hx_pos_b69a1b3bd673fa32_62_new)
...
HXLINE(  64)		( ( ::openfl::media::SoundTransform)(__this) )->volume = vol;
HXLINE(  65)		( ( ::openfl::media::SoundTransform)(__this) )->pan = panning;
HXLINE(  66)		( ( ::openfl::media::SoundTransform)(__this) )->leftToLeft = (int)0;
HXLINE(  67)		( ( ::openfl::media::SoundTransform)(__this) )->leftToRight = (int)0;
HXLINE(  68)		( ( ::openfl::media::SoundTransform)(__this) )->rightToLeft = (int)0;
HXLINE(  69)		( ( ::openfl::media::SoundTransform)(__this) )->rightToRight = (int)0;
            	}
