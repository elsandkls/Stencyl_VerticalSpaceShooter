...
HX_DECLARE_STACK_FRAME(_hx_pos_c5f39c48023aa9de_240_new)
...
HXLINE( 242)		( ( ::openfl::text::TextFormat)(__this) )->font = font;
HXLINE( 243)		( ( ::openfl::text::TextFormat)(__this) )->size = size;
HXLINE( 244)		( ( ::openfl::text::TextFormat)(__this) )->color = color;
HXLINE( 245)		( ( ::openfl::text::TextFormat)(__this) )->bold = bold;
HXLINE( 246)		( ( ::openfl::text::TextFormat)(__this) )->italic = italic;
HXLINE( 247)		( ( ::openfl::text::TextFormat)(__this) )->underline = underline;
HXLINE( 248)		( ( ::openfl::text::TextFormat)(__this) )->url = url;
HXLINE( 249)		( ( ::openfl::text::TextFormat)(__this) )->target = target;
HXLINE( 250)		( ( ::openfl::text::TextFormat)(__this) )->align = align;
HXLINE( 251)		( ( ::openfl::text::TextFormat)(__this) )->leftMargin = leftMargin;
HXLINE( 252)		( ( ::openfl::text::TextFormat)(__this) )->rightMargin = rightMargin;
HXLINE( 253)		( ( ::openfl::text::TextFormat)(__this) )->indent = indent;
HXLINE( 254)		( ( ::openfl::text::TextFormat)(__this) )->leading = leading;
            	}
