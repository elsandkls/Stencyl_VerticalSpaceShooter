...
class HXCPP_CLASS_ATTRIBUTES Context3DTilemap_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Context3DTilemap_obj > __new() {
			hx::ObjectPtr< Context3DTilemap_obj > __this = new Context3DTilemap_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Context3DTilemap_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("Context3DTilemap","\xce","\xe3","\x4c","\xc1"); }
