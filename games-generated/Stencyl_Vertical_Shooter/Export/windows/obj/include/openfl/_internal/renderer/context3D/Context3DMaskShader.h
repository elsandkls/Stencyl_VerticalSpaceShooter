...
#define INCLUDED_openfl__internal_renderer_context3D_Context3DMaskShader
...
class HXCPP_CLASS_ATTRIBUTES Context3DMaskShader_obj : public  ::openfl::display::Shader_obj
{
	...
	public:
		enum { _hx_ClassId = 0x46a73280 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl._internal.renderer.context3D.Context3DMaskShader")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.renderer.context3D.Context3DMaskShader"); }
		...
		::String __ToString() const { return HX_HCSTRING("Context3DMaskShader","\x91","\xfd","\x02","\xf3"); }
...
#endif /* INCLUDED_openfl__internal_renderer_context3D_Context3DMaskShader */ 
