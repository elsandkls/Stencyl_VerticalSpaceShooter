...
class HXCPP_CLASS_ATTRIBUTES CairoTilemap_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< CairoTilemap_obj > __new() {
			hx::ObjectPtr< CairoTilemap_obj > __this = new CairoTilemap_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< CairoTilemap_obj > __alloc(hx::Ctx *_hx_ctx) {
			CairoTilemap_obj *__this = (CairoTilemap_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(CairoTilemap_obj), false, "openfl._internal.renderer.cairo.CairoTilemap"));
