...
class HXCPP_CLASS_ATTRIBUTES FlashRenderer_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FlashRenderer_obj > __new() {
			hx::ObjectPtr< FlashRenderer_obj > __this = new FlashRenderer_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< FlashRenderer_obj > __alloc(hx::Ctx *_hx_ctx) {
