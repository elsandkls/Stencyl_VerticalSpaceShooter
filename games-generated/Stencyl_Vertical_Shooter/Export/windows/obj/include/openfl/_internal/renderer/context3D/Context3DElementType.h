...
class Context3DElementType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("openfl._internal.renderer.context3D.Context3DElementType","\x9f","\xfa","\x59","\xbb"); }
		::String __ToString() const { return HX_HCSTRING("Context3DElementType.","\x38","\x30","\xf0","\x03") + _hx_tag; }
