...
class HXCPP_CLASS_ATTRIBUTES Memory_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< Memory_obj > __alloc(hx::Ctx *_hx_ctx) {
			Memory_obj *__this = (Memory_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Memory_obj), false, "openfl.Memory"));
		...
		static  ::openfl::utils::ByteArrayData gcRef;
		static int len;
		...
		static void select( ::openfl::utils::ByteArrayData inBytes);
