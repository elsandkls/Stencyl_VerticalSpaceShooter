...
HX_DECLARE_STACK_FRAME(_hx_pos_8cde7e51a6201b8b_104_new)
...
HXLINE( 106)		( ( ::openfl::net::URLRequestHeader)(__this) )->name = name;
HXLINE( 107)		( ( ::openfl::net::URLRequestHeader)(__this) )->value = value;
            	}
