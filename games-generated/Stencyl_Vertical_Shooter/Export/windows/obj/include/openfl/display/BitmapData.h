...
class HXCPP_CLASS_ATTRIBUTES BitmapData_obj : public hx::Object
{
	...
	public:
		...
		static void __boot();
		static int _hx___vertexBufferStride;
		...
		::Dynamic generateFilterRect_dyn();
		 ...
		 ::openfl::display3D::IndexBuffer3D getIndexBuffer( ::openfl::display3D::Context3D context);
		::Dynamic getIndexBuffer_dyn();

		 ::openfl::display3D::VertexBuffer3D getVertexBuffer( ::openfl::display3D::Context3D context);
