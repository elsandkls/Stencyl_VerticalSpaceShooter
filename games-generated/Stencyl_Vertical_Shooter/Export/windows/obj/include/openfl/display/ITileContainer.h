...
class HXCPP_CLASS_ATTRIBUTES ITileContainer_obj {
	public:
		...
		static inline int get_numTiles( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_get_numTiles)();
		}
		...
		static inline  ::openfl::display::Tile addTile( ::Dynamic _hx_, ::openfl::display::Tile tile) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_addTile)(tile);
		}
		...
		static inline  ::openfl::display::Tile addTileAt( ::Dynamic _hx_, ::openfl::display::Tile tile,int index) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_addTileAt)(tile,index);
		}
		...
		static inline ::Array< ::Dynamic> addTiles( ::Dynamic _hx_,::Array< ::Dynamic> tiles) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_addTiles)(tiles);
		}
		bool (hx::Object :: *_hx_contains)( ::openfl::display::Tile tile); 
		static inline bool contains( ::Dynamic _hx_, ::openfl::display::Tile tile) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_contains)(tile);
		}
		 ::openfl::display::Tile (hx::Object :: *_hx_getTileAt)(int index); 
		static inline  ::openfl::display::Tile getTileAt( ::Dynamic _hx_,int index) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_getTileAt)(index);
		}
		...
		static inline int getTileIndex( ::Dynamic _hx_, ::openfl::display::Tile tile) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_getTileIndex)(tile);
		}
		...
		static inline  ::openfl::display::Tile removeTile( ::Dynamic _hx_, ::openfl::display::Tile tile) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_removeTile)(tile);
		}
		...
		static inline  ::openfl::display::Tile removeTileAt( ::Dynamic _hx_,int index) {
			return (_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_removeTileAt)(index);
		}
		...
		static inline void removeTiles( ::Dynamic _hx_,hx::Null< int >  beginIndex,hx::Null< int >  endIndex) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_removeTiles)(beginIndex,endIndex);
		}
		...
		static inline void setTileIndex( ::Dynamic _hx_, ::openfl::display::Tile tile,int index) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_setTileIndex)(tile,index);
		}
		...
		static inline void swapTiles( ::Dynamic _hx_, ::openfl::display::Tile tile1, ::openfl::display::Tile tile2) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_swapTiles)(tile1,tile2);
		}
		void (hx::Object :: *_hx_swapTilesAt)(int index1,int index2); 
		static inline void swapTilesAt( ::Dynamic _hx_,int index1,int index2) {
			(_hx_.mPtr->*( static_cast< ::openfl::display::ITileContainer_obj *>(_hx_.mPtr->_hx_getInterface(0xcad54adc)))->_hx_swapTilesAt)(index1,index2);
		}
};
