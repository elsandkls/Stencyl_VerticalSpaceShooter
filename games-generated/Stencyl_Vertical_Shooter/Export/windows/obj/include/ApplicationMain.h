...
class HXCPP_CLASS_ATTRIBUTES ApplicationMain_obj : public hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::openfl::display::Application app;
		static  ::Universal universal;
		static void main();
		static ::Dynamic main_dyn();

		static ::Array< ::Dynamic> reloadListeners;
		...
		static void uncaughtErrorHandler( ::openfl::events::UncaughtErrorEvent event);
		static ::Dynamic uncaughtErrorHandler_dyn();
